...
# DB_URL=postgresql://root@club.local:26257/defaultdb?sslmode=disable,
...
export STATS_URL="http://club.local:4900"
export SES_URL=
...
# DISABLE_SIGNUP=true,
# INIT_SCRIPT_URL=https://raw.githubusercontent.com/opensrcs/init/main/script.yaml,
