...
import { type DatalakeClient } from '@opensrcs/datalake'
import { type UploadObjectParams } from '@opensrcs/datalake/types/client'
import { DOMAIN_ATTACHMENT } from '@opensrcs/model-attachment'
import { type S3Config, type S3Service } from '@opensrcs/s3'
import {
  type ListBlobResult,
  type StorageAdapter,
