...
import serverClientPlugin, { getTransactorEndpoint } from '@opensrcs/server-client'
import os from 'os'
import { Worker, isMainThread, parentPort } from 'worker_threads'
import { CSVWriter } from './csv'

import { AvatarType, getPersonBySocialKey } from '@opensrcs/contact'
import contact from '@opensrcs/model-contact'
import recruit from '@opensrcs/model-recruit'
import { type Vacancy } from '@opensrcs/recruit'
...
export async function generateEmployee (client: TxOperations): Promise<AccountUuid> {
  ...
  const socialString = buildSocialIdString({ type: SocialIdType.CLUB, value: personUuid })
