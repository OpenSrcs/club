...
const devProductionClub = clientType === 'dev-club'
...
const devProxy = {
  '/account': {
    target: 'http://club.local:3000',
    changeOrigin: true,
    pathRewrite: { '^/account': '' },
    logLevel: 'debug'
  },
  '/files': {
    target: 'http://club.local:8087',
    changeOrigin: true,
    logLevel: 'debug'
  },
  '/api/v1': {
...
const devProxyTest = {
  '/account': {
    target: 'http://club.local:3003',
    changeOrigin: true,
    pathRewrite: { '^/account': '' },
    logLevel: 'debug'
  },
  '/files': {
    target: 'http://club.local:8083',
    changeOrigin: true,
    logLevel: 'debug'
  },
  '/api/v1': {
...
const devClubProxy = {
  '/account': {
    target: 'https://account.club.app/',
    changeOrigin: true,
    pathRewrite: { '^/account': '' },
    logLevel: 'debug'
  },
  '/api/v1': {
    target: 'http://club.app',
    changeOrigin: true,
    logLevel: 'debug'
  },
  '/files': {
    target: 'https://club.opensrcs.org/files',
    changeOrigin: true,
    pathRewrite: { '^/files': '' },
    logLevel: 'debug'
  },
  '/rekoni/recognize': {
    target: 'https://rekoni.club.app',
    changeOrigin: true,
    pathRewrite: { '^/rekoni/recognize': '/recognize' },
    logLevel: 'debug'
  }
...
const devFrontProxy = {
  '/account': {
    target: 'https://account.club.opensrcs.org/',
    changeOrigin: true,
    pathRewrite: { '^/account': '' },
    logLevel: 'debug'
  },
  '/files': {
    target: 'https://front.club.opensrcs.org/files',
    changeOrigin: true,
    pathRewrite: { '^/files': '' },
    logLevel: 'debug'
  },
...
module.exports = [
  {
    ...
    entry: {
      serviceWorker: '@opensrcs/notification/src/serviceWorker.ts'
    },
    module: {
      rules: [
        {
  ...
  },
  {
    cache: useCache
      ...
      : undefined,
    entry: {
      bundle: ['@opensrcs/theme/styles/global.scss', ...(dev ? ['./src/main-dev.ts'] : ['./src/main.ts'])]
    },
    ignoreWarnings: [
      {
        message: /a11y-/
    ...
    resolve: {
      ...
      alias: {
        ...
        '@opensrcs/club-rig/profiles/ui/svelte': path.resolve('node_modules', 'svelte/src/runtime')
      },
      fallback: {
        crypto: false
      },
