...
Tool for importing data into club workspace.

## Recommended Import Method

### Unified Format Import
The recommended way to import data into club is using our [Unified Import Format](./docs/club/README.md). This format provides a straightforward way to migrate data from any system by converting it into an intermediate, human-readable structure.

See the [complete guide](./docs/club/README.md) and [example workspace](./docs/club/example-workspace) to get started.
