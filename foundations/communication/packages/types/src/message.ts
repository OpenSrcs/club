...
import type { Attribute, BlobMetadata, Class, Mixin, Ref } from '@opensrcs/core'
...
// LinkPreview
export const linkPreviewType = 'application/vnd.club.link-preview' as const
...
export type AppletType = `application/vnd.club.applet.${string}`
