  ...
  private findOrCreateQuery<P, Q extends AnyQuery>(
    ...
    if (exists !== undefined) {
      if (this.unsubscribed.has(exists.id)) {
        ...
        return new QueryClass(this.client, this.clublake, id, params, options, callback, result)
      }
    }

    return new QueryClass(this.client, this.clublake, id, params, options, callback, undefined)
  }
