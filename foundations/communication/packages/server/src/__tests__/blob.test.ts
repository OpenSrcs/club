...
import { MeasureContext, SortingOrder, WorkspaceUuid, PersonUuid } from '@opensrcs/core'
...
describe('Blob', () => {
  let blob: Blob
  let mockClient: jest.Mocked<ClublakeWorkspaceClient>
  ...
  beforeEach(() => {
    ...
    mockMetadata = {
      ...
      clublakeUrl: 'http://clublake.test',
      secret: 'test-secret',
      messagesPerBlob: 100
    }
