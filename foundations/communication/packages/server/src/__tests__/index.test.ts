...
import { Event, EventResult, SessionData } from '@opensrcs/communication-sdk-types'
import { createDbAdapter } from '@opensrcs/communication-cockroach'
...
// Mock dependencies
jest.mock('@opensrcs/communication-cockroach')
jest.mock('../metadata')
