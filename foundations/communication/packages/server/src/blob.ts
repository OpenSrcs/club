...
import { getWorkspaceClient, type ClublakeWorkspaceClient, type JsonPatch } from '@opensrcs/clublake-client'
...
export class Blob {
  private readonly client: ClublakeWorkspaceClient
  ...
  constructor (private readonly ctx: MeasureContext, private readonly workspace: WorkspaceUuid, private readonly metadata: Metadata) {
    this.client = getWorkspaceClient(metadata.clublakeUrl, workspace, generateToken(systemAccountUuid, workspace, undefined, metadata.secret))
  }
