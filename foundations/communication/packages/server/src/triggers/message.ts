...
import { CardPeer, MessageType, Peer } from '@opensrcs/communication-types'
import { type AccountUuid, generateId } from '@opensrcs/core'
import { extractReferences } from '@opensrcs/text-core'
