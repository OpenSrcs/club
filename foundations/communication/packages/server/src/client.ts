...
import { Account, MeasureContext, systemAccountUuid } from '@opensrcs/core'
...
import { getWorkspaceClient, ClublakeWorkspaceClient } from '@opensrcs/clublake-client'
...
export class LowLevelClient {
  ...
  private readonly lake: ClublakeWorkspaceClient
  ...
  constructor (
    ...
    this.lake = getWorkspaceClient(metadata.clublakeUrl, workspace, generateToken(systemAccountUuid, workspace, undefined, metadata.secret))
  }
