...
**This repository is not a standalone project** and is intended to be used **only** as a submodule within https://github.com/opensrcs/club.
...
Cloning this repository by itself will not provide the full dependency structure. To set everything up correctly, clone and initialize https://github.com/opensrcs/club.
