...
[![GitHub License](https://img.shields.io/github/license/opensrcs/club.server?style=for-the-badge)](LICENSE)

⭐️ Your star shines on us. Star us on GitHub!

## About

club Server is a collection of server-side packages extracted from the [OpenSrcs Club](https://github.com/opensrcs/club). This repository contains backend infrastructure components, storage adapters, and server-side utilities that power the club ecosystem.
...
- [@opensrcs/server-core](packages/core) - Core server infrastructure, adapters, storage management, and server-side utilities
- [@opensrcs/server](packages/server) - Main server implementation and runtime
- [@opensrcs/server-client](packages/client) - Server-side client implementation for inter-service communication
- [@opensrcs/middleware](packages/middleware) - Server middleware components and request processing

### Database Adapters

- [@opensrcs/mongo](packages/mongo) - MongoDB adapter for document storage
- [@opensrcs/postgres](packages/postgres) - PostgreSQL adapter for relational data
- [@opensrcs/elastic](packages/elastic) - Elasticsearch adapter for full-text search and analytics

### Storage Providers

- [@opensrcs/server-storage](packages/server-storage) - Storage abstraction layer and implementations
- [@opensrcs/minio](packages/minio) - MinIO storage provider for object storage
- [@opensrcs/s3](packages/s3) - AWS S3 compatible storage provider
- [@opensrcs/datalake](packages/datalake) - Data lake storage and management
- [@opensrcs/clublake](packages/clublake) - club lake storage and management

### Infrastructure

- [@opensrcs/kafka](packages/kafka) - Apache Kafka integration for event streaming and messaging
- [@opensrcs/collaboration](packages/collaboration) - Real-time collaborative editing infrastructure
...
POSTGRES_URL=postgresql://localhost:5432/club
...
- [club Core](https://github.com/opensrcs/club.core) - Core packages and client libraries
