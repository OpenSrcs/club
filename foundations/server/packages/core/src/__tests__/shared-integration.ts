 ...
 * ```typescript
 * import { runSharedIntegrationTests } from '@opensrcs/server-core/src/__tests__/shared-integration.test'
 *
...
import core, { type Client, type Ref, SortingOrder, type Space, type TxOperations } from '@opensrcs/core'
