...
import { Class, Doc, MeasureMetricsContext, PersonId, Ref, Space, WorkspaceUuid } from '@opensrcs/core'
import type { FullTextAdapter, IndexedDoc } from '@opensrcs/server-core'
