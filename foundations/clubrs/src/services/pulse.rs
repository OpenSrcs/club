...
const PULSE_TTL_HEADER: HeaderName = HeaderName::from_static("club-ttl");
const PULSE_EXPIRE_AT_HEADER: HeaderName = HeaderName::from_static("club-expire-at");
...
mod tests {
    ...
    fn test_make_rest_api_endpoint() {
        ...
        check_url(
            "wss://pulse.club.opensrcs.org/ws",
            "https://pulse.club.opensrcs.org/api/workspace",
        );
