...
use clubrs::services::kvs::KvsClient;
use clubrs::services::transactor::backend::http::HttpBackend;
use clubrs::services::{core::WorkspaceUuid, jwt::ClaimsBuilder, transactor::TransactorClient};
use serde::{Deserialize, Serialize};
use serde_json as json;

use super::state::SyncState;
use crate::config::CONFIG;
use crate::config::clubrs::SERVICES;
...
pub struct SyncInfo {
    pub club_workspace_id: WorkspaceUuid,
    ...
    #[serde(default)]
    pub club_space_id: String,
    pub club_card_id: String,
    pub club_card_title: String,
}
...
impl SyncContext {
    ...
    pub async fn store_sync_info(global: &Arc<GlobalContext>, info: &SyncInfo) -> Result<()> {
        ...
        let ref_key = sync_key_ref(info.club_workspace_id, &info.club_card_id);
    ...
    pub fn set_club_card_id(self, club_card_id: String) -> Self {
        let info = SyncInfo {
            club_card_id,
            ..self.info
        };
