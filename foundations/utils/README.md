...
club Utils is a monorepo managed by [Rush](https://rushjs.io/) that contains build tools to club platform.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/opensrcs/club.utils.git
   cd club.utils
   ```
