# GitHub Copilot Instructions - club Core
...
3. **All packages extend `@opensrcs/club-rig`** for tsconfig/eslint - don't override configs
...
├── package.json          # Scope: @opensrcs/, main: lib/index.js
...
**Plugin System**: `@opensrcs/club` provides dependency injection. Packages register resources/services via plugin manifests. Example: `packages/core/src/plugin.ts`
