...
import clientPlugin from '@opensrcs/client'
import type { ClientFactoryOptions } from '@opensrcs/client/src'
import core, {
  Client,
  LoadModelResponse,
  type PersonUuid,
...
import platform, { Severity, Status, getMetadata, getPlugins, setPlatformStatus } from '@opensrcs/club'
