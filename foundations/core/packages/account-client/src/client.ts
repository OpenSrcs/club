...
import platform, { PlatformError, Severity, Status } from '@opensrcs/club'
import type {
...
export interface AccountClient {
  ...
  addClubAssistantSocialId: () => Promise<PersonId>
  refreshClubAssistantToken: () => Promise<void>
...
class AccountClientImpl implements AccountClient {
  ...
  async addClubAssistantSocialId (): Promise<PersonId> {
    const request = {
      method: 'addClubAssistantSocialId' as const,
      params: {}
    }
  ...
  async refreshClubAssistantToken (): Promise<void> {
    const request = {
      method: 'refreshClubAssistantToken' as const,
      params: {}
    }
