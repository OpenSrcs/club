...
import { MarkupNode, MarkupNodeType, MarkupMarkType } from '@opensrcs/text-core'
...
<img src="https://github.com/user-attachments/assets/e21431a3-2062-4b0b-9c8f-d06c92ede741" alt="Screenshot 2025-09-11 at 15 43 50" width="250" height="210" >`
    ...
    {
      name: 'Sub',
      markdown: '<sub>View in club <a href="http://localhost:8080/guest/github?token=token">TSK-50</a></sub>'
    }
    // {
    //   name: 'Malformed',
