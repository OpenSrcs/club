...
import { addLocation, getResource } from '@opensrcs/club'
...
async function createClient (
  ...
  addLocation(clientId, () => {
    ...
    if (typeof window === 'undefined') {
      ...
      return Promise.resolve(require('@opensrcs/client-resources'))
    }
    return import(/* webpackChunkName: "client" */ '@opensrcs/client-resources')
  })
