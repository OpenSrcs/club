# club on Network example

## Building club on top of club Network

club could be managed by following set of container kinds, `session`, `query`, `transactor`.
...
flowchart
  ...
  transactor:ws1 -..->|event's| ClubPulse
