 ...
 * 
 * @example
 * // Start the club Network server first:
...
import { AgentImpl, containerUuid as generateContainerUuid, TickManagerImpl, containerOnAgentEndpointRef, NetworkImpl } from '@opensrcs/network-core'
import { createNetworkClient, type StatelessContainersFactory, NetworkAgentServer } from '@opensrcs/network-client'
