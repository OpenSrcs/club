...
import activity, { DocUpdateMessage } from '@opensrcs/activity'
import { Analytics } from '@opensrcs/analytics'
import { loadCollabJson, loadCollabYdoc, saveCollabJson, saveCollabYdoc } from '@opensrcs/collaboration'
import { decodeDocumentId } from '@opensrcs/collaborator-client'
import { CreateMessageEvent, MessageEventType } from '@opensrcs/communication-sdk-types'
import { ActivityCollaborativeChange, ActivityUpdateType, MessageType } from '@opensrcs/communication-types'
import core, { AttachedData, Doc, MeasureContext, OperationDomain, Ref, Space, TxOperations } from '@opensrcs/core'
import { StorageAdapter } from '@opensrcs/server-core'
import { areEqualMarkups } from '@opensrcs/text'
import { markupToYDoc } from '@opensrcs/text-ydoc'
