import { saveCollabJson } from '@opensrcs/collaboration'
import core, {
  type AttachedDoc,
  type Class,
  type Data,
...
import { type ModelLogger } from '@opensrcs/model'
import { makeRank } from '@opensrcs/rank'
import { ClubFormatImporter, StorageFileUploader } from '@opensrcs/importer'
...
export class WorkspaceInitializer {
  ...
  private async processImport (step: ImportStep, vars: Record<string, any>, logger: ModelLogger): Promise<void> {
    try {
      ...
      const importer = new ClubFormatImporter(this.client, uploader, logger, vars)
