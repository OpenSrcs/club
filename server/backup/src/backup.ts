...
import { type Person as GlobalPerson, type SocialId, type AccountDB } from '@opensrcs/account'
import contact, { type Person, type SocialIdentity, type SocialIdentityRef } from '@opensrcs/contact'
import { DOMAIN_CHANNEL, DOMAIN_CONTACT } from '@opensrcs/model-contact'
import { BlobClient } from '@opensrcs/server-client'
import { BackupClientOps, createDummyStorageAdapter, estimateDocSize, type Pipeline } from '@opensrcs/server-core'
...
export async function backup (
  ...
  const tmpRoot = mkdtempSync('club')
