...
OpenSrcs Club, please report it privately — **do not open a public issue.**

Use GitHub's private vulnerability reporting:

1. Go to the [Security tab](https://github.com/opensrcs/club/security) of this repository.
