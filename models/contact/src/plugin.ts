...
import type { Client, Doc, DocManager, DocumentQuery, Ref } from '@opensrcs/core'
import { type ObjectSearchCategory, type ObjectSearchFactory } from '@opensrcs/model-presentation'
import { type NotificationGroup } from '@opensrcs/notification'
import { type IntlString, mergeIds, type Resource } from '@opensrcs/club'
import { type TemplateFieldFunc } from '@opensrcs/templates'
import { type AnyComponent, type Location } from '@opensrcs/ui/src/types'
import { type Action, type ActionCategory, type ViewAction } from '@opensrcs/view'
