...
import activity, { type ActivityMessageControl } from '@opensrcs/activity'
import { type Role, type Card } from '@opensrcs/card'
import {
  AvatarType,
  type UserRole,
  contactId,
...
import attachment from '@opensrcs/model-attachment'
import chunter from '@opensrcs/model-chunter'
import core, { TAttachedDoc, TDoc, TSpace } from '@opensrcs/model-core'
import { createPublicLinkAction } from '@opensrcs/model-guest'
import { generateClassNotificationTypes } from '@opensrcs/model-notification'
import presentation from '@opensrcs/model-presentation'
import view, { createAction, createAttributePresenter, type Viewlet } from '@opensrcs/model-view'
import workbench from '@opensrcs/model-workbench'
import notification from '@opensrcs/notification'
import { getEmbeddedLabel, type Asset, type IntlString, type Resource } from '@opensrcs/club'
import setting from '@opensrcs/setting'
import templates from '@opensrcs/templates'
...
import preference, { TPreference } from '@opensrcs/model-preference'

export { contactId } from '@opensrcs/contact'
...
export function createModel (builder: Builder): void {
  ...
  builder.createDoc(
    ...
    core.space.Model,
    {
      label: getEmbeddedLabel('club'),
      icon: contact.icon.club,
      type: SocialIdType.CLUB
    },
    contact.socialIdentityProvider.club
  )
