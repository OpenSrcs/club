...
import core, { type AccountUuid, type Ref, type Space } from '@opensrcs/core'
import {
  migrateSpace,
  type MigrateUpdate,
...
import setting, { DOMAIN_SETTING, type Integration, settingId } from '@opensrcs/setting'
import { getSocialKeyByOldAccount, getUniqueAccountsFromOldAccounts } from '@opensrcs/model-core'
