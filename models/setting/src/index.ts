...
import { Mixin, Model, Prop, TypeRecord, UX, type Builder } from '@opensrcs/model'
import core, { TClass, TConfiguration, TDoc } from '@opensrcs/model-core'
...
export { settingId } from '@opensrcs/setting'
