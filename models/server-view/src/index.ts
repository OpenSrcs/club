...
import { type Builder, Mixin } from '@opensrcs/model'
...
import serverView, { type ServerLinkIdProvider } from '@opensrcs/server-view'

export { serverViewId } from '@opensrcs/server-view'
