...
import { type IntegrationSecret } from '@opensrcs/account-client'
import {
  AccessLevel,
  type Calendar,
  calendarId,
...
import contact, { type SocialIdentity, type SocialIdentityRef } from '@opensrcs/contact'
import core, {
  type AccountUuid,
  buildSocialIdString,
  type Doc,
...
import setting, { DOMAIN_SETTING, type Integration } from '@opensrcs/setting'
