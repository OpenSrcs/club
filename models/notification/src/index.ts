...
import activity, { type ActivityMessage, type Reaction } from '@opensrcs/activity'
import { type PersonSpace } from '@opensrcs/contact'
import {
  AccountRole,
  type Collaborator,
  type CollectionSize,
...
import view, { createAction, template } from '@opensrcs/model-view'
...
export { DOMAIN_DOC_NOTIFY, DOMAIN_NOTIFICATION, DOMAIN_USER_NOTIFY, notificationId } from '@opensrcs/notification'
