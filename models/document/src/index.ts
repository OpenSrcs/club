//
// Copyright © 2022, 2023, 2024 OpenSrcs.
//
...
import { AccountRole, AccountUuid, IndexKind } from '@opensrcs/core'
import { type Document, type DocumentSnapshot, type Teamspace, documentId } from '@opensrcs/document'
import {
  type Builder,
  Collection,
  Hidden,
...
import core, { TDoc, TTypedSpace } from '@opensrcs/model-core'
...
import view, { actionTemplates, createAction } from '@opensrcs/model-view'
import workbench from '@opensrcs/model-workbench'
import notification from '@opensrcs/notification'
import { type Asset, getEmbeddedLabel } from '@opensrcs/club'
import tags from '@opensrcs/tags'
import time, { type ToDo, type Todoable } from '@opensrcs/time'
import { definePermissions } from './permissions'
import document from './plugin'

export { documentId } from '@opensrcs/document'
