...
import { type Document, type DocumentSnapshot, type Teamspace } from '@opensrcs/document'
import {
  migrateSpaceRanks,
  tryMigrate,
...
import core, { DOMAIN_SPACE, getAccountUuidBySocialKey, getSocialKeyByOldAccount } from '@opensrcs/model-core'
import { DOMAIN_NOTIFICATION } from '@opensrcs/notification'
import { type Asset } from '@opensrcs/club'
import { makeRank } from '@opensrcs/rank'

import { loadCollabYdoc, saveCollabYdoc, yDocCopyXmlField } from '@opensrcs/collaboration'
import attachment, { DOMAIN_ATTACHMENT } from '@opensrcs/model-attachment'
