...
import calendar, { TEvent, TSchedule } from '@opensrcs/model-calendar'
...
import view, { createAction, createAttributePresenter } from '@opensrcs/model-view'
import media from '@opensrcs/media'
...
import workbench, { WidgetType } from '@opensrcs/workbench'
...
export { loveId } from '@opensrcs/love'
