...
import type { ActivityMessage, DocUpdateMessageViewlet } from '@opensrcs/activity'
import { attachmentId } from '@opensrcs/attachment'
import attachment from '@opensrcs/attachment-resources/src/plugin'
import type { Ref, Doc } from '@opensrcs/core'
