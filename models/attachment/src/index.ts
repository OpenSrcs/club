...
import type {
  ...
  Photo,
  SavedAttachments
} from '@opensrcs/attachment'
import { AccountRole, IndexKind, type Blob, type Class, type Doc, type Domain, type Ref } from '@opensrcs/core'
import {
  Hidden,
  Index,
  Model,
...
export { attachmentId } from '@opensrcs/attachment'
