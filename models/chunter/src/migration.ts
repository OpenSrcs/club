...
import { chunterId, type ThreadMessage } from '@opensrcs/chunter'
import core, {
  TxOperations,
  type Class,
  type Doc,
...
import activity, { migrateMessagesSpace, DOMAIN_ACTIVITY } from '@opensrcs/model-activity'
import notification from '@opensrcs/notification'
import contact, { getAllAccounts } from '@opensrcs/contact'
import { DOMAIN_DOC_NOTIFY, DOMAIN_NOTIFICATION } from '@opensrcs/model-notification'
import { type DocUpdateMessage } from '@opensrcs/activity'
