...
import view, { actionTemplates as viewTemplates, createAction, template } from '@opensrcs/model-view'
import notification, { notificationActionTemplates } from '@opensrcs/model-notification'
