...
import type { ActivityMessage } from '@opensrcs/activity'
import { chunterId, type Channel } from '@opensrcs/chunter'
import chunter from '@opensrcs/chunter-resources/src/plugin'
import { type Client, type Doc, type Ref } from '@opensrcs/core'
import { type NotificationGroup } from '@opensrcs/notification'
import type { IntlString, Resource } from '@opensrcs/club'
import { mergeIds } from '@opensrcs/club'
import type { AnyComponent, Location } from '@opensrcs/ui/src/types'
import type { Action, ActionCategory, ViewAction, Viewlet, ViewletDescriptor } from '@opensrcs/view'
import { type WidgetTab, type LocationData } from '@opensrcs/workbench'
