...
import core, { TClass, TDoc, TSpace } from '@opensrcs/model-core'
import type {
  Channel,
  ChatMessage,
  ChatMessageViewlet,
...
import contact, { type ChannelProvider as SocialChannelProvider, type Person } from '@opensrcs/contact'
import activity, { type ActivityMessage } from '@opensrcs/activity'
import { TActivityMessage } from '@opensrcs/model-activity'
import attachment from '@opensrcs/model-attachment'
import type { IntlString } from '@opensrcs/club'
import type { DocNotifyContext } from '@opensrcs/notification'
