...
import notification from '@opensrcs/model-notification'
import core from '@opensrcs/model-core'
import activity from '@opensrcs/activity'

import chunter from './plugin'
import { type ClassCollaborators } from '@opensrcs/core'
import { type Channel, type DirectMessage } from '@opensrcs/chunter'
