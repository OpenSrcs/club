...
import type { Doc, Ref, Status } from '@opensrcs/core'
import { leadId } from '@opensrcs/lead'
import lead from '@opensrcs/lead-resources/src/plugin'
...
import { type TaskTypeDescriptor } from '@opensrcs/task'
import type { AnyComponent } from '@opensrcs/ui/src/types'
import { type Action, type ActionCategory, type Viewlet } from '@opensrcs/view'
