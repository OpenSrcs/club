...
import { AccountRole, type ClassCollaborators, SortingOrder, type FindOptions } from '@opensrcs/core'
import { leadId, type Lead } from '@opensrcs/lead'
...
import view, { createAction, actionTemplates as viewTemplates } from '@opensrcs/model-view'
...
import { type ViewOptionsModel } from '@opensrcs/view'
...
export { leadId } from '@opensrcs/lead'
