...
import { type Customer, type Funnel, type Lead } from '@opensrcs/lead'
import {
  Collection,
  Index,
  Mixin,
...
import contact, { TContact } from '@opensrcs/model-contact'
import core from '@opensrcs/model-core'
import task, { TProject, TTask } from '@opensrcs/model-task'
