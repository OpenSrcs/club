...
import '@opensrcs/controlled-documents'
import { productsId } from '@opensrcs/products'
import products from '@opensrcs/products-resources/src/plugin'
import type { Client, Doc, Ref, Role } from '@opensrcs/core'
import { type Resource, mergeIds } from '@opensrcs/club'
import { type AnyComponent } from '@opensrcs/ui/src/types'
import type { Action, ViewAction } from '@opensrcs/view'
