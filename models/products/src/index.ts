...
import documents, { TExternalSpace, TProject } from '@opensrcs/model-controlled-documents'
import type { Document } from '@opensrcs/controlled-documents'
import type { Product, ProductVersionState, ProductVersion } from '@opensrcs/products'
...
import { getRoleAttributeProps } from '@opensrcs/setting'
import type {
  Type,
  Ref,
  CollectionSize,
...
import { AccountRole, IndexKind, AccountUuid } from '@opensrcs/core'
import {
  type Builder,
  Model,
  Prop,
...
import core, { TType } from '@opensrcs/model-core'
...
import { getEmbeddedLabel, type Asset } from '@opensrcs/club'

import products from './plugin'
import { roles } from './roles'

export { productsId } from '@opensrcs/products/src/index'
