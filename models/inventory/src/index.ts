...
import { type Domain, IndexKind, type Ref } from '@opensrcs/core'
import { type Category, type Product, type Variant, inventoryId } from '@opensrcs/inventory'
import { type Builder, Collection, Index, Model, Prop, TypeRef, TypeString, UX } from '@opensrcs/model'
...
export { inventoryId } from '@opensrcs/inventory'
