...
import { type Doc, type DocManager, type Ref, type StatusCategory } from '@opensrcs/core'
import { type NotificationGroup, type NotificationType } from '@opensrcs/notification'
import { mergeIds, type IntlString, type Resource } from '@opensrcs/club'
import { type ProjectType } from '@opensrcs/task'
import { trackerId } from '@opensrcs/tracker'
import tracker from '@opensrcs/tracker-resources/src/plugin'
import type { AnyComponent } from '@opensrcs/ui/src/types'
import { type Action, type ViewAction, type Viewlet, type ViewletViewAction } from '@opensrcs/view'
