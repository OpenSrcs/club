...
import { type Channel } from '@opensrcs/contact'
import { type Class, type Domain, IndexKind, type Ref, type Timestamp, type Type } from '@opensrcs/core'
import {
  ArrOf,
  type Builder,
  Collection,
...
export { telegramId } from '@opensrcs/telegram'
