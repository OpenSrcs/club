...
import type { Employee, Organization } from '@opensrcs/contact'
import {
  IndexKind,
  type Collection,
  type MarkupBlobRef,
...
import calendar, { TEvent } from '@opensrcs/model-calendar'
import chunter from '@opensrcs/model-chunter'
import contact, { TOrganization, TPerson } from '@opensrcs/model-contact'
import core, { TAttachedDoc } from '@opensrcs/model-core'
import tags from '@opensrcs/model-tags'
import task, { DOMAIN_TASK, TProject, TTask } from '@opensrcs/model-task'
...
import type {
  ...
  Vacancy,
  VacancyList
} from '@opensrcs/recruit'
import survey, { type Poll } from '@opensrcs/survey'
