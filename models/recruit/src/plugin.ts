...
import type { Client, Doc, Ref, Status } from '@opensrcs/core'
import { type NotificationGroup, type NotificationType } from '@opensrcs/notification'
import type { IntlString, Status as OperationStatus, Resource } from '@opensrcs/club'
import { mergeIds } from '@opensrcs/club'
import { recruitId } from '@opensrcs/recruit'
import recruit from '@opensrcs/recruit-resources/src/plugin'
import { type ProjectType, type TaskTypeDescriptor } from '@opensrcs/task'
