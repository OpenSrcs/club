...
import { AccountRole, type ClassCollaborators, SortingOrder, type Lookup, type Ref } from '@opensrcs/core'
import { type Builder } from '@opensrcs/model'
import calendar from '@opensrcs/model-calendar'
import chunter from '@opensrcs/model-chunter'
import contact from '@opensrcs/model-contact'
import core from '@opensrcs/model-core'
import gmail from '@opensrcs/model-gmail'
...
import tags from '@opensrcs/model-tags'
import task, { actionTemplates } from '@opensrcs/model-task'
import tracker from '@opensrcs/model-tracker'
import view, { createAction, showColorsViewOption, actionTemplates as viewTemplates } from '@opensrcs/model-view'
import workbench, { createNavigateAction, type Application } from '@opensrcs/model-workbench'
import notification from '@opensrcs/notification'
import { type IntlString } from '@opensrcs/club'
import { recruitId, type Applicant, RecruitEvents, type Vacancy } from '@opensrcs/recruit'
import setting from '@opensrcs/setting'
import { type KeyBinding, type ViewOptionModel, type ViewOptionsModel } from '@opensrcs/view'
...
export { recruitId } from '@opensrcs/recruit'
