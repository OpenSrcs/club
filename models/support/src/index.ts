...
import core, { DOMAIN_MODEL, type Domain, IndexKind } from '@opensrcs/core'
import { type Builder, Index, Model } from '@opensrcs/model'
import preference, { TPreference } from '@opensrcs/model-preference'
import support, {
  type SupportConversation,
  type SupportSystem,
  type SupportWidgetFactory
} from '@opensrcs/support'

import { TDoc } from '@opensrcs/model-core'
import { type Resource } from '@opensrcs/club'

export { supportId } from '@opensrcs/support'
