...
import { type Domain, DOMAIN_MODEL, IndexKind, type Ref, type Markup, AccountRole } from '@opensrcs/core'
import { type Builder, Index, Model, Prop, TypeString, UX, TypeMarkup } from '@opensrcs/model'
import core, { TDoc, TSpace } from '@opensrcs/model-core'
import textEditor from '@opensrcs/model-text-editor'
import tracker from '@opensrcs/model-tracker'
import view, { createAction } from '@opensrcs/model-view'
import { type IntlString, type Resource } from '@opensrcs/club'
...
import type {
  ...
  TemplateFieldFunc
} from '@opensrcs/templates'
import templates from './plugin'

export { templatesId } from '@opensrcs/templates'
