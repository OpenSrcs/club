...
import { type SettingsCategory } from '@opensrcs/setting'
import { templatesId } from '@opensrcs/templates'
import templates from '@opensrcs/templates-resources/src/plugin'

import { type RefInputAction, type RefInputActionItem } from '@opensrcs/model-text-editor'
