...
import { AccountRole, type AccountUuid, type Class, DOMAIN_MODEL, type Ref, type Space } from '@opensrcs/core'
import { type Builder, Mixin, Model, Prop, TypeRef, UX } from '@opensrcs/model'
import preference, { TPreference } from '@opensrcs/model-preference'
import { createAction } from '@opensrcs/model-view'
import core, { TClass, TDoc } from '@opensrcs/model-core'
import { type Asset, getEmbeddedLabel, type IntlString, type Resource } from '@opensrcs/club'
import view, { type KeyBinding } from '@opensrcs/view'
import type {
  Application,
  ApplicationNavModel,
  HiddenApplication,
...
export { workbenchId } from '@opensrcs/workbench'
export { workbenchOperation } from './migration'
export type { Application, Widget }
export { WidgetType } from '@opensrcs/workbench'
