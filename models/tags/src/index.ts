...
import { type Class, type Doc, type Domain, IndexKind, type Ref } from '@opensrcs/core'
import { ArrOf, type Builder, Index, Model, Prop, TypeNumber, TypeRef, TypeString, UX } from '@opensrcs/model'
...
export { type TagCategory, type TagElement, type TagReference, tagsId } from '@opensrcs/tags'
