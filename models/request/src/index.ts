...
import { type Timestamp, type Domain, type Ref, type Tx, type ClassCollaborators } from '@opensrcs/core'
import {
  ArrOf,
  type Builder,
  Collection,
...
import core, { TAttachedDoc, TClass } from '@opensrcs/model-core'
