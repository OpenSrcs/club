...
import { ArrOf, type Builder, Model, TypeAny, TypeNumber, TypeRef } from '@opensrcs/model'
import core, { TAttachedDoc, TConfiguration, TDoc } from '@opensrcs/model-core'
import { type Class, type Domain, DOMAIN_MODEL, type Ref } from '@opensrcs/core'
import { type Asset, type IntlString } from '@opensrcs/club'
import {
  type Applet,
  type MessageAction,
...
import { type AppletType } from '@opensrcs/communication-types'
import card, { createSystemType } from '@opensrcs/model-card'
import type { AnyComponent } from '@opensrcs/ui'
import contact, { type PersonSpace } from '@opensrcs/contact'
import { type Card, type MasterTag } from '@opensrcs/card'
import { DOMAIN_SETTING } from '@opensrcs/setting'
import view from '@opensrcs/model-view'
