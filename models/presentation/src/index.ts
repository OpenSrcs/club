...
import { Mixin, Model, Prop, TypeRef, TypeString, type Builder } from '@opensrcs/model'
import core, { TClass, TDoc } from '@opensrcs/model-core'
import { type Asset, type IntlString, type Resource } from '@opensrcs/club'
...
} from '@opensrcs/presentation/src/pipeline'
import {
...
} from '@opensrcs/presentation/src/types'
import { type AnyComponent, type ComponentExtensionId } from '@opensrcs/ui/src/types'
import presentation from './plugin'

export { presentationId } from '@opensrcs/presentation/src/plugin'
