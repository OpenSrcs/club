...
import { type Builder, Mixin, Model, Prop, TypeRecord, TypeRef, TypeString, UX } from '@opensrcs/model'
...
import { type Asset, getEmbeddedLabel, type IntlString, type Resource, type Status } from '@opensrcs/club'
import {
  type AnyComponent,
  type ComponentExtensionId,
  type LabelAndProps,
  type Location
} from '@opensrcs/ui/src/types'
import {
  type TypeEditor,
  type Action,
  type ActionCategory,
...
export { viewId } from '@opensrcs/view'
