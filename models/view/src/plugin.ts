...
import { type Blob, type BlobMetadata, type Doc, type Ref } from '@opensrcs/core'
...
import { type FileOrBlob, type FilePreviewExtension } from '@opensrcs/presentation/src/types'
