...
import { DOMAIN_MODEL } from '@opensrcs/core'
import { Model, type Builder } from '@opensrcs/model'
import core, { TDoc } from '@opensrcs/model-core'
...
} from '@opensrcs/text-editor'
import view from '@opensrcs/view'
import textEditor from './plugin'
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import type { EditorKitOptions } from '@opensrcs/text-editor-resources/src/kits/editor-kit'
export { textEditorId } from '@opensrcs/text-editor'
