...
import { type Contact, type Employee } from '@opensrcs/contact'
import {
  AccountRole,
  DOMAIN_MODEL,
  IndexKind,
...
import contact, { TEmployee } from '@opensrcs/model-contact'
import core, { TAttachedDoc, TDoc, TType } from '@opensrcs/model-core'
