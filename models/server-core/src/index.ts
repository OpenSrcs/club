...
import { Mixin, Model, type Builder } from '@opensrcs/model'
import { TClass, TDoc } from '@opensrcs/model-core'
import type { Resource } from '@opensrcs/club'

import core, { DOMAIN_MODEL } from '@opensrcs/core'
import type {
...
export { serverCoreId } from '@opensrcs/server-core'
