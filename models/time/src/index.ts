...
import board from '@opensrcs/board'
import calendarPlugin, { type Visibility } from '@opensrcs/calendar'
import contactPlugin, { type Employee } from '@opensrcs/contact'
import {
  AccountRole,
  DOMAIN_MODEL,
  DateRangeMode,
...
import { TEvent } from '@opensrcs/model-calendar'
import core, { TAttachedDoc, TClass, TDoc, TType } from '@opensrcs/model-core'
import document from '@opensrcs/model-document'
...
import notification, { type NotificationGroup } from '@opensrcs/notification'
...
import type { Rank } from '@opensrcs/task'
import task from '@opensrcs/task'
import time from './plugin'

export { timeId } from '@opensrcs/time'
