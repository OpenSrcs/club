...
import notification, { type NotificationType } from '@opensrcs/notification'
import { type Asset, type IntlString } from '@opensrcs/club'
import type { BuildModelKey, KeyFilterPreset, Viewlet, ViewletDescriptor } from '@opensrcs/view'
import questions from '@opensrcs/model-questions'
...
import setting, { getRoleAttributeProps } from '@opensrcs/setting'
import {
  type Training,
...
import { Prop, type Builder } from '@opensrcs/model'
...
export { trainingId } from '@opensrcs/training/src/index'
