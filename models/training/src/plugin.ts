...
import training from '@opensrcs/training-resources/src/plugin'
...
export default mergeIds(trainingId, training, {
  ...
  //    > The inferred type of 'default' cannot be named without a reference to '[..]/node_modules/@opensrcs/ui/src'.
