...
import { type Builder, Model, Prop, ReadOnly, TypeString, UX, TypeBoolean, TypeAccountUuid } from '@opensrcs/model'
import { type OnboardingChannel } from '@opensrcs/analytics-collector'
import chunter from '@opensrcs/chunter'
import { TChannel } from '@opensrcs/model-chunter'
import activity, { type ActivityMessageControl } from '@opensrcs/activity'
import core, { type AccountUuid, type WorkspaceUuid } from '@opensrcs/core'

import analyticsCollector from './plugin'

export { analyticsCollectorId } from '@opensrcs/analytics-collector'
