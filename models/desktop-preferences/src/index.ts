...
import desktopPreferences, { type DesktopNotificationPreference } from '@opensrcs/desktop-preferences'

export { desktopPreferencesId } from '@opensrcs/desktop-preferences'
