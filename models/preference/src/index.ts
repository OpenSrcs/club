...
import { type Ref, type Space } from '@opensrcs/core'
import { type Builder, Model, Prop, TypeRef, TypeString } from '@opensrcs/model'
import core, { TDoc } from '@opensrcs/model-core'
import preference, { DOMAIN_PREFERENCE, type Preference, type SpacePreference } from '@opensrcs/preference'

export { preferenceId } from '@opensrcs/preference'
