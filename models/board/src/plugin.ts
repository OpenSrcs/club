...
import { type Board, boardId } from '@opensrcs/board'
import board from '@opensrcs/board-resources/src/plugin'
import type { Ref, Sequence } from '@opensrcs/core'
import { type IntlString, mergeIds } from '@opensrcs/club'
import { type TaskTypeDescriptor, type ProjectType } from '@opensrcs/task'
import type { AnyComponent } from '@opensrcs/ui/src/types'
import { type Action, type ViewAction, type Viewlet, type ViewletDescriptor } from '@opensrcs/view'
