...
import core, { TDoc, TType } from '@opensrcs/model-core'
import preference, { TPreference } from '@opensrcs/model-preference'
import tags from '@opensrcs/model-tags'
import task, { actionTemplates as taskActionTemplates, TProject, TTask } from '@opensrcs/model-task'
import view, { actionTemplates, createAction, actionTemplates as viewTemplates } from '@opensrcs/model-view'
import workbench, { type Application } from '@opensrcs/model-workbench'
import { type IntlString } from '@opensrcs/club'
import type { AnyComponent } from '@opensrcs/ui/src/types'
import board from './plugin'

export { boardId } from '@opensrcs/board'
