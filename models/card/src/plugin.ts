...
import type { ViewletViewAction, Action, ActionCategory, ViewAction } from '@opensrcs/view'
import { type Card, cardId } from '@opensrcs/card'
import card from '@opensrcs/card-resources/src/plugin'
import type { Client, Doc, DocumentQuery, Ref } from '@opensrcs/core'
import {} from '@opensrcs/core'
import { mergeIds, type Resource } from '@opensrcs/club'
import { type TagCategory } from '@opensrcs/tags'
import { type Location, type ResolvedLocation } from '@opensrcs/ui/src/types'
import { type LocationData } from '@opensrcs/workbench'
import { type NotificationGroup, type NotificationType } from '@opensrcs/notification'
