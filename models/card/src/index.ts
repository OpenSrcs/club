...
import converter from '@opensrcs/converter'
import core, {
  AccountRole,
  type Blobs,
  type Class,
...
import { TRole as TBaseRole, TClass, TDoc, TMixin, TTypedSpace } from '@opensrcs/model-core'
...
import setting from '@opensrcs/model-setting'
import view, { type Viewlet } from '@opensrcs/model-view'
import workbench, { WidgetType } from '@opensrcs/model-workbench'
import notification from '@opensrcs/notification'
import { type Asset, getEmbeddedLabel, type IntlString, type Resource } from '@opensrcs/club'
import time, { type ToDo } from '@opensrcs/time'
import { PaletteColorIndexes } from '@opensrcs/ui/src/colors'
import { type AnyComponent } from '@opensrcs/ui/src/types'
import { type BuildModelKey, type ViewOptionModel } from '@opensrcs/view'
import { createActions } from './actions'
import { defineActionPermissions, definePermissions } from './permissions'
import card from './plugin'

export { cardId } from '@opensrcs/card'
