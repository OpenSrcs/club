...
import documents from '@opensrcs/controlled-documents-resources/src/plugin'
...
import type { ActionCategory, ViewAction, Viewlet, ViewletViewAction } from '@opensrcs/view'
import { type NotificationType, type NotificationGroup } from '@opensrcs/notification'
import { type TextActionVisibleFunction, type TextActionFunction } from '@opensrcs/text-editor'
