...
import exportPlugin from '@opensrcs/export'
...
import request from '@opensrcs/model-request'
import tracker from '@opensrcs/model-tracker'
import view, { classPresenter, createAction } from '@opensrcs/model-view'
...
import contacts from '@opensrcs/model-contact'
import setting from '@opensrcs/setting'
import tags from '@opensrcs/tags'
import textEditor from '@opensrcs/text-editor'

import { AccountRole, type ClassCollaborators, type Class, type Doc, type Lookup, type Ref } from '@opensrcs/core'
...
export { documentsId } from '@opensrcs/controlled-documents/src/index'
export * from './types'
