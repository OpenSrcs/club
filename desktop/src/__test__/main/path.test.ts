...
describe('path (bundled UI)', () => {
  ...
  test('getBundledUiDistPath joins getAppPath with dist/ui', () => {
    mockGetAppPath.mockReturnValue('/Applications/club.app/Contents/Resources/app.asar')
    expect(getBundledUiDistPath()).toBe(
      nodePath.join('/Applications/club.app/Contents/Resources/app.asar', 'dist', 'ui')
    )
  })
