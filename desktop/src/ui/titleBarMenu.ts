...
import { type ThemeVariantType } from '@opensrcs/theme'
...
export function buildClubApplicationMenu (minimizeToTrayEnabled: boolean, autoLaunchEnabled: boolean): HTMLElement {
...
class MenuBarManager {
  ...
  constructor (
    ...
    this.view = buildClubApplicationMenu(minimizeToTrayEnabled, autoLaunchEnabled)
  }
