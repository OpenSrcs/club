...
import { getEmbeddedLabel, getMetadata, getResource, translate } from '@opensrcs/club'
import presentation, { MessageBox, setDownloadProgress, getClient } from '@opensrcs/presentation'
...
import { handleDownloadItem } from '@opensrcs/desktop-downloads'
import notification, { notificationId } from '@opensrcs/notification'
import { inboxId } from '@opensrcs/inbox'
import workbench, { workbenchId, logOut } from '@opensrcs/workbench'
import view, { Action, encodeObjectURI } from '@opensrcs/view'
import { resolveLocation } from '@opensrcs/notification-resources'
import { themeStore, ThemeVariant } from '@opensrcs/theme'
import type { Application } from '@opensrcs/workbench'
import { isAllowedToRole } from '@opensrcs/workbench-resources'
import card from '@opensrcs/card'
import communication from '@opensrcs/communication'

import { isOwnerOrMaintainer, getCurrentAccount, Ref } from '@opensrcs/core'
import { configurePlatform } from './club'
