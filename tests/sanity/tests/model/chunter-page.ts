...
export class ChunterPage {
  ...
  readonly buttonChannelBrowser = (): Locator => this.page.locator('.clubNavPanel-header > button.type-button-icon')
  ...
  readonly buttonNewDirectChatModalNext = (): Locator => this.page.locator('.clubModal-footer button:has-text("Next")')
  readonly buttonNewDirectChatModalCreate = (): Locator =>
    this.page.locator('.clubModal-footer button:has-text("Create")')

  readonly directMessagesButtonInLeftMenu = (): Locator =>
    this.page.locator('.clubNavGroup-header:has-text("Direct messages")')
