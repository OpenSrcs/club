...
export class CommonPage {
  ...
  appHeader = (): Locator => this.page.locator('.clubNavPanel-header')
  ...
  clubPopupRowButton = (name: string): Locator =>
    this.page.locator('div.clubPopup-container button.clubPopup-row', { hasText: name })
  ...
  linesFromTable = (text: string = ''): Locator =>
    this.page.locator('.clubComponent table tbody tr').filter({ hasText: text })

  linesFromList = (text: string = ''): Locator =>
    this.page.locator('.clubComponent .list-container div.row').filter({ hasText: text })
  ...
  buttonBreadcrumb = (hasText?: string): Locator => this.page.locator('button.clubBreadcrumb-container', { hasText })
  ...
  async selectPopupItem (name: string): Promise<void> {
    await this.clubPopupRowButton(name).click({ delay: 100 })
  }
