...
export class ApplicationsPage extends CommonRecruitingPage {
  ...
  readonly buttonTypeSelector = (): Locator =>
    this.page.locator('div[class*="clubHeader-container"] div[class*="clubHeader-titleGroup"] button')
  ...
  async openApplicationByTalentName (talentName: TalentName): Promise<void> {
    await this.page
      ...
      .click()
    await expect(
      this.page.locator('div.clubHeader-container div.clubHeader-titleGroup', { hasText: talentName.lastName })
