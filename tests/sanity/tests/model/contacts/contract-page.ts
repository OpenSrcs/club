...
export class ContractPage {
  ...
  readonly employeeNavElement = (Employee: string): Locator =>
    this.page.locator(`.clubNavItem-container:has-text("${Employee}")`)

  readonly employeeButton = (Employee: string): Locator =>
    this.page.locator(`button:not(.clubNavItem-container, .clubBreadcrumb-container):has-text("${Employee}")`)
  ...
  readonly comapnyTab = (): Locator => this.page.locator('.clubNavItem-container:has-text("Company")')
