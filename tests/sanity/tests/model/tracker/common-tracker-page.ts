...
export class CommonTrackerPage extends CalendarPage {
  ...
  buttonMoreActions = (): Locator =>
    this.page.locator('.popupPanel > .clubHeader-container button[data-id="btnMoreActions"]')
  ...
  header = (): Locator =>
    this.page.locator('button.clubBreadcrumb-container > span.clubBreadcrumb-label', { hasText: 'Issues' })

  view = (): Locator => this.page.locator('.clubHeader-buttonsGroup > button[data-id="btn-viewOptions"]')
  showMore = (): Locator => this.page.locator('.clubHeader-buttonsGroup > button[data-id="btn-viewSetting"]')
  task1 = (): Locator => this.page.getByRole('link', { name: 'Welcome to club! 🌟' })
  ...
  task5 = (): Locator => this.page.getByRole('link', { name: 'Explore all club has to offer' })
