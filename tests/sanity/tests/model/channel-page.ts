...
export class ChannelPage extends CommonPage {
  ...
  readonly textMessage = (messageText: string, strict = false): Locator =>
    strict
      ? this.page.locator('.clubComponent .activityMessage div[data-delivered]', { hasText: messageText })
      : this.page.locator('.clubComponent .activityMessage', { hasText: messageText })
  ...
  readonly closeReplyButton = (): Locator => this.page.locator('.clubHeader-container > button.iconOnly')
  ...
  readonly inputSearchChannel = (): Locator => this.page.locator('.clubHeader-container').getByPlaceholder('Search')

  readonly channelContainers = (): Locator => this.page.locator('.clubNavItem-container')

  readonly starredChannelContainers = (): Locator =>
    this.page.locator('#navGroup-starred').locator('.clubNavItem-container')

  readonly issueChannelContainers = (): Locator =>
    this.page.locator('#navGroup-tracker\\:class\\:Issue').locator('.clubNavItem-container')

  readonly vacancyChannelContainers = (): Locator =>
    this.page.locator('#navGroup-recruit\\:class\\:Vacancy').locator('.clubNavItem-container')

  readonly applicationChannelContainers = (): Locator =>
    this.page.locator('#navGroup-recruit\\:class\\:Applicant').locator('.clubNavItem-container')
  ...
  async makeActionWithChannelInMenu (channelName: string, action: string): Promise<void> {
    ...
    await this.channelContainers().filter({ hasText: channelName }).locator('.clubNavItem-actions').click()
