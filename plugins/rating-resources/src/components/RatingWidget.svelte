<script lang="ts">
  import { getCurrentAccount, groupByArray, SortingOrder, type Class, type Doc, type Ref } from '@opensrcs/core'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import rating, { ReactionKind, type DocReaction } from '@opensrcs/rating'
  import { NavGroup, Label, ScrollBox } from '@opensrcs/ui'
