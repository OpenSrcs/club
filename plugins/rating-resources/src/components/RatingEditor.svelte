<script lang="ts">
  ...
  import core, { getCurrentAccount, groupByArray } from '@opensrcs/core'
  import emojiPlugin from '@opensrcs/emoji'
  import { translateCB, getEmbeddedLabel } from '@opensrcs/club'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import type { DocReaction } from '@opensrcs/rating'
  import ratingPlugin, { ReactionKind } from '@opensrcs/rating'
  import { Button, showPopup } from '@opensrcs/ui'
