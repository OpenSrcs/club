...
-->
<script lang="ts">
  import { AccountRole, Class, Doc, getCurrentAccount, Ref } from '@opensrcs/core'
  import notification, { BrowserNotification } from '@opensrcs/notification'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { addNotification, getCurrentResolvedLocation, Location, NotificationSeverity } from '@opensrcs/ui'
  import view from '@opensrcs/view'
  import { parseLinkId } from '@opensrcs/view-resources'
  import { Analytics } from '@opensrcs/analytics'
  import workbench, { Application } from '@opensrcs/workbench'
