...
-->
<script lang="ts">
  import { ButtonIcon, CheckBox, Component, IconMoreV, Label, Loading, showPopup, Spinner } from '@opensrcs/ui'
  import notification, {
  ...
  import { getDocTitle, getDocIdentifier, Menu } from '@opensrcs/view-resources'
  import { createEventDispatcher } from 'svelte'
  import { AccountRole, Class, Doc, getCurrentAccount, Ref, WithLookup } from '@opensrcs/core'
  import chunter from '@opensrcs/chunter'
  import { getPersonRefsByPersonIds } from '@opensrcs/contact-resources'
