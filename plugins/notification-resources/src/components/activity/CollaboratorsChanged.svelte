...
<script lang="ts">
  import activity, { DisplayDocUpdateMessage } from '@opensrcs/activity'
  import { employeeRefByAccountUuidStore, PersonRefPresenter } from '@opensrcs/contact-resources'
  import { Collaborator } from '@opensrcs/core'
