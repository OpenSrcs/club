<script lang="ts">
  import { Avatar, getPersonByPersonIdCb } from '@opensrcs/contact-resources'
  import { Class, Doc, Ref } from '@opensrcs/core'
  import { BrowserNotification } from '@opensrcs/notification'
  import { Button, navigate, Notification as PlatformNotification, NotificationToast } from '@opensrcs/ui'
  import view from '@opensrcs/view'
  import chunter, { ThreadMessage } from '@opensrcs/chunter'
  import { getResource } from '@opensrcs/club'
  import activity, { ActivityMessage } from '@opensrcs/activity'
  import { getClient, playSound } from '@opensrcs/presentation'
