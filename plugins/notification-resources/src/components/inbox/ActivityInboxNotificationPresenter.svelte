...
<script lang="ts">
  ...
  import { Ref, Space, matchQuery, Doc } from '@opensrcs/core'
  import notification, {
  ...
  import activity, { ActivityMessage, DisplayActivityMessage, DocUpdateMessage } from '@opensrcs/activity'
  import { Action, Component } from '@opensrcs/ui'
  import { getActions } from '@opensrcs/view-resources'
