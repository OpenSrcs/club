...
<script lang="ts">
  ...
  import { Class, Doc, getCurrentAccount, groupByArray, Ref, SortingOrder } from '@opensrcs/core'
  import { DocNotifyContext, InboxNotification, notificationId } from '@opensrcs/notification'
  ...
  import view, { decodeObjectURI } from '@opensrcs/view'
  import { parseLinkId } from '@opensrcs/view-resources'
...
<div class="clubPanels-container">
  {#if $deviceInfo.navigator.visible}
    ...
    >
      <div class="antiPanel-wrap__content clubNavPanel-container">
        <div class="clubNavPanel-header withButton small">
    ...
    />
  {/if}
  <div bind:this={replacedPanel} class="clubComponent">
