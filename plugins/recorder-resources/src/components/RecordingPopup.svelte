...
-->
<script lang="ts">
  import core, { type Blob, type Ref } from '@opensrcs/core'
  import drive, { createFile } from '@opensrcs/drive'
  import { getMediaDevices } from '@opensrcs/media'
  import { micAccess, camAccess } from '@opensrcs/media-resources'
  import { getEmbeddedLabel } from '@opensrcs/club'
  import { FilePreview, getClient, MessageBox, SpaceSelector } from '@opensrcs/presentation'
  import {
    EditBox,
    IconUpOutline,
    Label,
  ...
  import { openDocFromRef } from '@opensrcs/view-resources'
...
>
  ...
  <svelte:fragment slot="afterContent">
    <div class="clubModal-footer px-2">
