...
import { ActivityMessage, ActivityMessageViewlet } from '@opensrcs/activity'
import type { Class, Doc, Markup, Mixin, Ref, Space, Timestamp } from '@opensrcs/core'
import { NotificationType } from '@opensrcs/notification'
import type { Asset, Plugin, Resource } from '@opensrcs/club'
import { IntlString, plugin } from '@opensrcs/club'
import { AnyComponent } from '@opensrcs/ui'
import { Action } from '@opensrcs/view'
import { Person, ChannelProvider as SocialChannelProvider } from '@opensrcs/contact'
import { Widget, WidgetTab } from '@opensrcs/workbench'
