...
import type { Contact, Employee } from '@opensrcs/contact'
import type { Arr, AttachedDoc, Class, Doc, Markup, Mixin, Ref, Type } from '@opensrcs/core'
...
import { Viewlet } from '@opensrcs/view'
