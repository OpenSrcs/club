...
<script lang="ts">
  ...
  import { AttachmentRefInput } from '@opensrcs/attachment-resources'
  import contact, { Channel, Contact, Person, getName as getContactName } from '@opensrcs/contact'
  import { Avatar } from '@opensrcs/contact-resources'
  import core, { Ref, SortingOrder, generateId, getCurrentAccount } from '@opensrcs/core'
  import { InboxNotificationsClientImpl } from '@opensrcs/notification-resources'
  import { getEmbeddedLabel, getResource } from '@opensrcs/club'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import setting, { Integration } from '@opensrcs/setting'
  import type { NewTelegramMessage, SharedTelegramMessage, TelegramMessage } from '@opensrcs/telegram'
