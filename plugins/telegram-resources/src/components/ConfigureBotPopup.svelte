...
<script lang="ts">
  import { CodeForm, Icon, IconCheckmark, Label, Loading, Modal, ModernButton } from '@opensrcs/ui'
  import presentation from '@opensrcs/presentation'
  import { getEmbeddedLabel, getMetadata, IntlString } from '@opensrcs/club'
  import { concatLink, getCurrentAccount } from '@opensrcs/core'
