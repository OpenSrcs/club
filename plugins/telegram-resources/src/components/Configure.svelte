<script lang="ts">
  ...
  import { getCurrentWorkspaceUuid, getClient, SpaceSelector } from '@opensrcs/presentation'
  ...
  import core, { getCurrentAccount, Space } from '@opensrcs/core'
