...
<script lang="ts">
  ...
  import { AttachmentGroup } from '@opensrcs/attachment-resources'
  import { formatName } from '@opensrcs/contact'
  import { WithLookup } from '@opensrcs/core'
  import { HTMLViewer } from '@opensrcs/presentation'
  import type { SharedTelegramMessage } from '@opensrcs/telegram'
  import { CheckBox, getPlatformColorForText, themeStore } from '@opensrcs/ui'
