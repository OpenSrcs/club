...
import { concatLink, type Ref, type Space, type PersonId } from '@opensrcs/core'
import { getMetadata } from '@opensrcs/club'
import telegram from './plugin'
import presentation, { getCurrentWorkspaceUuid } from '@opensrcs/presentation'
import login from '@opensrcs/login'
import { telegramIntegrationKind } from '@opensrcs/telegram'
import {
...
export async function getIntegrationClient (): Promise<IntegrationClient> {
  ...
  return getIntegrationClientRaw(accountsUrl, token, telegramIntegrationKind, 'clubgram')
}
