...
import { getResource, type IntlString, type Resources } from '@opensrcs/club'
import { MessageBox, getBlobRef, getClient, type ObjectSearchResult } from '@opensrcs/presentation'
import {
...
import { AggregationManager } from '@opensrcs/view-resources'
