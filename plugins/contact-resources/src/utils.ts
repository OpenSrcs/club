...
import { getMetadata, getResource, type IntlString, translate } from '@opensrcs/club'
import presentation, { addTxListener, createQuery, getClient, onClient } from '@opensrcs/presentation'
import { type TemplateDataProvider } from '@opensrcs/templates'
import {
...
import view, { type Filter, type GrouppingManager } from '@opensrcs/view'
import { accessDeniedStore, FilterQuery } from '@opensrcs/view-resources'
import { type LocationData } from '@opensrcs/workbench'
