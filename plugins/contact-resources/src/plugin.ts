...
import contact, { contactId } from '@opensrcs/contact'
import { type Client, type Doc } from '@opensrcs/core'
import { type IntlString, mergeIds, type Resource } from '@opensrcs/club'
import { type LabelAndProps, type Location } from '@opensrcs/ui/src/types'
import {
