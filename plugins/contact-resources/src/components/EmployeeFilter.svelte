...
<script lang="ts">
  ...
  import core, { Doc, FindResult, getObjectValue, Ref, SortingOrder, Space } from '@opensrcs/core'
  ...
  import { FILTER_DEBOUNCE_MS, FilterRemovedNotification, sortFilterValues } from '@opensrcs/view-resources'
