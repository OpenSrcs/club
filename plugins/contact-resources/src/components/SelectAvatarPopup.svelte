...
<script lang="ts">
  ...
  import { AvatarType, checkHasGravatar, type AvatarInfo } from '@opensrcs/contact'
  import type { Ref } from '@opensrcs/core'
  import { Blob as PlatformBlob } from '@opensrcs/core'
  import { Asset } from '@opensrcs/club'
  import presentation, { Card, getFileUrl, uiContext } from '@opensrcs/presentation'
  import ui, {
    AnySvelteComponent,
    Button,
    ColorDefinition,
  ...
  import { ColorsPopup } from '@opensrcs/view-resources'
