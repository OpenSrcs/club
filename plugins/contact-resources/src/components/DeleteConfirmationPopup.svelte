...
<script lang="ts">
  ...
  import { AccountRole, Doc, getCurrentAccount, PersonId, Ref, uniqueNotEmpty } from '@opensrcs/core'
  import { Card, isAdminUser } from '@opensrcs/presentation'
  import ui, { Button, Label } from '@opensrcs/ui'
