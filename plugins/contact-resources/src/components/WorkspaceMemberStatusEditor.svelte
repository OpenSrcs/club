...
-->
<script lang="ts">
  import contact, { type WorkspaceMemberStatus, trimWorkspaceMemberStatusMessage } from '@opensrcs/contact'
  import core, { getCurrentAccount } from '@opensrcs/core'
  import EmojiPopup from '@opensrcs/emoji-resources/src/components/EmojiPopup.svelte'
