...
<script lang="ts">
  ...
  import contact, { type SocialIdentity, type SocialIdentityProvider } from '@opensrcs/contact'
  import { getClient } from '@opensrcs/presentation'
  import { AccountRole, getCurrentAccount, type SocialId } from '@opensrcs/core'
