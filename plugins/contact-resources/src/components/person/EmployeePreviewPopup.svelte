...
-->
<script lang="ts">
  import { Employee, Person, getWorkspaceMemberStatusSubtitle } from '@opensrcs/contact'
  import { AccountUuid, Class, Doc, Ref } from '@opensrcs/core'
  import { ComponentExtensions, createQuery, getClient, hasResource } from '@opensrcs/presentation'
  import { ButtonIcon, Component, navigate } from '@opensrcs/ui'
