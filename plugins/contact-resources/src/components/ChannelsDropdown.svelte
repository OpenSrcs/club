...
-->
<script lang="ts">
  import type { Channel, ChannelProvider } from '@opensrcs/contact'
  import contact from '@opensrcs/contact'
  import { AttachedData, Doc, Ref, toIdMap } from '@opensrcs/core'
  import notification, { DocNotifyContext, InboxNotification } from '@opensrcs/notification'
  import { Asset, IntlString, getResource } from '@opensrcs/club'
  ...
  import view, { Action as ViewAction } from '@opensrcs/view'
  import { ContextMenu, invokeAction } from '@opensrcs/view-resources'
