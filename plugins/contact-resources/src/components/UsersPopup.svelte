...
-->
<script lang="ts">
  import contact, { Contact, getFirstName, getLastName, getName, Person } from '@opensrcs/contact'
  import type { Class, Doc, DocumentQuery, FindOptions, Ref } from '@opensrcs/core'
  import type { Asset, IntlString } from '@opensrcs/club'
  import presentation, { getClient, ObjectCreate, ObjectPopup } from '@opensrcs/presentation'
  import { AnySvelteComponent, Label } from '@opensrcs/ui'
