...
-->
<script lang="ts">
  import contact, { Person, SocialIdentity } from '@opensrcs/contact'
  import core, { FindResult, getObjectValue, includesAny, PersonId, Ref, Space, WithLookup } from '@opensrcs/core'
  ...
  import view, { Filter } from '@opensrcs/view'
  import { FILTER_DEBOUNCE_MS, sortFilterValues } from '@opensrcs/view-resources'
