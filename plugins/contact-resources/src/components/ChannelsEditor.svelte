...
-->
<script lang="ts">
  import type { AttachedData, Class, Doc, Ref } from '@opensrcs/core'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { ButtonKind, ButtonSize, closeTooltip, showPopup } from '@opensrcs/ui'

  import { Channel, ChannelProvider } from '@opensrcs/contact'
  import { restrictionStore } from '@opensrcs/view-resources'
