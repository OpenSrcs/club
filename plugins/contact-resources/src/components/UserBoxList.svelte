...
<script lang="ts">
  ...
  import type { Class, Doc, DocumentQuery, Ref } from '@opensrcs/core'
  import type { IntlString } from '@opensrcs/club'
  import { ObjectCreate, getClient } from '@opensrcs/presentation'
  import type { ButtonKind, ButtonSize, TooltipAlignment } from '@opensrcs/ui'
  import { Button, Label, showPopup } from '@opensrcs/ui'
