...
<script lang="ts">
  ...
  import { AvatarType, type AvatarInfo } from '@opensrcs/contact'
  import { Asset, getResource } from '@opensrcs/club'
  import { AnySvelteComponent, IconSize, showPopup } from '@opensrcs/ui'
  import { createEventDispatcher } from 'svelte'

  import type { Data, Blob as PlatformBlob, Ref, WithLookup } from '@opensrcs/core'
