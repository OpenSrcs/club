<script lang="ts">
  ...
  import core, { Class, Doc, Mixin, Ref } from '@opensrcs/core'
  import notification from '@opensrcs/notification'
  import { Panel } from '@opensrcs/panel'
  import { getResource } from '@opensrcs/club'
  import presentation, { createQuery, getClient, type KeyedAttribute } from '@opensrcs/presentation'
  import { type AnyComponent, Button, Component, IconMixin, IconMoreH, Label } from '@opensrcs/ui'
  import view, { AttributeCategory } from '@opensrcs/view'
  import {
    DocAttributeBar,
    DocNavLink,
