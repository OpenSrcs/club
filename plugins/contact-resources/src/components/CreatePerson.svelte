...
-->
<script lang="ts">
  import { AvatarType, Channel, combineName, ContactEvents, findPerson, Person } from '@opensrcs/contact'
  import { AttachedData, Data, generateId } from '@opensrcs/core'
  import { Card, getClient } from '@opensrcs/presentation'
  import { createFocusManager, EditBox, FocusHandler, IconInfo, Label } from '@opensrcs/ui'
