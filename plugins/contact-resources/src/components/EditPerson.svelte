...
-->
<script lang="ts">
  import { Channel, Person, combineName, getCurrentEmployee, getFirstName, getLastName } from '@opensrcs/contact'
  import { AccountRole, Ref, getCurrentAccount, hasAccountRole, type AccountUuid } from '@opensrcs/core'
  import { AttributeEditor, createQuery, getClient, hasResource } from '@opensrcs/presentation'
  import type { PersonRating } from '@opensrcs/rating'
  import ratingPlugin from '@opensrcs/rating'
  import setting, { IntegrationType } from '@opensrcs/setting'
  import { Component, EditBox, FocusHandler, Scroller, createFocusManager } from '@opensrcs/ui'
