<script lang="ts">
  import { Employee, Person, getName } from '@opensrcs/contact'
  import { Ref, Space, notEmpty } from '@opensrcs/core'
  import presentation, { getClient } from '@opensrcs/presentation'
  import { ActionIcon, Button, IconClose, Label } from '@opensrcs/ui'
