...
-->
<script lang="ts">
  import contact, { Contact, Employee, Person, getName } from '@opensrcs/contact'
  import { Class, DocumentQuery, FindOptions, Ref } from '@opensrcs/core'
  import { IntlString, getEmbeddedLabel } from '@opensrcs/club'
  import presentation, { getClient, reduceCalls } from '@opensrcs/presentation'
  import {
    ActionIcon,
    Button,
    ButtonKind,
