...
<script lang="ts">
  ...
  import { Channel, ContactEvents, Organization, findContacts } from '@opensrcs/contact'
  import core, {
    AttachedData,
    fillDefaults,
    generateId,
  ...
  import { Button, createFocusManager, EditBox, FocusHandler, IconAttachment, IconInfo, Label } from '@opensrcs/ui'
