...
-->
<script lang="ts">
  import contact, { Contact, getName } from '@opensrcs/contact'
  import { Class, Doc, DocumentQuery, FindOptions, Ref } from '@opensrcs/core'
  import { Asset, IntlString, getEmbeddedLabel } from '@opensrcs/club'
  import presentation, { ObjectCreate, getClient } from '@opensrcs/presentation'
  import {
    ActionIcon,
    AnySvelteComponent,
    Button,
