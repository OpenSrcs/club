...
<script lang="ts">
  import { AnyAttribute } from '@opensrcs/core'
  import { findAttributeEditorByAttribute, getAttributePresenterClass, getClient } from '@opensrcs/presentation'
  import { Context, createContext, parseContext, Process, SelectedContext } from '@opensrcs/process'
  import { Button, Component, eventToHTMLElement, IconAdd, IconClose, showPopup } from '@opensrcs/ui'
