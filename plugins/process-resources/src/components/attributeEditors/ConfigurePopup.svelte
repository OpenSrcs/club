...
-->
<script lang="ts">
  import core, { AnyAttribute, Class, Doc, DocumentQuery, Ref } from '@opensrcs/core'
  import { getClient } from '@opensrcs/presentation'
  import { Context, Func, Process, ProcessFunction, SelectedContext } from '@opensrcs/process'
  import {
    ButtonIcon,
    CheckBox,
    closeTooltip,
