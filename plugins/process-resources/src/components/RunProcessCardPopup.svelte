...
<script lang="ts">
  ...
  import { CardSelector } from '@opensrcs/card-resources'
  import { Ref } from '@opensrcs/core'
  import { Card as CardPopup, getClient } from '@opensrcs/presentation'
  import { Process } from '@opensrcs/process'
  import { Dropdown, ListItem } from '@opensrcs/ui'
