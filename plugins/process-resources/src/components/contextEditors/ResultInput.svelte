...
-->
<script lang="ts">
  import { Doc, getObjectValue } from '@opensrcs/core'
  import presentation, { Card, getAttrEditor, getClient } from '@opensrcs/presentation'
  import { ContextId, ExecutionContext, UserResult } from '@opensrcs/process'
  import { Component, tooltip } from '@opensrcs/ui'
