...
-->
<script lang="ts">
  import { AnyAttribute, Class, Doc, Ref } from '@opensrcs/core'
  import presentation, { Card, getAttributeEditor, getClient } from '@opensrcs/presentation'
  import { SelectedContext } from '@opensrcs/process'
  import { AnySvelteComponent, CheckBox, Label } from '@opensrcs/ui'
