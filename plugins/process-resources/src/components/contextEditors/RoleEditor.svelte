...
-->
<script lang="ts">
  import card, { MasterTag, Role, Tag } from '@opensrcs/card'
  import { AnyAttribute, Ref } from '@opensrcs/core'
  import { getClient } from '@opensrcs/presentation'
  import { ProcessFunction, SelectedContext } from '@opensrcs/process'
  import { resizeObserver, Scroller } from '@opensrcs/ui'
