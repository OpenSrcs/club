...
<script lang="ts">
  ...
  import core, { Doc, FindOptions, SortingOrder } from '@opensrcs/core'
  import { createQuery } from '@opensrcs/presentation'
  import { ApproveRequest } from '@opensrcs/process'
  import { Label, registerFocus, resizeObserver, Section } from '@opensrcs/ui'
