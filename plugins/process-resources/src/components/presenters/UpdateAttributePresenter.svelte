...
-->
<script lang="ts">
  import { getAttributePresenterClass, getClient } from '@opensrcs/presentation'
  import { parseContext, Process } from '@opensrcs/process'
  import { AnyComponent, Component, Label } from '@opensrcs/ui'
  import { AttributeCategory } from '@opensrcs/view'
  import { findAttributePresenter } from '@opensrcs/view-resources'
