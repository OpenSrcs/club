...
<script lang="ts">
  ...
  import { PermissionsStore } from '@opensrcs/contact'
  import { checkMyPermission, permissionsStore } from '@opensrcs/contact-resources'
  import core, { Doc, FindOptions, Ref, SortingOrder, TypedSpace } from '@opensrcs/core'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { Execution, Process } from '@opensrcs/process'
  import {
    Button,
    eventToHTMLElement,
    IconAdd,
