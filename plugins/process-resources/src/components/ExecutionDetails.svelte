...
-->
<script lang="ts">
  import { Doc, WithLookup } from '@opensrcs/core'
  import presentation, { ActionContext, createQuery } from '@opensrcs/presentation'
  import { Execution } from '@opensrcs/process'
  import { Modal, registerFocus } from '@opensrcs/ui'
