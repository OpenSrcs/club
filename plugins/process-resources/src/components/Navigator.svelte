...
<script lang="ts">
  ...
  import { processId, Process } from '@opensrcs/process'
  import { deviceOptionsStore as deviceInfo, NavItem, Scroller } from '@opensrcs/ui'
  import { NavLink } from '@opensrcs/view-resources'
  import { NavFooter, NavHeader, SavedView } from '@opensrcs/workbench-resources'
