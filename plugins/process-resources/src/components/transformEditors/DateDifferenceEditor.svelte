...
<script lang="ts">
  ...
  import core, { AnyAttribute, Ref } from '@opensrcs/core'
  import { getResource } from '@opensrcs/club'
  import presentation, { Card, getClient } from '@opensrcs/presentation'
  import { Context, Process, ProcessFunction } from '@opensrcs/process'
  import ui, { AnySvelteComponent, DropdownIntlItem, DropdownLabelsIntl } from '@opensrcs/ui'
