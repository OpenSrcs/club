...
<script lang="ts">
  ...
  import presentation, { Card, getAttributePresenterClass, getClient } from '@opensrcs/presentation'
  import { Process, ProcessFunction } from '@opensrcs/process'
  import { Button, SelectPopup, eventToHTMLElement, showPopup } from '@opensrcs/ui'
