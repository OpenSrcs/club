...
<script lang="ts">
  ...
  import { TypeSelector } from '@opensrcs/card-resources'
  import core, { AnyAttribute, Class, Ref } from '@opensrcs/core'
  import { translateCB } from '@opensrcs/club'
  import presentation, { getClient } from '@opensrcs/presentation'
  import { createContext, Process, Step } from '@opensrcs/process'
  import { Button, eventToHTMLElement, Label, SelectPopup, showPopup, Toggle, tooltip } from '@opensrcs/ui'
