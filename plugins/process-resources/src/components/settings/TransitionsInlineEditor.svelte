...
<script lang="ts">
  ...
  import { Process, Transition } from '@opensrcs/process'
  import { Button, getCurrentLocation, IconAdd, Label, navigate, showPopup } from '@opensrcs/ui'
  ...
  import { SortableDocList } from '@opensrcs/view-resources'
...
<div class="clubTableAttr-container box">
