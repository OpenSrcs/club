...
<script lang="ts">
  ...
  import { State, Transition } from '@opensrcs/process'
  import { getCurrentLocation, navigate, ButtonIcon, IconDescription, NavItem, Separator } from '@opensrcs/ui'
...
{#if visibleSecondNav}
  <div class="clubComponent-content__column pt-4">
