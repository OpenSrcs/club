...
-->
<script lang="ts">
  import cardPlugin, { Card, MasterTag, Tag } from '@opensrcs/card'
  import core, { AnyAttribute, Class, Ref } from '@opensrcs/core'
  import { Process, Step } from '@opensrcs/process'
  import { Button, eventToHTMLElement, IconClose, Label, SelectPopup, showPopup, tooltip } from '@opensrcs/ui'
