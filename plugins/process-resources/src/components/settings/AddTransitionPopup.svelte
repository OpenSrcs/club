...
-->
<script lang="ts">
  import core, { Ref, SortingOrder } from '@opensrcs/core'
  import { Card, createQuery, getClient } from '@opensrcs/presentation'
  import { Process, State, Transition, Trigger } from '@opensrcs/process'
  import { Component, Dropdown, DropdownIntlItem, DropdownLabelsIntl, Label, ListItem } from '@opensrcs/ui'
