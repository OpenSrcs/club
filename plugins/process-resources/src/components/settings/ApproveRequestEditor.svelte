...
<script lang="ts">
  ...
  import { getAttributeEditor, getAttributePresenterClass, getClient } from '@opensrcs/presentation'
  import { ApproveRequest, parseContext, Process, Step } from '@opensrcs/process'
  import { AnySvelteComponent, Label, Toggle } from '@opensrcs/ui'
