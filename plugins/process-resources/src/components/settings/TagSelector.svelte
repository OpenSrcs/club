...
-->
<script lang="ts">
  import cardPlugin, { Tag as MasterTag } from '@opensrcs/card'
  import { Ref } from '@opensrcs/core'
  import { getClient } from '@opensrcs/presentation'
  import { Process } from '@opensrcs/process'
  import { Button, eventToHTMLElement, Label, SelectPopup, SelectPopupValueType, showPopup } from '@opensrcs/ui'
