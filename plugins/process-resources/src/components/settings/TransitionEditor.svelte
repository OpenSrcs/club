...
<script lang="ts">
  ...
  import { Process, State, Step, Transition } from '@opensrcs/process'
  ...
  import { SortableList } from '@opensrcs/view-resources'
    ...
    {#if value && process}
      <Scroller align="center" padding="var(--spacing-3)" bottomPadding="var(--spacing-3)">
        <div class="clubComponent-content gap">
          ...
          <div class="clubComponent-content flex-col-center flex-gap-4">
            <div class="clubTableAttr-container flex-col-center box">
