...
<script lang="ts">
  ...
  import contact, { SocialIdentityRef } from '@opensrcs/contact'
  import { getCurrentAccount, SocialIdType } from '@opensrcs/core'
  ...
  import { EditBox, ModernDialog, StylishEdit, Status as StatusControl } from '@opensrcs/ui'
