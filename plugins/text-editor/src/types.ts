...
import { type Class, type Space, type PersonId, type Doc, type Markup, type Ref, type Blob } from '@opensrcs/core'
import type { AnySvelteComponent } from '@opensrcs/ui/src/types'
