...
-->
<script lang="ts">
  import { reduceCalls } from '@opensrcs/core'
  import { type IntlString, OK, Severity, Status, translate } from '@opensrcs/club'
  import { Button, Label, StylishEdit, deviceOptionsStore as deviceInfo, themeStore } from '@opensrcs/ui'
