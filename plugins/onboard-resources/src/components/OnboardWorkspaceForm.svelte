...
-->
<script lang="ts">
  import { LoginInfo, RegionInfo } from '@opensrcs/login'
  import { createWorkspace, getAccountDisplayName, getRegionInfo, setLoginInfo } from '@opensrcs/login-resources'
  import { Status, Severity, OK, getEmbeddedLabel } from '@opensrcs/club'
  import { createEventDispatcher, onMount } from 'svelte'
  import { ButtonMenu } from '@opensrcs/ui'
