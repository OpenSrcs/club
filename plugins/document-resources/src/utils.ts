...
import { type Document, type Teamspace, documentId, getFirstRank } from '@opensrcs/document'
...
import { type Location, type ResolvedLocation, getCurrentResolvedLocation, getPanelURI } from '@opensrcs/ui'
