...
<script lang="ts">
  ...
  import { Data, generateId, Ref } from '@opensrcs/core'
  import { Document, DocumentEvents, Teamspace } from '@opensrcs/document'
  import { IconWithEmoji, Card, getClient, SpaceSelector } from '@opensrcs/presentation'
  import {
    Button,
    createFocusManager,
    EditBox,
  ...
  import { IconPicker, ObjectBox } from '@opensrcs/view-resources'
