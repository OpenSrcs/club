...
<script lang="ts">
  ...
  import { Ref, SortingOrder, Space, generateId } from '@opensrcs/core'
  import { Document, DocumentEvents, Teamspace } from '@opensrcs/document'
  import { IconWithEmoji, createQuery, getClient } from '@opensrcs/presentation'
  import {
    IconEdit,
    getPlatformColorDef,
  ...
  import { TreeNode, openDoc, getActions as getContributedActions } from '@opensrcs/view-resources'
