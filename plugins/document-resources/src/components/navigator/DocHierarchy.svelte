...
<script lang="ts">
  ...
  import { Ref, generateId } from '@opensrcs/core'
  ...
  import { Action, IconAdd, IconEdit, getPlatformColorDef, themeStore } from '@opensrcs/ui'
  import view from '@opensrcs/view'
  import { getActions as getContributedActions, openDoc } from '@opensrcs/view-resources'
