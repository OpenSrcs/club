...
<script lang="ts">
  ...
  import attachment, { Attachment } from '@opensrcs/attachment'
  import core, { Doc, Ref, WithLookup, generateId, type Blob } from '@opensrcs/core'
  import { Document, DocumentEvents, Teamspace } from '@opensrcs/document'
  ...
  import { Heading } from '@opensrcs/text-editor'
  import { TableOfContents } from '@opensrcs/text-editor-resources'
