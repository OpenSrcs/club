...
-->
<script lang="ts">
  import core, { AccountRole, Ref, Space, getCurrentAccount } from '@opensrcs/core'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { HeaderButton, showPopup } from '@opensrcs/ui'
  import { openDoc } from '@opensrcs/view-resources'
  import { Analytics } from '@opensrcs/analytics'
  import { DocumentEvents } from '@opensrcs/document'
