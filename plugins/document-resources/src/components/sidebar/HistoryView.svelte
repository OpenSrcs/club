...
<script lang="ts">
  ...
  import { EmployeePresenter, getPersonByPersonIdCb } from '@opensrcs/contact-resources'
  import { DocumentSnapshot } from '@opensrcs/document'
  import { TimeSince } from '@opensrcs/ui'
