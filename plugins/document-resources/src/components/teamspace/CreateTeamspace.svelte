...
<script lang="ts">
  ...
  import document, { Teamspace, DocumentEvents } from '@opensrcs/document'
  import { Asset } from '@opensrcs/club'
  import presentation, { IconWithEmoji, Card, getClient, reduceCalls } from '@opensrcs/presentation'
  import {
    Button,
    EditBox,
    Label,
