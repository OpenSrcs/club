...
-->
<script lang="ts">
  import type { Class, Doc, DocumentQuery, FindOptions, Ref, WithLookup } from '@opensrcs/core'
  import { type Resource } from '@opensrcs/drive'
  import { ActionContext, createQuery, getClient } from '@opensrcs/presentation'
  import { BuildModelKey, ViewOptions } from '@opensrcs/view'
  import { ListSelectionProvider, SelectDirection, buildConfigLookup, focusStore } from '@opensrcs/view-resources'
