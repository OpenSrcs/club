...
-->
<script lang="ts">
  import { AccountRole, Ref, getCurrentAccount } from '@opensrcs/core'
  import { checkMyPermission, permissionsStore } from '@opensrcs/contact-resources'
  import { type Drive } from '@opensrcs/drive'
  import { getResource } from '@opensrcs/club'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { HeaderButton, HeaderButtonAction } from '@opensrcs/ui'
  import { getUploadHandlers } from '@opensrcs/uploader'
