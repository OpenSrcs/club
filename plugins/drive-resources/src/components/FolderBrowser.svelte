...
-->
<script lang="ts">
  import { type Doc, type DocumentQuery, type Ref, type WithLookup } from '@opensrcs/core'
  import { permissionsStore } from '@opensrcs/contact-resources'
  import drive, { type Drive, type Folder } from '@opensrcs/drive'
  import { Scroller, SearchInput, Panel, Button, IconMoreH } from '@opensrcs/ui'
  import view, { Viewlet, ViewOptions } from '@opensrcs/view'
  import {
    FilterBar,
    FilterButton,
    ViewletContentView,
