...
-->
<script lang="ts">
  import { Doc, Ref, SortingOrder, Space } from '@opensrcs/core'
  import { Drive, Folder } from '@opensrcs/drive'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { Action, navigate, IconEdit } from '@opensrcs/ui'
  import { TreeNode, TreeItem, getActions as getContributedActions } from '@opensrcs/view-resources'
