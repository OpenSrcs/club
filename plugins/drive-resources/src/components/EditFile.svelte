...
-->
<script lang="ts">
  import { type Blob, type Ref, type WithLookup } from '@opensrcs/core'
  import drive, { type File, type FileVersion } from '@opensrcs/drive'
  import { FilePreview, createQuery } from '@opensrcs/presentation'
