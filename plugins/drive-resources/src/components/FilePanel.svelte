...
-->
<script lang="ts">
  import { type Ref, type WithLookup } from '@opensrcs/core'
  import { checkMyPermission, permissionsStore } from '@opensrcs/contact-resources'
  import { createFileVersion, type File as DriveFile, type FileVersion } from '@opensrcs/drive'
  import { Panel } from '@opensrcs/panel'
  import { createQuery, getClient, getFileUrl } from '@opensrcs/presentation'
  import { Button, IconMoreH } from '@opensrcs/ui'
  import { FileUploadCallbackParams, showFilesUploadPopup } from '@opensrcs/uploader'
  import view from '@opensrcs/view'
  import { canChangeDoc, showMenu } from '@opensrcs/view-resources'
