...
import { type Class, type Doc, type Ref, type Space, toIdMap } from '@opensrcs/core'
import drive, {
  type Drive,
  type FileVersion,
  type Folder,
...
import { type Asset, setPlatformStatus, unknownError } from '@opensrcs/club'
import { getClient } from '@opensrcs/presentation'
import { type AnySvelteComponent, showPopup } from '@opensrcs/ui'
import {
