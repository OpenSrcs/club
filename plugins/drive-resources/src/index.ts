...
import type { Class, Client, Doc, DocumentQuery, Ref, RelatedDocument, WithLookup } from '@opensrcs/core'
import drive, { type Drive, type File, type FileVersion, type Folder } from '@opensrcs/drive'
import { type Resources } from '@opensrcs/club'
import { type ObjectSearchResult, getFileUrl } from '@opensrcs/presentation'
import { showPopup, type Location } from '@opensrcs/ui'
import { canChangeDoc, canCreateObject, canDeleteObject, canRemoveDoc } from '@opensrcs/view-resources'
