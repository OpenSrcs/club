...
-->
<script lang="ts">
  import type { Class, Doc, Ref, Space } from '@opensrcs/core'
  import { getClient } from '@opensrcs/presentation'
  import { Survey } from '@opensrcs/survey'
  import { Button, IconAdd, Label, Section, navigate, showPopup, Scroller } from '@opensrcs/ui'
  import view, { Viewlet, ViewletPreference } from '@opensrcs/view'
  import { Table, ViewletSelector, ViewletSettingButton, getObjectLinkFragment } from '@opensrcs/view-resources'
