...
import { type Client, type Doc, type Ref, type Space } from '@opensrcs/core'
...
import type { KeyFilter, ReferenceVersion, SortFunc, ViewActionAvailabilityFunction } from '@opensrcs/view'
