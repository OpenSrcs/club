...
-->
<script lang="ts">
  import { Class, Doc, DocumentQuery, Ref, WithLookup } from '@opensrcs/core'
  import { IntlString, translate } from '@opensrcs/club'
  import { themeStore } from '@opensrcs/ui'
  import { Viewlet, ViewOptions } from '@opensrcs/view'
  import { FilterBar, SpaceHeader, ViewletContentView, ViewletSettingButton } from '@opensrcs/view-resources'
  import { Project, DocumentSpace } from '@opensrcs/controlled-documents'
