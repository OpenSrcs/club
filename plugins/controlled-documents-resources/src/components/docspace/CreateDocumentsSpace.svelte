...
<script lang="ts">
  ...
  import { EditBox, Label, Toggle } from '@opensrcs/ui'
  import { SpaceTypeSelector } from '@opensrcs/view-resources'
  import documents, { DocumentSpace, DocumentSpaceType } from '@opensrcs/controlled-documents'
