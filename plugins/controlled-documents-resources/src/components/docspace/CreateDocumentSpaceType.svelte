...
<script lang="ts">
  ...
  import { Data, SpaceTypeDescriptor, generateId } from '@opensrcs/core'
  import { getClient } from '@opensrcs/presentation'
  import documents, { DocumentSpaceType, DocumentSpaceTypeDescriptor } from '@opensrcs/controlled-documents'
  import { createSpaceType } from '@opensrcs/setting'
