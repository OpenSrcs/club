...
<script lang="ts">
  ...
  import { type Doc, type Ref, type Space, WithLookup } from '@opensrcs/core'
  ...
  import { ActionGroup } from '@opensrcs/view'
  import { TreeItem, TreeNode, getActions as getContributedActions } from '@opensrcs/view-resources'
