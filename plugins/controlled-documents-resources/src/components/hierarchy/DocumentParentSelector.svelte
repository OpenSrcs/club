...
-->
<script lang="ts">
  import documents, { ProjectDocumentTree, type DocumentSpace, type Project } from '@opensrcs/controlled-documents'
  import { type Doc, type Ref } from '@opensrcs/core'
  import { getPlatformColorForTextDef, themeStore } from '@opensrcs/ui'
