...
<script lang="ts">
  ...
  import { generateId, Ref, Space } from '@opensrcs/core'
  import { Card, getClient } from '@opensrcs/presentation'
  import { Button, EditBox, IconAttachment, tooltip } from '@opensrcs/ui'
  import { DocumentCategory } from '@opensrcs/controlled-documents'
