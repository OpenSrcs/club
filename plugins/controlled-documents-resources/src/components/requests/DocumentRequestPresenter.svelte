...
<script lang="ts">
  ...
  import { Button, Label, ProgressCircle, eventToHTMLElement, showPopup } from '@opensrcs/ui'
  ...
  import { RequestStatusPresenter, RequestDetailPopup } from '@opensrcs/request-resources'
