...
<script lang="ts">
  ...
  import type { Class, DocumentQuery, Ref } from '@opensrcs/core'
  import type { IntlString } from '@opensrcs/club'
  import { Label, showPopup, ActionIcon, IconClose, IconAdd, Icon } from '@opensrcs/ui'
  import type { IconSize } from '@opensrcs/ui'
