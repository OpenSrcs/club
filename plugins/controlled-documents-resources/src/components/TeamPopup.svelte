...
<script lang="ts">
  ...
  import { UserBoxItems, getPermittedPersons, permissionsStore } from '@opensrcs/contact-resources'
  import documents, {
    ControlledDocument,
    ControlledDocumentState,
    DocumentRequest
  } from '@opensrcs/controlled-documents'
  import { Class, Ref, TxOperations } from '@opensrcs/core'
  import { getClient } from '@opensrcs/presentation'
  import { RequestStatus } from '@opensrcs/request'
  import { Label, ModernDialog, showPopup } from '@opensrcs/ui'
