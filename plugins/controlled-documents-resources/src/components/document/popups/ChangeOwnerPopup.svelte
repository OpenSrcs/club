...
<script lang="ts">
  ...
  import { EmployeeBox, EmployeePresenter, employeeRefByAccountUuidStore } from '@opensrcs/contact-resources'
  import core, { Ref, Space, notEmpty } from '@opensrcs/core'
  import presentation, { createQuery, getClient } from '@opensrcs/presentation'
  import { Button, Icon, Label } from '@opensrcs/ui'
