...
<script lang="ts">
  ...
  import { Component, EditBox, Label, Scroller } from '@opensrcs/ui'
  import { getCollaborationUser } from '@opensrcs/view-resources'
