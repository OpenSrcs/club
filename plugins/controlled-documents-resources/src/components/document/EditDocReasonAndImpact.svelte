...
<script lang="ts">
  ...
  import { Label, Scroller, PlainTextEditor } from '@opensrcs/ui'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import documents, { type DocumentSpace, type ChangeControl, DocumentState } from '@opensrcs/controlled-documents'
