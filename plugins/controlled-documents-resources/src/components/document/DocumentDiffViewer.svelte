<script lang="ts">
  ...
  import { makeDocCollabId, type Doc } from '@opensrcs/core'
  import { CollaborationIds } from '@opensrcs/text-editor'
  import {
  ...
  import { Dropdown, Label, ListItem, Loading, Scroller, themeStore } from '@opensrcs/ui'
  import documents, {
    ControlledDocument,
