<script lang="ts">
  import { PersonRefPresenter } from '@opensrcs/contact-resources'
  import { DocumentValidationState } from '@opensrcs/controlled-documents'
  import { Chevron, Label, tooltip } from '@opensrcs/ui'
