<!--
//
// Copyright © 2026 Xored
//
-->
<script lang="ts">
  import documents, { DocumentComment } from '@opensrcs/controlled-documents'
  import { ThreadView } from '@opensrcs/chunter-resources'
  import { Button, IconCheckCircle, Label } from '@opensrcs/ui'
  import {
