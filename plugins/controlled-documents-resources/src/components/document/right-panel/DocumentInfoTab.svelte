...
<script lang="ts">
  import documents, { DocumentState, type Document, type DocumentTemplate } from '@opensrcs/controlled-documents'
  import { PersonPresenter } from '@opensrcs/contact-resources'
  import { DateRangeMode } from '@opensrcs/core'
  import { DatePresenter, Label, Scroller, eventToHTMLElement, showPopup } from '@opensrcs/ui'
