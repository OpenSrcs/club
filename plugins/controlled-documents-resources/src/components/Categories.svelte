...
<script lang="ts">
  ...
  import { Class, DocumentQuery, Ref, TypedSpace } from '@opensrcs/core'
  import { ActionContext } from '@opensrcs/presentation'
  import { Button, IconAdd, Loading, showPopup } from '@opensrcs/ui'
  import view, { Viewlet, ViewletPreference, ViewOptions } from '@opensrcs/view'
  import { TableBrowser, ViewletPanelHeader } from '@opensrcs/view-resources'
