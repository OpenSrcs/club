...
import contact, { type Employee, type Person, getCurrentEmployee } from '@opensrcs/contact'
import documents, {
...
import { type IntlString, translate } from '@opensrcs/club'
import { createQuery, getClient, MessageBox } from '@opensrcs/presentation'
import request, { type Request, RequestStatus } from '@opensrcs/request'
import { isEmptyMarkup } from '@opensrcs/text'
import { type Location, getUserTimezone, showPopup } from '@opensrcs/ui'
import { type KeyFilter, type ReferenceVersion } from '@opensrcs/view'
...
import { getPersonRefByPersonId, getPersonRefsByPersonIds } from '@opensrcs/contact-resources'
