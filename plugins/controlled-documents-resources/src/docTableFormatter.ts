...
import core, { type Class, type Doc, type Hierarchy, type Ref, type Space, getObjectValue } from '@opensrcs/core'
import { translate, type IntlString } from '@opensrcs/club'
import documentsPlugin from '@opensrcs/controlled-documents'
