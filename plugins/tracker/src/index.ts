...
import { Employee, Person } from '@opensrcs/contact'
import {
  AttachedDoc,
  Attribute,
  Class,
...
import { Asset, IntlString, Plugin, Resource, plugin } from '@opensrcs/club'
import { Preference } from '@opensrcs/preference'
import { TagCategory, TagElement, TagReference } from '@opensrcs/tags'
import { ToDo } from '@opensrcs/time'
import {
  ProjectType,
...
import { AnyComponent, ComponentExtensionId, Location, ResolvedLocation } from '@opensrcs/ui'
import { Action, ActionCategory, IconProps } from '@opensrcs/view'
