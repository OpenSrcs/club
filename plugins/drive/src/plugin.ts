...
import type { Class, Doc, Mixin, Ref, SpaceType, SpaceTypeDescriptor, Type, Permission } from '@opensrcs/core'
import type { Asset, IntlString, Plugin, Resource as PlatformResource } from '@opensrcs/club'
import { plugin } from '@opensrcs/club'
import type { Location, ResolvedLocation } from '@opensrcs/ui/src/types'
