...
<script lang="ts">
  ...
  import { Card, getClient, getCurrentWorkspaceUuid } from '@opensrcs/presentation'
  import { DropdownLabels, DropdownLabelsIntl, Label, ToggleWithLabel } from '@opensrcs/ui'
  import { getResource } from '@opensrcs/club'
  import login from '@opensrcs/login'
  import { shouldSkipDocument, isEffectiveDocument } from '@opensrcs/export'
