...
-->
<script lang="ts">
  import core, { type Class, type Doc, type Ref } from '@opensrcs/core'
  import exportPlugin, { type ExportResultRecord } from '@opensrcs/export'
  ...
  import { Button, IconMoreH, Label } from '@opensrcs/ui'
  import { DocNavLink, ObjectPresenter, showMenu } from '@opensrcs/view-resources'
