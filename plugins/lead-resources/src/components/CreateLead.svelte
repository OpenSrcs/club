...
-->
<script lang="ts">
  import contact, { Contact } from '@opensrcs/contact'
  import { UserBox } from '@opensrcs/contact-resources'
  import core, {
    AccountRole,
    AttachedData,
    AttachedDoc,
  ...
  import { Customer, Funnel, Lead, LeadEvents } from '@opensrcs/lead'
  import { OK, Status } from '@opensrcs/club'
  import { Card, createQuery, getClient, InlineAttributeBar, SpaceSelector } from '@opensrcs/presentation'
  import task, { getStates, TaskType } from '@opensrcs/task'
  import { TaskKindSelector, typeStore } from '@opensrcs/task-resources'
  import { Button, createFocusManager, EditBox, FocusHandler, Label, Status as StatusControl } from '@opensrcs/ui'
