...
<script lang="ts">
  ...
  import { MembersBox } from '@opensrcs/contact-resources'
  import type { Funnel } from '@opensrcs/lead'
  import { FullDescriptionBox } from '@opensrcs/text-editor-resources'
  import { EditBox, Grid } from '@opensrcs/ui'
  import { ClassAttributeBar } from '@opensrcs/view-resources'
