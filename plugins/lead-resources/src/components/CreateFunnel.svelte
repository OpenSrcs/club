...
<script lang="ts">
  ...
  import lead, { Funnel, LeadEvents } from '@opensrcs/lead'
  import presentation, { getClient, SpaceCreateCard } from '@opensrcs/presentation'
  import task, { ProjectType } from '@opensrcs/task'
  import ui, { Component, EditBox, Label, Toggle, ToggleWithLabel } from '@opensrcs/ui'
