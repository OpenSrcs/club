...
<script lang="ts">
  ...
  import { ContactPresenter } from '@opensrcs/contact-resources'
  import type { WithLookup } from '@opensrcs/core'
  import type { Lead } from '@opensrcs/lead'
  import notification from '@opensrcs/notification'
  import { getClient } from '@opensrcs/presentation'
  import task from '@opensrcs/task'
  import { AssigneePresenter, StateRefPresenter } from '@opensrcs/task-resources'
  import { ActionIcon, Component, DueDatePresenter, IconMoreH } from '@opensrcs/ui'
  import { BuildModelKey } from '@opensrcs/view'
  import { enabledConfig, openDoc, showMenu, statusStore } from '@opensrcs/view-resources'
