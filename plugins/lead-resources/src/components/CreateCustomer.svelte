...
-->
<script lang="ts">
  import { AvatarType, Channel, combineName, Contact, findContacts, type Organization } from '@opensrcs/contact'
  import { ChannelsDropdown, EditableAvatar, PersonPresenter } from '@opensrcs/contact-resources'
  import contact from '@opensrcs/contact-resources/src/plugin'
  import {
    AttachedData,
    Class,
    Data,
  ...
  import { Customer, LeadEvents } from '@opensrcs/lead'
  import { Card, createMarkup, getClient, InlineAttributeBar } from '@opensrcs/presentation'
