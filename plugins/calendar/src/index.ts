...
import type { Asset, IntlString, Metadata, Plugin, Resource } from '@opensrcs/club'
import { plugin } from '@opensrcs/club'
import { Preference } from '@opensrcs/preference'
import { Handler, IntegrationType } from '@opensrcs/setting'
import { AnyComponent, ComponentExtensionId } from '@opensrcs/ui'
