...
<script lang="ts">
  ...
  import { UserInfo } from '@opensrcs/contact-resources'
  import { type Ref, SortingOrder } from '@opensrcs/core'
  import { createQuery, DocPopup } from '@opensrcs/presentation'
  import { StateTag, StateType } from '@opensrcs/ui'
