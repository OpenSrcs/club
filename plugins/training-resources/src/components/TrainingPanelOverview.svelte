...
<script lang="ts">
  import { Icon, Label, navigate } from '@opensrcs/ui'
  import { Table } from '@opensrcs/view-resources'
  import { type Training } from '@opensrcs/training'
  import { Attachments, AttachmentStyleBoxEditor } from '@opensrcs/attachment-resources'
  import { AttributeBarEditor, getClient } from '@opensrcs/presentation'
