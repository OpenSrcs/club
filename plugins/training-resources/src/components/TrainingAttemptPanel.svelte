...
<script lang="ts">
  import { Class, Ref, type WithLookup } from '@opensrcs/core'
  import { Panel } from '@opensrcs/panel'
  import { ActionContext, createQuery } from '@opensrcs/presentation'
  import { Button, IconMoreH, navigate, type IModeSelector, rawLocation } from '@opensrcs/ui'
  import view from '@opensrcs/view'
  import { showMenu } from '@opensrcs/view-resources'
  import { type Training, type TrainingAttempt, type TrainingRequest } from '@opensrcs/training'
