...
<script lang="ts">
  ...
  import { Button, IconMoreH, type IModeSelector, navigate, rawLocation } from '@opensrcs/ui'
  import view, { type Action } from '@opensrcs/view'
  import { ActionButton, showMenu } from '@opensrcs/view-resources'
