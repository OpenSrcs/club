...
<script lang="ts">
  import core, { type DocumentQuery, type FindOptions, type Ref, type Role, SortingOrder } from '@opensrcs/core'
  import presentation, { ObjectPopup } from '@opensrcs/presentation'
