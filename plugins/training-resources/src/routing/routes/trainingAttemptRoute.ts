...
import { isEnum, isId } from '@opensrcs/core'
import { type TrainingAttempt, trainingId } from '@opensrcs/training'
import { getClient } from '@opensrcs/presentation'
import { getCurrentLocation, type Location, type ResolvedLocation } from '@opensrcs/ui'
