...
-->
<script lang="ts">
  import { Class, Doc, DocumentQuery, FindOptions, Ref, SortingOrder } from '@opensrcs/core'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { Label, Loading } from '@opensrcs/ui'
  import { buildModel } from '@opensrcs/view-resources'
  import { Category } from '@opensrcs/inventory'
  import HierarchyElement from './HierarchyElement.svelte'
  import { buildConfigLookup } from '@opensrcs/view-resources/src/utils'
