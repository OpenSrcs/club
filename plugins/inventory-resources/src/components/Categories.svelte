...
-->
<script lang="ts">
  import core, { DocumentQuery } from '@opensrcs/core'
  import { Button, Breadcrumb, Scroller, SearchInput, showPopup, IconAdd, Header } from '@opensrcs/ui'
  import type { Category } from '@opensrcs/inventory'
