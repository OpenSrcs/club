...
-->
<script lang="ts">
  import core, { Doc, generateId, PersonId, Ref } from '@opensrcs/core'
  import { Category, Product } from '@opensrcs/inventory'
  import { Card, createQuery, getClient } from '@opensrcs/presentation'
  import { Button, DropdownLabels, DropdownTextItem, EditBox } from '@opensrcs/ui'
