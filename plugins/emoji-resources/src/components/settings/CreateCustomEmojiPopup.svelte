<script lang="ts">
  ...
  import { Button, EditBox, Label, Modal, showPopup } from '@opensrcs/ui'

  import { getEmojiByShortCode } from '../../utils'
  import emojiPlugin, { shortcodeRegex } from '@opensrcs/emoji'
  import { createEventDispatcher } from 'svelte'
  import { getClient, MessageBox, uploadFile } from '@opensrcs/presentation'
