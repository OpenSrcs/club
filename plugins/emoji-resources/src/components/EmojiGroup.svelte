...
<script lang="ts">
  import plugin, { Label, Lazy } from '@opensrcs/ui'
  import EmojiGroupPalette from './EmojiGroupPalette.svelte'
  import { EmojiWithGroup } from '@opensrcs/emoji'
...
<div class="clubPopupEmoji-group kind-{kind}" class:lazy>
  <div id={group.id} class="clubPopupEmoji-group__header categoryHeader">
