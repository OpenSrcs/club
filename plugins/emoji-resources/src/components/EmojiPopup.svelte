<script lang="ts">
  ...
  import type { EmojiWithGroup } from '@opensrcs/emoji'
  ...
  import emojiPlugin, { isCustomEmoji } from '@opensrcs/emoji'
  import { emojiCategories, EmojiCategory } from '../types'
  import { Ref, Blob } from '@opensrcs/core'
...
<div class="clubPopupEmoji-container kind-{kind}" class:embedded>
  <div class="clubPopupEmoji-header__tabs-wrapper">
    <div class="clubPopupEmoji-header__tabs">
      {#each categoryTabs as category (category.id)}
        <button
          class="clubPopupEmoji-header__tab"
      ...
      <div
        ...
        class="clubPopupEmoji-header__tab-cursor"
      />
    </div>
  </div>
  <div class="clubPopupEmoji-header__tools">
    <SearchInput
      value={$searchEmoji}
  ...
  {#if !hidden && kind === 'fade'}<div class="clubPopupEmoji-footer" />{/if}
</div>

<style lang="scss">
  .clubPopupEmoji-container {
    position: relative;
    display: flex;
    ...
    .clubPopupEmoji-header__tools,
    .clubPopupEmoji-header__tabs-wrapper,
    .clubPopupEmoji-header__tabs,
    .clubPopupEmoji-header__tab {
      display: flex;
      align-items: center;
      flex-shrink: 0;
      min-width: 0;
    ...
    .clubPopupEmoji-header__tab-cursor {
      position: absolute;
      bottom: -0.25rem;
      width: 2rem;
      height: 0.125rem;
