<script lang="ts">
  ...
  import { tooltip, capitalizeFirstLetter, type LabelAndProps } from '@opensrcs/ui'
  import { isCustomEmoji, type ExtendedEmoji } from '@opensrcs/emoji'
