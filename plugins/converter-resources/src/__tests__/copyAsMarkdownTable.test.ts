...
import type { Doc, Class, Ref } from '@opensrcs/core'
...
import { copyMarkdown, buildModel, getObjectLinkFragment } from '@opensrcs/view-resources'
...
describe('converter-resources', () => {
  ...
  describe('copyAsMarkdownTable', () => {
    ...
    it('calls copyMarkdown and addNotification on success', async () => {
      ...
      const { addNotification } = await import('@opensrcs/ui')
