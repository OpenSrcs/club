...
import core, { type Class, type Client, type Doc, type Hierarchy, type Ref } from '@opensrcs/core'
import type { AttributeModel, BuildModelKey, Viewlet } from '@opensrcs/view'
import viewPlugin from '@opensrcs/view'
import { buildModel, buildConfigLookup } from '@opensrcs/view-resources'
