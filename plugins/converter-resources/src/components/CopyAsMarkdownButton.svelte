...
<script lang="ts">
  ...
  import { ButtonMenu, IconCopy, IconMoreH, type DropdownIntlItem } from '@opensrcs/ui'
  import view from '@opensrcs/view'
  import { viewletContextStore } from '@opensrcs/view-resources'
  import { copyAsMarkdownTableFromResource, copyRelationshipTableAsMarkdown } from '../markdown/copyActions'

  export let _class: Ref<Class<Doc>>
  export let query: DocumentQuery<Doc> = {}
  export let config: Array<string | import('@opensrcs/view').BuildModelKey> = []
