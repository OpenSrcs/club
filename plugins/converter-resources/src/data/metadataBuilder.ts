...
import { concatLink, type Client, type Doc, type Ref } from '@opensrcs/core'
import { getMetadata } from '@opensrcs/club'
import { getCurrentResolvedLocation, locationToUrl } from '@opensrcs/ui'
import presentation from '@opensrcs/presentation'
import type { TableMetadata, Viewlet } from '@opensrcs/view'
