...
import core, { type Class, type Client, type Doc, type Hierarchy, type Ref, type PersonId } from '@opensrcs/core'
...
import { buildConfigLookup, buildModel, getAttributeValue, buildConfigAssociation } from '@opensrcs/view-resources'
