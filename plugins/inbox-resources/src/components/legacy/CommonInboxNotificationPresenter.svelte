...
-->
<script lang="ts">
  import core, { Doc, Markup } from '@opensrcs/core'
  import { CommonInboxNotification } from '@opensrcs/notification'
  import { getEmbeddedLabel, IntlString, translateCB } from '@opensrcs/club'
  import { Icon, Label, themeStore, tooltip } from '@opensrcs/ui'
  import { Person } from '@opensrcs/contact'
  import { getClient, LiteMessageViewer } from '@opensrcs/presentation'
