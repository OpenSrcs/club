...
<script lang="ts">
  ...
  import { CheckBox, Loading, Spinner } from '@opensrcs/ui'
  import { AccountRole, Doc, getCurrentAccount } from '@opensrcs/core'
  import notification, { ActivityNotificationViewlet, InboxNotification } from '@opensrcs/notification'
  import { Card } from '@opensrcs/card'
  import { Notification, NotificationType } from '@opensrcs/communication-types'
  ...
  import { isReactionNotification } from '@opensrcs/notification-resources'
