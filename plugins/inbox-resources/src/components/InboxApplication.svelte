...
<script lang="ts">
  ...
  import { Class, Doc, getCurrentAccount, Ref } from '@opensrcs/core'
  import notification, { DocNotifyContext, InboxNotification } from '@opensrcs/notification'
  import { Notification } from '@opensrcs/communication-types'
  ...
  import cardPlugin from '@opensrcs/card'
...
<div class="clubPanels-container inbox">
  ...
  <div bind:this={replacedPanelElement} class="clubComponent inbox__panel">
    {#if doc}
