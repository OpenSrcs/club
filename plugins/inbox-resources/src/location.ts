...
import type { Class, Doc, Ref, WithLookup } from '@opensrcs/core'
import {
  navigate,
  type Location,
...
import { type MessageID, type Notification } from '@opensrcs/communication-types'
import { decodeObjectURI, encodeObjectURI } from '@opensrcs/view'
...
import chunter, { type ThreadMessage } from '@opensrcs/chunter'
import { isActivityMessageClass, messageInFocus } from '@opensrcs/activity-resources'
import { getClient } from '@opensrcs/presentation'
import { isMentionNotification, isReactionNotification } from '@opensrcs/notification-resources'
