...
import { type Asset, getMetadata, getResource, type IntlString, setMetadata, translate } from '@opensrcs/club'
import presentation, { configurationStore, getClient } from '@opensrcs/presentation'
import {
  type AnyComponent,
  getCurrentLocation,
  languageStore,
...
import { type Application, workbenchId, type WorkbenchTab } from '@opensrcs/workbench'
