<script lang="ts">
  ...
  import { groupByArray, systemAccountUuid } from '@opensrcs/core'
  import { getEmbeddedLabel, getMetadata } from '@opensrcs/club'
  import presentation, { isAdminUser, type OverviewStatistics } from '@opensrcs/presentation'
  import { Button, CheckBox, ticker, Expandable } from '@opensrcs/ui'
  import { FixedColumn, ObjectPresenter } from '@opensrcs/view-resources'
