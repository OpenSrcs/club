...
-->
<script lang="ts">
  import type { Class, Doc, DocumentQuery, Ref, Space } from '@opensrcs/core'
  import core, { WithLookup } from '@opensrcs/core'
  ...
  import view, { ViewOptions, Viewlet } from '@opensrcs/view'
  import {
    FilterButton,
    ViewletSelector,
...
{:else}
  <div class="clubHeader-container" />
{/if}
