...
<script lang="ts">
  ...
  import { isArchivingMode, systemAccountUuid, WorkspaceInfoWithStatus } from '@opensrcs/core'
  import login from '@opensrcs/login'
  import { getMetadata, getResource } from '@opensrcs/club'
  import presentation, { createQuery, decodeTokenPayload, hasResource, isAdminUser } from '@opensrcs/presentation'
  import {
    closePopup,
    Component,
