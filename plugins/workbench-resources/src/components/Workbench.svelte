...
<script lang="ts">
  ...
  import { myEmployeeStore } from '@opensrcs/contact-resources'
  import core, {
    AccountRole,
    Class,
    Doc,
  ...
  import notification, { DocNotifyContext, InboxNotification, notificationId } from '@opensrcs/notification'
  import { BrowserNotificatator, InboxNotificationsClientImpl } from '@opensrcs/notification-resources'
  import inbox, { inboxId } from '@opensrcs/inbox'
  import { broadcastEvent, getMetadata, getResource, IntlString, translate } from '@opensrcs/club'
  import {
    ActionContext,
    ComponentExtensions,
    createQuery,
  ...
  import support, { supportLink, SupportStatus } from '@opensrcs/support'
  import {
    AnyComponent,
    areLocationsEqual,
    Button,
    ...
    <div class="flex-row-center w-full h-full">
      ...
      >
        ...
        {#if mainNavigator}
          ...
          >
            <div class="antiPanel-wrap__content clubNavPanel-container">
        ...
        <div
          ...
          class={navigatorModel === undefined ? 'clubPanels-container' : 'clubComponent overflow-hidden'}
