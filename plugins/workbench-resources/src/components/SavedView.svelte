<script lang="ts">
  ...
  import { AccountRole, Ref, getCurrentAccount, toIdMap } from '@opensrcs/core'
  import { copyTextToClipboard, createQuery, getClient } from '@opensrcs/presentation'
  ...
  import view, { Filter, FilteredView, ViewOptions, Viewlet } from '@opensrcs/view'
  import {
    EditBoxPopup,
    TreeItem,
    TreeNode,
