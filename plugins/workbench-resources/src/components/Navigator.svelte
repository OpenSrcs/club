...
-->
<script lang="ts">
  import core, { Doc, Ref, SortingOrder, Space, getCurrentAccount, hasAccountRole } from '@opensrcs/core'
  import { getResource } from '@opensrcs/club'
  import preference, { SpacePreference } from '@opensrcs/preference'
  import { createQuery, getClient, isAdminUser } from '@opensrcs/presentation'
  import { Scroller, NavItem, Component } from '@opensrcs/ui'
  import { NavLink } from '@opensrcs/view-resources'
  import type { Application, NavigatorModel, SpecialNavModel } from '@opensrcs/workbench'
