...
-->
<script lang="ts">
  import core, { Doc, Ref, Space, AccountRole, getCurrentAccount, hasAccountRole } from '@opensrcs/core'
  import { IntlString, getResource } from '@opensrcs/club'
  ...
  import { TreeNode } from '@opensrcs/view-resources'
  import { SpacesNavModel } from '@opensrcs/workbench'
  import { createEventDispatcher } from 'svelte'
  import { InboxNotificationsClientImpl } from '@opensrcs/notification-resources'
  import { DocNotifyContext, InboxNotification } from '@opensrcs/notification'
