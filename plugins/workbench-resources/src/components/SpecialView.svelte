...
-->
<script lang="ts">
  import { Class, Doc, DocumentQuery, FindOptions, Ref, Space, WithLookup, mergeQueries } from '@opensrcs/core'
  import { Asset, getResource, IntlString, Resource } from '@opensrcs/club'
  import { getClient, ComponentExtensions } from '@opensrcs/presentation'
  import {
    AnyComponent,
    AnySvelteComponent,
    Breadcrumb,
  ...
  import view, { Viewlet, ViewletDescriptor, ViewletPreference, ViewOptions, BuildModelKey } from '@opensrcs/view'
  import {
    FilterBar,
    FilterButton,
    getResultOptions,
  ...
  import workbench, { type ParentsNavigationModel } from '@opensrcs/workbench'
