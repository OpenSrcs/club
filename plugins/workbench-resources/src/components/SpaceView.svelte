...
-->
<script lang="ts">
  import core, { Class, Doc, Ref, Space, WithLookup } from '@opensrcs/core'
  import { IntlString } from '@opensrcs/club'
  import { getClient, reduceCalls } from '@opensrcs/presentation'
  import { AnyComponent, Component, resolvedLocationStore } from '@opensrcs/ui'
  ...
  import type { ViewConfiguration } from '@opensrcs/workbench'
