...
-->
<script lang="ts">
  import type { Class, Doc, DocumentQuery, Ref, Space, WithLookup } from '@opensrcs/core'
  ...
  import { AnyComponent, Component, Loading } from '@opensrcs/ui'
  import view, { Viewlet, ViewletPreference, ViewOptions } from '@opensrcs/view'
  import { FilterBar } from '@opensrcs/view-resources'
