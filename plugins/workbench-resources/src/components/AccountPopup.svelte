...
-->
<script lang="ts">
  import contact, { formatName, getCurrentEmployee, isWorkspaceMemberStatusVisible } from '@opensrcs/contact'
  import {
    myEmployeeStore,
    loadWorkspaceMemberStatuses,
    workspaceMemberStatusByAccountStore
  } from '@opensrcs/contact-resources'
  import contactResources from '@opensrcs/contact-resources/src/plugin'
  import core, { AccountRole, getCurrentAccount, hasAccountRole } from '@opensrcs/core'
  import rating, { type PersonRating } from '@opensrcs/rating'
  ...
  import setting, { RoleCapability, settingId, SettingsCategory } from '@opensrcs/setting'
  import {
    Action,
    closePopup,
    Component,
  ...
  import { allowGuestSignUpStore } from '@opensrcs/view-resources'
