...
<script lang="ts">
  ...
  import core, { AccountRole, getCurrentAccount, type ModulePermissionGroup, type Ref } from '@opensrcs/core'
  import { createNotificationsQuery, createQuery } from '@opensrcs/presentation'
  import { Scroller, deviceOptionsStore as deviceInfo } from '@opensrcs/ui'
  ...
  import { NotificationType } from '@opensrcs/communication-types'
