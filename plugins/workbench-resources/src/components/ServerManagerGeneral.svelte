<script lang="ts">
  import core, { RateLimiter, concatLink, metricsAggregate, platformNow, type Metrics } from '@opensrcs/core'
  import login from '@opensrcs/login'
  import { getEmbeddedLabel, getMetadata } from '@opensrcs/club'
  import presentation, { getClient, isAdminUser, uiContext } from '@opensrcs/presentation'
  import { Button, EditBox, IconArrowLeft, IconArrowRight, fetchMetadataLocalStorage, ticker } from '@opensrcs/ui'
