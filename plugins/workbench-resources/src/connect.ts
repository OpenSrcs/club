import { getClient as getAccountClient, type WorkspaceLoginInfo } from '@opensrcs/account-client'
import { Analytics } from '@opensrcs/analytics'
import client from '@opensrcs/client'
import contact, { ensureEmployee, setCurrentEmployee, setCurrentEmployeeSpace } from '@opensrcs/contact'
import core, {
  type Account,
  AccountRole,
  type Client,
...
import login, { loginId, type Pages } from '@opensrcs/login'
import platform, {
  broadcastEvent,
  getMetadata,
  getResource,
...
import { WorkbenchEvents } from '@opensrcs/workbench'
