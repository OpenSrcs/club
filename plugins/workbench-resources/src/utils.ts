...
import core, { hasAccountRole } from '@opensrcs/core'
import login from '@opensrcs/login'
import { getMetadata, getResource, setMetadata } from '@opensrcs/club'
import presentation, { closeClient, getClient, setPresentationCookie } from '@opensrcs/presentation'
import {
  closePanel,
  getCurrentLocation,
  type Location,
...
import workbench, { type Application, type NavigatorModel } from '@opensrcs/workbench'
