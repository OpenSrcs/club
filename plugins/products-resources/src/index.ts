...
import products, { type Product } from '@opensrcs/products'
import type { Class, Client, DocumentQuery, Ref, RelatedDocument, WithLookup } from '@opensrcs/core'
import { type Resources } from '@opensrcs/club'
import { type ObjectSearchResult } from '@opensrcs/presentation'
