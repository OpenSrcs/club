...
<script lang="ts">
  import { AttachmentStyleBoxEditor } from '@opensrcs/attachment-resources'
  import core, { type Class, type Doc, type Ref, getCurrentAccount } from '@opensrcs/core'
  import { checkMyPermission, permissionsStore } from '@opensrcs/contact-resources'
  import notification from '@opensrcs/notification'
  import { Panel } from '@opensrcs/panel'
  import { getResource } from '@opensrcs/club'
  import { ActionContext, MessageViewer, IconWithEmoji, createQuery, getClient } from '@opensrcs/presentation'
  import { Button, EditBox, IconMixin, IconMoreH, getPlatformColorDef, showPopup, themeStore } from '@opensrcs/ui'
  import view from '@opensrcs/view'
  import { DocAttributeBar, IconPicker, getDocMixins, showMenu } from '@opensrcs/view-resources'
  import type { Product } from '@opensrcs/products'
