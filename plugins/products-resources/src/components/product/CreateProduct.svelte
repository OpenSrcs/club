...
<script lang="ts">
  ...
  import { type DocumentSpaceType } from '@opensrcs/controlled-documents'
  import { type Product, ProductVersionState } from '@opensrcs/products'
  import { type Attachment } from '@opensrcs/attachment'
  import { AttachmentPresenter, AttachmentStyledBox } from '@opensrcs/attachment-resources'
  import { AccountArrayEditor, employeeRefByAccountUuidStore, getAnonymousRefs } from '@opensrcs/contact-resources'
  import core, {
    AccountUuid,
    Data,
    Ref,
  ...
  import { Card, MessageBox, IconWithEmoji, createQuery, getClient } from '@opensrcs/presentation'
  import {
    Button,
    DropdownLabelsIntl,
    EditBox,
  ...
  import { IconPicker, SpaceTypeSelector } from '@opensrcs/view-resources'
