...
-->
<script lang="ts">
  import { ProductVersionState, productVersionStates } from '@opensrcs/products'
  import { Button, ButtonKind, ButtonSize, SelectPopup, eventToHTMLElement, showPopup } from '@opensrcs/ui'
