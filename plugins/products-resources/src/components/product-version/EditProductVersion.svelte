...
<script lang="ts">
  ...
  import core, { Class, Doc, Ref, WithLookup, getCurrentAccount } from '@opensrcs/core'
  ...
  import { ActionContext, MessageViewer, createQuery, getClient } from '@opensrcs/presentation'
  import { Button, IconMixin, IconMoreH } from '@opensrcs/ui'
  import { DocAttributeBar, getDocMixins, showMenu } from '@opensrcs/view-resources'
  import type { ProductVersion } from '@opensrcs/products'
