...
-->
<script lang="ts">
  import type { Product, ProductVersion } from '@opensrcs/products'
  import core, { FindOptions, SortingOrder } from '@opensrcs/core'
  ...
  import { DocNavLink, ObjectPresenter, Table } from '@opensrcs/view-resources'
