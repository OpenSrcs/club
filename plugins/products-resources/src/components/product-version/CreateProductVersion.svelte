...
<script lang="ts">
  ...
  import { Product, ProductVersion, ProductVersionState } from '@opensrcs/products'
  import { Data, Ref, SortingOrder, generateId } from '@opensrcs/core'
  import { Card, MessageBox, SpaceSelector, createQuery, getClient } from '@opensrcs/presentation'
  import { StyledTextBox } from '@opensrcs/text-editor-resources'
  import { DropdownLabelsIntl, EditBox, FocusHandler, createFocusManager, showPopup } from '@opensrcs/ui'
