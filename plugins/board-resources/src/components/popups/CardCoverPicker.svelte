<script lang="ts">
  import { CardCover, Card } from '@opensrcs/board'
  import presentation, { Card as Popup, getClient } from '@opensrcs/presentation'
  import { Button, hexColorToNumber, Icon, Label, IconCheck } from '@opensrcs/ui'
