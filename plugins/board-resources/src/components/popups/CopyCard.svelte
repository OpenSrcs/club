<script lang="ts">
  ...
  import { Label, Status as StatusControl, TextArea } from '@opensrcs/ui'
  import { Class, Client, Doc, Ref, generateId, AttachedData } from '@opensrcs/core'
  import { getResource, OK, Resource, Status } from '@opensrcs/club'
  import { Card as Popup, getClient } from '@opensrcs/presentation'
