...
-->
<script lang="ts">
  import type { Card as BoardCard } from '@opensrcs/board'
  import board from '../../plugin'
  import core, { AttachedData, generateId, Ref, Space } from '@opensrcs/core'
  import { IconAdd, Button, showPopup } from '@opensrcs/ui'
