...
-->
<script lang="ts">
  import { AttachmentDroppable, AttachmentsPresenter } from '@opensrcs/attachment-resources'
  import type { Card } from '@opensrcs/board'
  import contact, { Employee } from '@opensrcs/contact'
  import type { Ref, WithLookup } from '@opensrcs/core'
  import notification from '@opensrcs/notification'
  import { ChatMessagesPresenter } from '@opensrcs/notification-resources'
  import { getClient } from '@opensrcs/presentation'
  import tags from '@opensrcs/tags'
  import { Button, Component, EditBox, Icon, IconMoreV, Label, numberToHexColor } from '@opensrcs/ui'
