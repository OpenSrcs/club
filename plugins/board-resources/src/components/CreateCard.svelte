...
-->
<script lang="ts">
  import type { Board, Card as BoardCard } from '@opensrcs/board'
  import core, { AttachedData, Ref, SortingOrder, Space, generateId } from '@opensrcs/core'
  import { OK, Status } from '@opensrcs/club'
  import { Card, SpaceSelector, createQuery, getClient } from '@opensrcs/presentation'
  import { TaskType } from '@opensrcs/task'
  import { EditBox, Grid, Status as StatusControl } from '@opensrcs/ui'
