...
-->
<script lang="ts">
  import { Attachments } from '@opensrcs/attachment-resources'
  import type { Card } from '@opensrcs/board'
  import core, { Class, Doc, Mixin, Ref, Space } from '@opensrcs/core'
  ...
  import { Button, EditBox, IconMoreH } from '@opensrcs/ui'
  import { DocAttributeBar, ParentsNavigator, invokeAction, showMenu } from '@opensrcs/view-resources'
