...
import { createQuery, onClient } from '@opensrcs/presentation'
import task, {
  getStatusIndex,
  makeRank,
  type Project,
...
import { getCurrentLocation, navigate, showPopup } from '@opensrcs/ui'
import { type ViewletDescriptor } from '@opensrcs/view'
import { CategoryQuery, statusStore } from '@opensrcs/view-resources'
