...
-->
<script lang="ts">
  import core, { Doc, FindResult, IdMap, Ref, RefTo, Space, Status, toIdMap } from '@opensrcs/core'
  ...
  import { Filter } from '@opensrcs/view'
  import {
    FILTER_DEBOUNCE_MS,
  ...
  import { buildConfigLookup, getPresenter } from '@opensrcs/view-resources/src/utils'
