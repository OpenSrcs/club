...
-->
<script lang="ts">
  import contact, { Employee, Person, getName } from '@opensrcs/contact'
  import { Class, Doc, Ref, Space } from '@opensrcs/core'
  import { Task } from '@opensrcs/task'
  import { getClient } from '@opensrcs/presentation'
  import { UsersPopup, employeeByIdStore } from '@opensrcs/contact-resources'
  import { AttributeModel } from '@opensrcs/view'
  import { eventToHTMLElement, showPopup } from '@opensrcs/ui'
  import { getObjectPresenter } from '@opensrcs/view-resources'
