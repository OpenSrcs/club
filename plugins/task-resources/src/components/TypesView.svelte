...
-->
<script lang="ts">
  import { Class, Doc, DocumentQuery, mergeQueries, Ref, Space, WithLookup } from '@opensrcs/core'
  import { IntlString } from '@opensrcs/club'
  import { createQuery } from '@opensrcs/presentation'
  import { Project, ProjectType, ProjectTypeDescriptor } from '@opensrcs/task'
  import { AnyComponent, Button, Component, IconAdd, Loading, SearchInput, showPopup, Header } from '@opensrcs/ui'
  import { Viewlet, ViewletDescriptor, ViewletPreference, ViewOptions } from '@opensrcs/view'
  import {
    FilterBar,
    FilterButton,
    getResultOptions,
