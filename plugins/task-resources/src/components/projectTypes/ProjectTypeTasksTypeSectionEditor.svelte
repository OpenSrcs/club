...
<script lang="ts">
  ...
  import { ButtonIcon, IconAdd, Label, getCurrentResolvedLocation, navigate } from '@opensrcs/ui'
  import { createQuery } from '@opensrcs/presentation'
  import { ProjectType, ProjectTypeDescriptor, TaskType } from '@opensrcs/task'
