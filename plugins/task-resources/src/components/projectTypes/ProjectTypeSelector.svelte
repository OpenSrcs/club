...
<script lang="ts">
  ...
  import type { ProjectType, ProjectTypeDescriptor } from '@opensrcs/task'
  import task from '@opensrcs/task'
  import type { DropdownTextItem } from '@opensrcs/ui'
  import { ButtonKind, ButtonSize, DropdownLabels } from '@opensrcs/ui'
