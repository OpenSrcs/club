...
<script lang="ts">
  import { SpaceTypeDescriptor, generateId } from '@opensrcs/core'
  import { getClient } from '@opensrcs/presentation'
  import { ProjectTypeDescriptor, createProjectType } from '@opensrcs/task'
  import { ToggleWithLabel } from '@opensrcs/ui'
