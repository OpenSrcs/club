...
-->
<script lang="ts">
  import core, { Class, DocumentQuery, IdMap, Ref, Status, Timestamp } from '@opensrcs/core'
  import { createQuery } from '@opensrcs/presentation'
  import type { Project, Task } from '@opensrcs/task'
  import task, { getStates } from '@opensrcs/task'
  import { BarDashboard, DashboardItem } from '@opensrcs/ui'
