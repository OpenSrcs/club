...
<script lang="ts">
  ...
  import { DocWithRank, Item, Kanban as KanbanUI } from '@opensrcs/kanban'
  ...
  import { Project, Task, TaskOrdering } from '@opensrcs/task'
  import { ColorDefinition, defaultBackground, Label, themeStore } from '@opensrcs/ui'
