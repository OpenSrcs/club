<script lang="ts">
  ...
  import { Class, IdMap, Ref, Status } from '@opensrcs/core'
  import { IntlString } from '@opensrcs/club'
  import { DocPopup, getClient } from '@opensrcs/presentation'
  import { Task, TaskType } from '@opensrcs/task'
  import { getObjectId, ObjectPresenter, statusStore } from '@opensrcs/view-resources'
