...
-->
<script lang="ts">
  import core, { Class, ClassifierKind, Data, Ref, RefTo, Status, generateId, toIdMap } from '@opensrcs/core'
  import { Resource, getEmbeddedLabel, getResource } from '@opensrcs/club'
  import presentation, { getClient, hasResource } from '@opensrcs/presentation'
  import {
    ProjectType,
  ...
  import { DropdownIntlItem, Modal, ModernEditbox, Label, ButtonMenu } from '@opensrcs/ui'
