<!--
// Copyright © 2026, 2022, 2023, 2024 OpenSrcs.
//
...
-->
<script lang="ts">
  import { Ref, SortingOrder, Status } from '@opensrcs/core'
  import { Asset, getEmbeddedLabel, getResource } from '@opensrcs/club'
  import { AttributeEditor, MessageBox, createQuery, getClient } from '@opensrcs/presentation'
  import { ClassAttributes, settingsStore } from '@opensrcs/setting-resources'
  import task, { ProjectType, TaskType, calculateStatuses, findStatusAttr } from '@opensrcs/task'
  import {
    ButtonIcon,
    Icon,
    IconAdd,
  ...
  import { IconPicker, deleteObjects, statusStore } from '@opensrcs/view-resources'
      ...
      <Scroller align={'center'} padding={'var(--spacing-3)'} bottomPadding={'var(--spacing-3)'}>
        <div class="clubComponent-content gap">
          <div class="clubComponent-content__column-group mt-4">
            <div class="clubComponent-content__header mb-6">
