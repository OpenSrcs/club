...
-->
<script lang="ts">
  import { Class, DocumentQuery, FindOptions, Ref, Status } from '@opensrcs/core'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { Project, Task, getStates } from '@opensrcs/task'
  import type { TabItem } from '@opensrcs/ui'
  import { ScrollerBar, TabList, Switcher } from '@opensrcs/ui'
  import { TableBrowser, statusStore } from '@opensrcs/view-resources'
