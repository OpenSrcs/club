...
-->
<script lang="ts">
  import core, { Attribute, Class, Ref, Status, StatusCategory } from '@opensrcs/core'
  import { Asset, getEmbeddedLabel } from '@opensrcs/club'
  import presentation, { IconWithEmoji, createQuery, getClient } from '@opensrcs/presentation'
  import { clearSettingsStore, settingsStore } from '@opensrcs/setting-resources'
  import { ProjectType, TaskType, calculateStatuses, createState } from '@opensrcs/task'
  import {
    Component,
    ButtonIcon,
    ButtonMenu,
  ...
  import { ColorsPopup, statusStore } from '@opensrcs/view-resources'
  import view from '@opensrcs/view-resources/src/plugin'
...
>
  ...
  <div class="clubModal-content__titleGroup">
  ...
  <div class="clubModal-content__settingsSet table">
    <div class="clubTableAttr-container">
      <div class="clubTableAttr-header font-medium-12 withButton">
        <ButtonMenu
          {items}
          {selected}
          icon={IconSettings}
      ...
      <div class="clubTableAttr-content">
        {#if selected === 0}
          <ColorsPopup
