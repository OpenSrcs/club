...
<script lang="ts">
  ...
  import { BreadcrumbsElement, createQuery } from '@opensrcs/presentation'
  import task, { Project, ProjectType, getStates } from '@opensrcs/task'
  import { ScrollerBar, getColorNumberByText, getPlatformColor, themeStore } from '@opensrcs/ui'
