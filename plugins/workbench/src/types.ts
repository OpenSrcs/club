...
import type { AccountRole, AccountUuid, Class, Doc, DocumentQuery, Obj, Ref, Space } from '@opensrcs/core'
import { DocNotifyContext, InboxNotification } from '@opensrcs/notification'
import type { Asset, IntlString, Resource } from '@opensrcs/club'
import type { Preference } from '@opensrcs/preference'
import { AnyComponent, type AnySvelteComponent, Location, ResolvedLocation } from '@opensrcs/ui'
