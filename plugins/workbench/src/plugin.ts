...
import type { Class, Doc, Mixin, Ref, Space } from '@opensrcs/core'
import type { Asset, IntlString, Metadata, Plugin, Resource } from '@opensrcs/club'
import { plugin } from '@opensrcs/club'
import { AnyComponent, ComponentExtensionId, Location } from '@opensrcs/ui'
import { Action, ViewAction } from '@opensrcs/view'
