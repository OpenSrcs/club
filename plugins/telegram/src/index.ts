...
import { ChannelItem } from '@opensrcs/contact'
import { AttachedDoc, Class, Doc, IntegrationKind, Ref, Timestamp } from '@opensrcs/core'
import { NotificationProvider, NotificationType } from '@opensrcs/notification'
import type { Asset, IntlString, Metadata, Plugin } from '@opensrcs/club'
import { plugin } from '@opensrcs/club'
import type { Handler, IntegrationType } from '@opensrcs/setting'
import { TemplateField } from '@opensrcs/templates'
 ...
 * @public
 */
export const telegramIntegrationKind = 'clubgram' as IntegrationKind
