...
import { AccountRole, getCurrentAccount, type Ref } from '@opensrcs/core'
import { getCurrentEmployee, type Person } from '@opensrcs/contact'
import { type PopupResult, showPopup } from '@opensrcs/ui'
import { type UnsubscribeCallback } from '@opensrcs/clubpulse-client'
import presentation, { createPulseClient } from '@opensrcs/presentation'
import { getMetadata } from '@opensrcs/club'
import { type Room } from '@opensrcs/love'
