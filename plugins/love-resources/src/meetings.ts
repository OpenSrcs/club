import core, { AccountRole, getCurrentAccount, type Ref } from '@opensrcs/core'
import love, { getFreeRoomPlace, MeetingStatus, type Room, RoomType, isOffice, RoomAccess } from '@opensrcs/love'
