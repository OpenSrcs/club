...
import { connectMeeting, disconnectMeeting } from '@opensrcs/ai-bot-resources'
import { Analytics } from '@opensrcs/analytics'
import calendar, { type Event, type Schedule } from '@opensrcs/calendar'
import chunter from '@opensrcs/chunter'
...
import login from '@opensrcs/login'
import {
  isOffice,
  LoveEvents,
  loveId,
...
import { getEmbeddedLabel, getMetadata, getResource, type IntlString } from '@opensrcs/club'
import presentation, {
  copyTextToClipboard,
  type DocCreatePhase,
  getClient,
...
import { closePanel, getCurrentLocation, navigate, panelstore, showPopup } from '@opensrcs/ui'
import view from '@opensrcs/view'
import { getObjectLinkFragment } from '@opensrcs/view-resources'
import { type Widget, type WidgetTab } from '@opensrcs/workbench'
import { openWidget, openWidgetTab, sidebarStore, updateWidgetState } from '@opensrcs/workbench-resources'
...
import { getClient as getAccountClientRaw } from '@opensrcs/account-client'
