...
-->
<script lang="ts">
  import { AccountRole, getCurrentAccount, hasAccountRole, Ref, WithLookup } from '@opensrcs/core'
  import { Floor, Room } from '@opensrcs/love'
  import { Component, DropdownLabels, Header, IconEdit, ModernButton } from '@opensrcs/ui'
  import { Viewlet, ViewletPreference } from '@opensrcs/view'
  import { ViewletSelector } from '@opensrcs/view-resources'
