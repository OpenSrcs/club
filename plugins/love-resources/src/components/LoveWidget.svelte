...
-->
<script lang="ts">
  import { AccountRole, getCurrentAccount, hasAccountRole, Ref } from '@opensrcs/core'
  import love, { Floor, Room } from '@opensrcs/love'
  import { Breadcrumbs, ButtonIcon, eventToHTMLElement, Header, IconAdd, Scroller, showPopup } from '@opensrcs/ui'
...
<div class="clubModal-container noTopIndent type-aside">
  <div class="clubModal-content">
    <Scroller>
