...
<script lang="ts">
  ...
  import { isOffice, ParticipantInfo, Room } from '@opensrcs/love'
  import { getClient } from '@opensrcs/presentation'
  import { closePopup, eventToHTMLElement, Location, location, showPopup, closeTooltip } from '@opensrcs/ui'
  import { onDestroy } from 'svelte'
  import workbench from '@opensrcs/workbench'
  import { closeWidget, sidebarStore } from '@opensrcs/workbench-resources'
