<script lang="ts">
  ...
  import { DevicesPreference } from '@opensrcs/love'
  import { getClient } from '@opensrcs/presentation'
  import { Component, Label, Loading, Toggle } from '@opensrcs/ui'
  import { isKrispNoiseFilterSupported } from '@livekit/krisp-noise-filter'
  import love from '../../plugin'
  import { myPreferences } from '../../stores'
  import { krispProcessor } from '../../utils'
  import mediaPlugin, { getMediaDevices } from '@opensrcs/media'
