...
-->
<script lang="ts">
  import love, { MeetingMinutes } from '@opensrcs/love'
  import { ChannelEmbeddedContent } from '@opensrcs/chunter-resources'
  import { ActivityMessage } from '@opensrcs/activity'
  import { updateTabData, WidgetState } from '@opensrcs/workbench-resources'
