...
-->
<script lang="ts">
  import { getCurrentEmployee, Person } from '@opensrcs/contact'
  import { Avatar, myEmployeeStore, getPersonByPersonRef } from '@opensrcs/contact-resources'
  import { ParticipantInfo, Room, RoomAccess, RoomType, MeetingStatus } from '@opensrcs/love'
  import { Icon, Label, eventToHTMLElement, showPopup } from '@opensrcs/ui'
...
<div
  ...
  style:--club-floor-roomWidth={room.width + extraRow}
