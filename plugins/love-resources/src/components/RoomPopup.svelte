...
<script lang="ts">
  ...
  import { UserInfo, getPersonByPersonRef } from '@opensrcs/contact-resources'
  import { Class, Doc, Ref } from '@opensrcs/core'

  import { IconArrowLeft, Location, ModernButton, Scroller, location, navigate, panelstore } from '@opensrcs/ui'

  import { MeetingMinutes, ParticipantInfo, Room, loveId } from '@opensrcs/love'
