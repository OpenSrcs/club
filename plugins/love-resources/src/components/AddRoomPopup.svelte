<script lang="ts">
  import core, { Class, Data, generateId, type Doc, Ref } from '@opensrcs/core'
  import { Floor, getFreePosition, Office, Room, RoomAccess, RoomType } from '@opensrcs/love'
  import { translate } from '@opensrcs/club'
  import { getClient } from '@opensrcs/presentation'
  import setting, { type OfficeSettings } from '@opensrcs/setting'
  import { Button, DropdownIntlItem } from '@opensrcs/ui'
