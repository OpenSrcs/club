...
-->
<script lang="ts">
  import { getCurrentEmployee, formatName } from '@opensrcs/contact'
  import { getPersonByPersonRefStore } from '@opensrcs/contact-resources'
  import { translate } from '@opensrcs/club'
  import { notEmpty, Ref } from '@opensrcs/core'
  import love, { isOffice, Room } from '@opensrcs/love'
  import { Dropdown, Icon } from '@opensrcs/ui'
