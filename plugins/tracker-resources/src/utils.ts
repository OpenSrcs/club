...
import { createQuery, getClient, onClient } from '@opensrcs/presentation'
import task, { getStatusIndex, makeRank, type TaskType, type ProjectType } from '@opensrcs/task'
import {
  selectedTaskTypeStore,
  activeProjects as taskActiveProjects,
  taskTypeStore,
  typesOfJoinedProjectsStore
} from '@opensrcs/task-resources'
import {
  IssuePriority,
  MilestoneStatus,
  TimeReportDayType,
...
import { areDatesEqual, isWeekend, PaletteColorIndexes } from '@opensrcs/ui'
import { type KeyFilter, type ViewletDescriptor } from '@opensrcs/view'
import { CategoryQuery, ListSelectionProvider, statusStore, type SelectDirection } from '@opensrcs/view-resources'
