...
import { type Class, type Doc, type Hierarchy, type Ref, type PersonId } from '@opensrcs/core'
import trackerPlugin, { type Component, type IssueStatus, type Milestone, type Project } from '@opensrcs/tracker'
import { type AttributeModel } from '@opensrcs/view'
import { getClient } from '@opensrcs/presentation'
import { getName, getPersonByPersonId } from '@opensrcs/contact'
