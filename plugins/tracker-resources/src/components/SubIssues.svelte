...
<script lang="ts">
  ...
  import core, { AttachedData, Doc, makeCollabId, Ref } from '@opensrcs/core'
  import { DraftController, draftsStore, getClient, deleteFile, createMarkup } from '@opensrcs/presentation'
  import tags from '@opensrcs/tags'
  import { isEmptyMarkup } from '@opensrcs/text'
  import { Component, Issue, IssueDraft, IssueParentInfo, Milestone, Project } from '@opensrcs/tracker'
  import { Button, ExpandCollapse, Scroller } from '@opensrcs/ui'
