...
<script lang="ts">
  ...
  import presentation, { IconWithEmoji, Card, createQuery, getClient } from '@opensrcs/presentation'
  import task, { ProjectType, TaskType } from '@opensrcs/task'
  import { taskTypeStore, typeStore } from '@opensrcs/task-resources'
  import { IssueStatus, Project, TimeReportDayType, TrackerEvents } from '@opensrcs/tracker'
  import {
    Button,
    Component,
    EditBox,
  ...
  import { IconPicker } from '@opensrcs/view-resources'
