...
<script lang="ts">
  ...
  import presentation, { createQuery, IconWithEmoji, isAdminUser } from '@opensrcs/presentation'
  import { Project } from '@opensrcs/tracker'
  import { Icon, Label, getPlatformColorDef, getPlatformColorForTextDef, themeStore } from '@opensrcs/ui'
