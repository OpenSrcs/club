...
-->
<script lang="ts">
  import { DocumentQuery, WithLookup } from '@opensrcs/core'
  import type { IntlString } from '@opensrcs/club'
  import { isCreateAllowed } from '@opensrcs/presentation'
  import { Component } from '@opensrcs/tracker'
  import { Button, IconAdd, Breadcrumbs, SearchInput, showPopup, Header } from '@opensrcs/ui'
