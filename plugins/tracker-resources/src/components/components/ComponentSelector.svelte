...
<script lang="ts">
  ...
  import type { ButtonKind, ButtonSize, LabelAndProps, SelectPopupValueType } from '@opensrcs/ui'
  import { Button, ButtonShape, SelectPopup, eventToHTMLElement, showPopup, PopupResult } from '@opensrcs/ui'
