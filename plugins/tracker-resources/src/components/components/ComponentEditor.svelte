...
-->
<script lang="ts">
  import { AttachedData, DocumentQuery, Ref } from '@opensrcs/core'
  import { IntlString } from '@opensrcs/club'
  import { RuleApplyResult, getClient, getDocRules } from '@opensrcs/presentation'
  import { Component, Issue, IssueTemplate, Project, TrackerEvents } from '@opensrcs/tracker'
  import { ButtonKind, ButtonShape, ButtonSize, deviceOptionsStore as deviceInfo } from '@opensrcs/ui'
