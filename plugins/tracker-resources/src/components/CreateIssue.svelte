...
<script lang="ts">
  ...
  import { Employee } from '@opensrcs/contact'
  import core, {
    AccountRole,
    Class,
    Doc,
  ...
  import preference, { SpacePreference } from '@opensrcs/preference'
  import {
    Card,
    createMarkup,
    createQuery,
  ...
  import tags, { type TagElement, TagReference } from '@opensrcs/tags'
