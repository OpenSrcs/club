...
-->
<script lang="ts">
  import { Data, Ref } from '@opensrcs/core'
  import { IntlString } from '@opensrcs/club'
  import { Card, getClient, SpaceSelector } from '@opensrcs/presentation'
  import { Milestone, MilestoneStatus, Project } from '@opensrcs/tracker'
  import ui, { DatePresenter, EditBox } from '@opensrcs/ui'
