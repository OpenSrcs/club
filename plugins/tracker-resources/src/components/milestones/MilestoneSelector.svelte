...
-->
<script lang="ts">
  import { DocumentQuery, Ref, SortingOrder } from '@opensrcs/core'
  import { IntlString, getEmbeddedLabel, translateCB } from '@opensrcs/club'
  import { createQuery } from '@opensrcs/presentation'
  import { Milestone } from '@opensrcs/tracker'
  import type { ButtonKind, ButtonSize, LabelAndProps, PopupResult } from '@opensrcs/ui'
  import { Button, ButtonShape, Label, SelectPopup, eventToHTMLElement, showPopup, themeStore } from '@opensrcs/ui'
