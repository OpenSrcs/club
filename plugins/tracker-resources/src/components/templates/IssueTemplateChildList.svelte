...
<script lang="ts">
  ...
  import tracker, { Component, Issue, IssueTemplateChild, Milestone, Project } from '@opensrcs/tracker'
  import { IconCircles, eventToHTMLElement, showPopup } from '@opensrcs/ui'
  import { FixedColumn } from '@opensrcs/view-resources'
