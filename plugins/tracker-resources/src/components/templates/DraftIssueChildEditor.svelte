...
<script lang="ts">
  ...
  import core, { Doc, generateId, type PersonId, Ref } from '@opensrcs/core'
  import presentation, { DraftController, getClient, KeyedAttribute } from '@opensrcs/presentation'
  ...
  import { Button, Component, EditBox } from '@opensrcs/ui'
