...
<script lang="ts">
  ...
  import { Data, Doc, Ref, generateId } from '@opensrcs/core'
  import { Card, KeyedAttribute, SpaceSelector, createQuery, getClient } from '@opensrcs/presentation'
  import tags, { TagElement, TagReference } from '@opensrcs/tags'
  import { TaskType } from '@opensrcs/task'
  import { TaskKindSelector } from '@opensrcs/task-resources'
  import { StyledTextBox } from '@opensrcs/text-editor-resources'
  import { Component as ComponentType, IssuePriority, IssueTemplate, Milestone, Project } from '@opensrcs/tracker'
  import { Component, EditBox, Label } from '@opensrcs/ui'
