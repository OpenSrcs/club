...
-->
<script lang="ts">
  import { Data } from '@opensrcs/core'
  import { getClient } from '@opensrcs/presentation'
  import { IssueDraft, IssueTemplate, IssueTemplateChild, TrackerEvents } from '@opensrcs/tracker'
  import { Button, ButtonKind, ButtonSize, eventToHTMLElement, showPopup } from '@opensrcs/ui'
  import { EditBoxPopup, getObjectId } from '@opensrcs/view-resources'
