...
<script lang="ts">
  ...
  import tags, { type TagElement, type TagReference } from '@opensrcs/tags'
  import { IssueTemplate, IssueTemplateChild, Project } from '@opensrcs/tracker'
  import { Button, EditBox, IconMoreH, Label, getCurrentResolvedLocation, navigate } from '@opensrcs/ui'
