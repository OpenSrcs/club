...
-->
<script lang="ts">
  import { generateId, Ref, WithLookup } from '@opensrcs/core'
  import { AttributeBarEditor, createQuery, getClient, KeyedAttribute } from '@opensrcs/presentation'
  ...
  import type { IssueTemplate } from '@opensrcs/tracker'
  import { Component, Label } from '@opensrcs/ui'
  import { getFiltredKeys, isCollectionAttr } from '@opensrcs/view-resources'
