<script lang="ts">
  import core, { Space, WithLookup } from '@opensrcs/core'
  import { SpaceSelector, createQuery, getClient } from '@opensrcs/presentation'
  import { RelatedIssueTarget } from '@opensrcs/tracker'
  import { Button, Icon, IconArrowRight, IconDelete, Label } from '@opensrcs/ui'
