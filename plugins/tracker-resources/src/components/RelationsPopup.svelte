<script lang="ts">
  import { Class, Doc, Ref, RelatedDocument } from '@opensrcs/core'
  import { getResource, IntlString } from '@opensrcs/club'
  import { createQuery, getClient, ObjectSearchPopup, ObjectSearchResult } from '@opensrcs/presentation'
