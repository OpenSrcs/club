...
<script lang="ts">
  ...
  import presentation, { NavLink } from '@opensrcs/presentation'
  import { trackerId, type Issue, type IssueParentInfo } from '@opensrcs/tracker'
  import { getCurrentLocation, locationToUrl } from '@opensrcs/ui'
