...
-->
<script lang="ts">
  import { Doc, Ref, WithLookup, type Status } from '@opensrcs/core'
  import task from '@opensrcs/task'
  import { Project, type Issue } from '@opensrcs/tracker'
  import { Button, ButtonKind, ButtonSize, ProgressCircle } from '@opensrcs/ui'
