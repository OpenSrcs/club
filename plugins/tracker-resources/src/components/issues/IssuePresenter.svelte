...
<script lang="ts">
  ...
  import TaskTypeIcon from '@opensrcs/task-resources/src/components/taskTypes/TaskTypeIcon.svelte'
  import type { Issue } from '@opensrcs/tracker'
  import { AnySvelteComponent, Icon, tooltip } from '@opensrcs/ui'
  import { DocNavLink, ObjectMention } from '@opensrcs/view-resources'
