...
<script lang="ts">
  ...
  import { AttachmentDocList } from '@opensrcs/attachment-resources'
  import { ChatMessagePopup } from '@opensrcs/chunter-resources'
  import { Ref } from '@opensrcs/core'
  import { IconForward, createQuery, getClient } from '@opensrcs/presentation'
  import { CollaborativeTextEditor } from '@opensrcs/text-editor-resources'
  import { Issue } from '@opensrcs/tracker'
  import { Label, Scroller, resizeObserver } from '@opensrcs/ui'
