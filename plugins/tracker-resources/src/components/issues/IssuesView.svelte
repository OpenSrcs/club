<script lang="ts">
  import { DocumentQuery, Ref, Space, WithLookup } from '@opensrcs/core'
  import { Asset, IntlString, translateCB } from '@opensrcs/club'
  import { ComponentExtensions } from '@opensrcs/presentation'
  import { Issue, TrackerEvents } from '@opensrcs/tracker'
  import { IModeSelector, themeStore } from '@opensrcs/ui'
  import { ViewOptions, Viewlet } from '@opensrcs/view'
  import { FilterBar, SpaceHeader, ViewletContentView, ViewletSettingButton } from '@opensrcs/view-resources'
