...
<script lang="ts">
  ...
  import { Issue, IssueStatus, Project } from '@opensrcs/tracker'
  import { IModeSelector, resolvedLocationStore } from '@opensrcs/ui'
  import view, { Viewlet } from '@opensrcs/view'
  import { createEventDispatcher } from 'svelte'

  import { TypeSelector, selectedTaskTypeStore, selectedTypeStore, taskTypeStore } from '@opensrcs/task-resources'
