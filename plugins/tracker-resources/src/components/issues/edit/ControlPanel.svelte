...
-->
<script lang="ts">
  import { EmployeeBox, getPersonRefByPersonIdCb } from '@opensrcs/contact-resources'
  import core, { Class, ClassifierKind, Doc, Mixin, Ref } from '@opensrcs/core'
  ...
  import type { Issue } from '@opensrcs/tracker'
