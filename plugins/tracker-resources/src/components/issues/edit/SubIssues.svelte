...
-->
<script lang="ts">
  import { Issue, trackerId } from '@opensrcs/tracker'
  import { Button, IconScaleFull, Label, closeTooltip, getCurrentResolvedLocation, navigate } from '@opensrcs/ui'
  import { createFilter, restrictionStore, setFilters } from '@opensrcs/view-resources'
