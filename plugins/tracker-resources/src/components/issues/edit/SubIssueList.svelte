...
-->
<script lang="ts">
  import { Class, Doc, DocumentQuery, Ref } from '@opensrcs/core'
  import { IntlString } from '@opensrcs/club'
  import { ActionContext } from '@opensrcs/presentation'
  import { Issue } from '@opensrcs/tracker'
  import { AnyComponent, AnySvelteComponent, registerFocus } from '@opensrcs/ui'
  import { ViewOptions, Viewlet, ViewletPreference } from '@opensrcs/view'
  import { List, ListSelectionProvider, SelectDirection } from '@opensrcs/view-resources'
