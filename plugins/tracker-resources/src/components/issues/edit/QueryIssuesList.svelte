...
-->
<script lang="ts">
  import core, { Class, Doc, DocumentQuery, Ref } from '@opensrcs/core'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { Issue } from '@opensrcs/tracker'
  import { Button, Chevron, ExpandCollapse, IconAdd, closeTooltip, resizeObserver, showPopup } from '@opensrcs/ui'
  import view, { ViewOptions, Viewlet, ViewletPreference } from '@opensrcs/view'
  import { ViewletsSettingButton, restrictionStore } from '@opensrcs/view-resources'
