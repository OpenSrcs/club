...
-->
<script lang="ts">
  import core, { IdMap, Ref, SortingOrder, StatusCategory, WithLookup, toIdMap } from '@opensrcs/core'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import task, { getStates } from '@opensrcs/task'
  import { typeStore } from '@opensrcs/task-resources'
  import { Issue, Project } from '@opensrcs/tracker'
  import { Button, ButtonKind, ButtonSize, ProgressCircle, SelectPopup, showPanel } from '@opensrcs/ui'
