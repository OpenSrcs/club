...
-->
<script lang="ts">
  import { AttachmentStyleBoxCollabEditor } from '@opensrcs/attachment-resources'
  import { Class, Doc, Ref, WithLookup } from '@opensrcs/core'
  ...
  import { taskTypeStore, typeStore } from '@opensrcs/task-resources'
  import { Issue, TrackerEvents } from '@opensrcs/tracker'
  import {
    AnyComponent,
    Button,
    Component,
  ...
  import { DocNavLink, ParentsNavigator, showMenu, RelationsEditor } from '@opensrcs/view-resources'
