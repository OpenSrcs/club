...
-->
<script lang="ts">
  import { AttachmentsPresenter } from '@opensrcs/attachment-resources'
  import {
    CategoryType,
    Class,
    Doc,
  ...
  import { Item, Kanban as KanbanUI } from '@opensrcs/kanban'
  import notification from '@opensrcs/notification'
  import { ActionContext, createQuery, getClient } from '@opensrcs/presentation'
  import tags from '@opensrcs/tags'
  import { DocWithRank, getStates } from '@opensrcs/task'
  import { getTaskKanbanResultQuery, typeStore, updateTaskKanbanCategories } from '@opensrcs/task-resources'
  import { Issue, IssuesGrouping, IssuesOrdering, Project } from '@opensrcs/tracker'
  import {
    Button,
    ColorDefinition,
    Component,
  ...
  import view, { AttributeModel, BuildModelKey, Viewlet, ViewOptionModel, ViewOptions } from '@opensrcs/view'
  import {
    enabledConfig,
    focusStore,
  ...
  import { ChatMessagesPresenter } from '@opensrcs/chunter-resources'
