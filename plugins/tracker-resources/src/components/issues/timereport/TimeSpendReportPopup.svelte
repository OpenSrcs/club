...
-->
<script lang="ts">
  import contact, { Employee, getCurrentEmployee } from '@opensrcs/contact'
  import { AttachedData, Class, DocumentUpdate, Ref, Space } from '@opensrcs/core'
  import type { IntlString } from '@opensrcs/club'
  import presentation, { Card, getClient } from '@opensrcs/presentation'
  import { UserBox } from '@opensrcs/contact-resources'
  import { Issue, TimeReportDayType, TimeSpendReport, TrackerEvents } from '@opensrcs/tracker'
  import { Button, DatePresenter, EditBox, Label } from '@opensrcs/ui'
