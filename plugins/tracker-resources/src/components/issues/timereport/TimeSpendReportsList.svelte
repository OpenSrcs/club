...
<script lang="ts">
  ...
  import { Ref, Space, WithLookup } from '@opensrcs/core'
  import { Project, TimeReportDayType, TimeSpendReport } from '@opensrcs/tracker'
  import {
    DatePresenter,
    ListView,
  ...
  import { FixedColumn, ListSelectionProvider, showMenu } from '@opensrcs/view-resources'
