...
<script lang="ts">
  ...
  import { FindOptions } from '@opensrcs/core'
  import presentation, { Card } from '@opensrcs/presentation'
  import { Issue, Project, TimeSpendReport } from '@opensrcs/tracker'
  import { Button, eventToHTMLElement, IconAdd, Scroller, showPopup, tableSP } from '@opensrcs/ui'
  import { TableBrowser } from '@opensrcs/view-resources'
