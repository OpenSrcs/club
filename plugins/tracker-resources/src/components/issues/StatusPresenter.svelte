...
<script lang="ts">
  ...
  import { ColorDefinition } from '@opensrcs/ui'
  import { IssueStatus, Project } from '@opensrcs/tracker'
  import IssueStatusIcon from './IssueStatusIcon.svelte'
  import { ProjectType, TaskType } from '@opensrcs/task'
...
{#if value}
  {#if kind === 'table-attrs'}
    ...
    <span
      class="clubTableAttr-content__row-label font-medium-12 uppercase grow overflow-label"
