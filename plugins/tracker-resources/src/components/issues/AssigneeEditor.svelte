...
<script lang="ts">
  ...
  import { AssigneeBox, AssigneePopup, employeeRefByAccountUuidStore } from '@opensrcs/contact-resources'
  import { AssigneeCategory } from '@opensrcs/contact-resources/src/assignee'
  import { Doc, DocumentQuery, notEmpty, Ref, Space } from '@opensrcs/core'
  import { RuleApplyResult, getClient, getDocRules } from '@opensrcs/presentation'
  import { Component, Issue, TrackerEvents } from '@opensrcs/tracker'
  import { ButtonKind, ButtonSize, IconSize, TooltipAlignment } from '@opensrcs/ui'
