...
import { type Resources, type Status, translate } from '@opensrcs/club'
import { getClient, MessageBox, type ObjectSearchResult } from '@opensrcs/presentation'
import { type Component, type Issue, type Milestone, type Project } from '@opensrcs/tracker'
import {
  closePanel,
  getCurrentLocation,
...
import { getAllStates } from '@opensrcs/task-resources'
import view, { type Filter } from '@opensrcs/view'
...
import { getTargetObjectFromUrl } from '@opensrcs/text-editor-resources'
