...
<script lang="ts">
  ...
  import { ActionContext, createMarkup, createQuery, getClient } from '@opensrcs/presentation'
  import core, { Data, Ref, getCurrentAccount, generateId, makeCollabId, WithLookup } from '@opensrcs/core'
  import testManagement, {
    ...
    TestPlan,
    TestPlanItem
  } from '@opensrcs/test-management'
  import { Panel } from '@opensrcs/panel'
  import { EditBox, ModernButton, Label, navigate } from '@opensrcs/ui'
