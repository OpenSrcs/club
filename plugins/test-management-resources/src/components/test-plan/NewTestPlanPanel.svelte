...
<script lang="ts">
  ...
  import { ActionContext, getClient } from '@opensrcs/presentation'
  import core, { Data, Ref, generateId, getCurrentAccount } from '@opensrcs/core'
  ...
  import { ModernButton, EditBox, Label } from '@opensrcs/ui'
