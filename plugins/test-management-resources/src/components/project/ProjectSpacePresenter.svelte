...
-->
<script lang="ts">
  import { Ref, Space } from '@opensrcs/core'
  import { getResource } from '@opensrcs/club'
  import { TestProject } from '@opensrcs/test-management'
  import { IconWithEmoji } from '@opensrcs/presentation'
  import { getPlatformColorDef, getPlatformColorForTextDef, themeStore, type Action } from '@opensrcs/ui'
  import view from '@opensrcs/view'
  import { NavLink, TreeNode } from '@opensrcs/view-resources'
  import { SpacesNavModel, SpecialNavModel } from '@opensrcs/workbench'
  import { SpecialElement } from '@opensrcs/workbench-resources'
