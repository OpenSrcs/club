...
<script lang="ts">
  ...
  import { TestCase, TestProject } from '@opensrcs/test-management'
  import { Button, Dialog, Label } from '@opensrcs/ui'
  import { ComponentNavigator } from '@opensrcs/workbench-resources'
  import view from '@opensrcs/view'
  import { selectionStore } from '@opensrcs/view-resources'
