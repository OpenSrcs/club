...
<script lang="ts">
  ...
  import { TestCase, TestProject, TestSuite, TestCaseStatus } from '@opensrcs/test-management'
  import core, { fillDefaults, generateId, makeCollabId, Ref, TxOperations, Data } from '@opensrcs/core'
  import { ObjectBox } from '@opensrcs/view-resources'
  import { Card, SpaceSelector, createMarkup, getClient } from '@opensrcs/presentation'
  import { EmptyMarkup, isEmptyMarkup } from '@opensrcs/text'
  import { Button, createFocusManager, EditBox, FocusHandler, IconAttachment, getLocation } from '@opensrcs/ui'
