...
<script lang="ts">
  ...
  import { Doc, Mixin, WithLookup } from '@opensrcs/core'
  import testManagement, { TestResult } from '@opensrcs/test-management'
  import { DocAttributeBar, getDocMixins } from '@opensrcs/view-resources'
