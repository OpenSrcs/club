...
<script lang="ts">
  ...
  import { UserBoxList } from '@opensrcs/contact-resources'
  import { Class, DateRangeMode, Doc, Ref, getCurrentAccount } from '@opensrcs/core'
  import { Card, getClient } from '@opensrcs/presentation'
  import ui, { DateRangePresenter, EditBox } from '@opensrcs/ui'
