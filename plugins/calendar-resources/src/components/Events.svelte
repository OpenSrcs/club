...
<script lang="ts">
  ...
  import { Class, DocumentQuery, Ref, Space, WithLookup } from '@opensrcs/core'
  import { IntlString, Asset } from '@opensrcs/club'
  import {
    AnyComponent,
    Button,
    Component,
  ...
  import { ViewletSelector, getViewOptions, viewOptionStore } from '@opensrcs/view-resources'
  import calendar from '../plugin'
  // import { deviceOptionsStore as deviceInfo } from '@opensrcs/ui'
