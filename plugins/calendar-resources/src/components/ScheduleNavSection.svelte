...
-->
<script lang="ts">
  import { Schedule } from '@opensrcs/calendar'
  ...
  import { Action, ButtonIcon, IconAdd, IconDelete, IconLink, NavItem, showPopup } from '@opensrcs/ui'
  import view from '@opensrcs/view'
  import { TreeElement } from '@opensrcs/view-resources'
