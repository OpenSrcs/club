...
<script lang="ts">
  ...
  import { CreateGuest, getPersonRefByPersonId } from '@opensrcs/contact-resources'
  import { Ref, type PersonId } from '@opensrcs/core'
  import { IntlString, translateCB } from '@opensrcs/club'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import setting, { Integration } from '@opensrcs/setting'
  import { themeStore } from '@opensrcs/theme'
  import { Button, IconAdd, closePopup, registerFocus, resizeObserver, showPopup } from '@opensrcs/ui'
