...
-->
<script lang="ts">
  import { Event, ReccuringEvent, ReccuringInstance, RecurringRule } from '@opensrcs/calendar'
  import { Person } from '@opensrcs/contact'
  import { DocumentUpdate, Ref } from '@opensrcs/core'
  import presentation, { ComponentExtensions, getClient } from '@opensrcs/presentation'
