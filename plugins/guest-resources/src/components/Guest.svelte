...
<script lang="ts">
  ...
  import core, { Class, Doc, Ref, Space } from '@opensrcs/core'
  import { getMetadata, getResource } from '@opensrcs/club'
  import presentation, { ActionContext, decodeTokenPayload, getClient } from '@opensrcs/presentation'
  import {
    AnyComponent,
    Component,
    Label,
  ...
  import { ListSelectionProvider, parseLinkId, restrictionStore, updateFocus } from '@opensrcs/view-resources'
  import workbench, { Application, NavigatorModel, SpecialNavModel, ViewConfiguration } from '@opensrcs/workbench'
  import { SpaceView, buildNavModel } from '@opensrcs/workbench-resources'
