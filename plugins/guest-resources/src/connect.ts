...
import { setCurrentEmployee, type Employee } from '@opensrcs/contact'
import core, {
  ClientConnectEvent,
  concatLink,
  setCurrentAccount,
...
import login, { type WorkspaceLoginInfo } from '@opensrcs/login'
...
import { desktopPlatform, getCurrentLocation } from '@opensrcs/ui'
import { logOut } from '@opensrcs/workbench'
