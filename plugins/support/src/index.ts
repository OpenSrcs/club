...
import { Class, Ref } from '@opensrcs/core'
import type { Asset, IntlString, Plugin, Resource } from '@opensrcs/club'
import { plugin, Metadata } from '@opensrcs/club'
...
export const supportLink = 'https://link.opensrcs.org/slack'
export const reportBugLink = 'https://github.com/opensrcs/club/issues/new'
export const docsLink = 'http://docs.opensrcs.org/'
export const privacyPolicyLink = 'https://v1.opensrcs.org/legal/privacy/'
