...
import { type Ref, type Doc, type Class, generateId, concatLink } from '@opensrcs/core'
...
import { type DocNotifyContext, notificationId } from '@opensrcs/notification'
import workbench, { type Widget, workbenchId, type LocationData } from '@opensrcs/workbench'
import { classIcon, getObjectLinkId, parseLinkId } from '@opensrcs/view-resources'
import presentation, { getClient } from '@opensrcs/presentation'
import view, { encodeObjectURI, decodeObjectURI } from '@opensrcs/view'
import { createWidgetTab, isElementFromSidebar, sidebarStore } from '@opensrcs/workbench-resources'
import { type Asset, getMetadata, type IntlString, translate } from '@opensrcs/club'
