...
} from '@opensrcs/activity'
import aiBot from '@opensrcs/ai-bot'
import { summarizeMessages as aiSummarizeMessages, translate as aiTranslate } from '@opensrcs/ai-bot-resources'
import { type Channel, type ChatMessage, type DirectMessage, type ThreadMessage } from '@opensrcs/chunter'
import contact, { type Employee, getCurrentEmployee, getName, type Person } from '@opensrcs/contact'
import { employeeByAccountStore, employeeByIdStore, PersonIcon } from '@opensrcs/contact-resources'
import core, {
  AccountRole,
  type AccountUuid,
  type Class,
...
import notification, { type DocNotifyContext, type InboxNotification } from '@opensrcs/notification'
import {
  InboxNotificationsClientImpl,
  isActivityNotification,
  isMentionNotification,
  isReactionNotification
} from '@opensrcs/notification-resources'
import { type Asset, getMetadata, translate } from '@opensrcs/club'
import { getClient } from '@opensrcs/presentation'
import { type AnySvelteComponent, languageStore } from '@opensrcs/ui'
import { classIcon, getDocLinkTitle, getDocTitle } from '@opensrcs/view-resources'
...
import love, { type MeetingMinutes } from '@opensrcs/love'
