<script lang="ts">
  import contact, { Person, Employee } from '@opensrcs/contact'
  import { EmployeePresenter } from '@opensrcs/contact-resources'
  import { getClient } from '@opensrcs/presentation'
  import { getCurrentLocation, location, Location } from '@opensrcs/ui'
  import { decodeObjectURI } from '@opensrcs/view'
