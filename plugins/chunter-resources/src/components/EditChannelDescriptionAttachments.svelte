...
<script lang="ts">
  ...
  import { AttachmentPresenter, FileDownload } from '@opensrcs/attachment-resources'
  import { ChunterSpace } from '@opensrcs/chunter'
  import { Doc, SortingOrder, getCurrentAccount, type WithLookup } from '@opensrcs/core'
  import { createQuery, getClient, getFileUrl } from '@opensrcs/presentation'
  import { Icon, IconMoreV, Label, Menu, getCurrentResolvedLocation, navigate, showPopup } from '@opensrcs/ui'
