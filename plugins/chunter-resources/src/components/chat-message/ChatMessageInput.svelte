...
-->
<script lang="ts">
  import activity, { ActivityMessage } from '@opensrcs/activity'
  import { Analytics } from '@opensrcs/analytics'
  import { AttachmentRefInput } from '@opensrcs/attachment-resources'
  import chunter, { ChatMessage, ChunterEvents, ThreadMessage } from '@opensrcs/chunter'
  import { Class, Doc, generateId, getCurrentAccount, Ref, type CommitResult } from '@opensrcs/core'
  import { createQuery, DraftController, draftsStore, getClient } from '@opensrcs/presentation'
  import { EmptyMarkup, isEmptyMarkup } from '@opensrcs/text'
  import { createEventDispatcher } from 'svelte'
  import { getObjectId } from '@opensrcs/view-resources'
  import { ThrottledCaller } from '@opensrcs/ui'
  import { getSpace, editingMessageStore } from '@opensrcs/activity-resources'
  ...
  import { setTyping, clearTyping } from '@opensrcs/presence-resources'
