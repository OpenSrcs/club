...
<script lang="ts">
  import { ActivityMessagePreviewType } from '@opensrcs/activity'
  import { BaseMessagePreview } from '@opensrcs/activity-resources'
  import attachment, { Attachment } from '@opensrcs/attachment'
  import { AttachmentsTooltip } from '@opensrcs/attachment-resources'
  import { ChatMessage } from '@opensrcs/chunter'
  import { createQuery } from '@opensrcs/presentation'
  import { Action, Icon, Label, tooltip } from '@opensrcs/ui'
