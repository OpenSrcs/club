...
<script lang="ts">
  ...
  import { Doc, Ref, SortingOrder } from '@opensrcs/core'
  ...
  import { closeTooltip, Label, Lazy, Spinner, resizeObserver, MiniToggle } from '@opensrcs/ui'
  import { ObjectPresenter, DocNavLink } from '@opensrcs/view-resources'
  import { canGroupMessages, getActivityNewestFirst, setActivityNewestFirst } from '@opensrcs/activity-resources'
