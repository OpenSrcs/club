...
<script lang="ts">
  ...
  import { Widget } from '@opensrcs/workbench'
  import { ActivityMessage } from '@opensrcs/activity'
  import { ChatWidgetTab } from '@opensrcs/chunter'
  import { Presence } from '@opensrcs/presence-resources'
  import { updateTabData } from '@opensrcs/workbench-resources'
