...
<script lang="ts">
  ...
  import { getCurrentAccount, Markup } from '@opensrcs/core'
  import { MessageViewer } from '@opensrcs/presentation'
  import { Action, IconEdit, IconDelete, ShowMore } from '@opensrcs/ui'
  import view from '@opensrcs/view'
  import activity, { ActivityMessage, ActivityMessageViewType } from '@opensrcs/activity'
  import { ActivityMessageTemplate } from '@opensrcs/activity-resources'
