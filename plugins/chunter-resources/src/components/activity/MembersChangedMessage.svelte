...
<script lang="ts">
  import { DocAttributeUpdates, DocUpdateMessage } from '@opensrcs/activity'
  import { Employee, Person } from '@opensrcs/contact'
  import { AccountUuid, notEmpty, PersonId } from '@opensrcs/core'
  import { PersonPresenter, employeeByAccountStore, employeeByPersonIdStore } from '@opensrcs/contact-resources'
