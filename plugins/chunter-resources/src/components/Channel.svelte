...
-->
<script lang="ts">
  import { Doc, getCurrentAccount, Ref } from '@opensrcs/core'
  import notification, { DocNotifyContext } from '@opensrcs/notification'
  import activity, { ActivityMessage, WithReferences } from '@opensrcs/activity'
  import { getClient, isSpace } from '@opensrcs/presentation'
  import { getMessageFromLoc, messageInFocus } from '@opensrcs/activity-resources'
  import { location as locationStore } from '@opensrcs/ui'
