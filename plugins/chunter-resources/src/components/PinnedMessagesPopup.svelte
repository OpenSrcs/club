...
<script lang="ts">
  ...
  import { ActivityMessagePresenter, sortActivityMessages } from '@opensrcs/activity-resources'
  import { ActionIcon, IconClose, Loading } from '@opensrcs/ui'
  import { createEventDispatcher } from 'svelte'
  import { ThreadMessage } from '@opensrcs/chunter'
  import { Class, Doc, Ref, SortingOrder, Space } from '@opensrcs/core'
