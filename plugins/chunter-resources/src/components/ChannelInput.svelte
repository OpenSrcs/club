...
-->
<script lang="ts">
  import { ActivityExtension as ActivityExtensionComponent } from '@opensrcs/activity-resources'
  import { Class, Doc, Ref } from '@opensrcs/core'
  import activity, { ActivityExtension } from '@opensrcs/activity'
  import { getClient } from '@opensrcs/presentation'
  import { AnySvelteComponent, Icon, Label } from '@opensrcs/ui'
  import { Asset, getResource, IntlString } from '@opensrcs/club'
