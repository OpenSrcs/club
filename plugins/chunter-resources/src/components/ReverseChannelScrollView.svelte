...
<script lang="ts">
  ...
  import core, { Doc, generateId, getCurrentAccount, Ref, Space, Timestamp, Tx, TxCUD } from '@opensrcs/core'
  ...
  import { addTxListener, getClient, removeTxListener } from '@opensrcs/presentation'
  import { ModernButton, Scroller } from '@opensrcs/ui'
  import { afterUpdate, onDestroy, onMount, tick } from 'svelte'
  import { ChatMessage } from '@opensrcs/chunter'
