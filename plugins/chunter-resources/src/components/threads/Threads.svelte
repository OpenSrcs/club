...
<script lang="ts">
  ...
  import { ActivityMessagePresenter } from '@opensrcs/activity-resources'
  import attachment from '@opensrcs/attachment'
  import core, { Collaborator, getCurrentAccount, Ref, SortingOrder } from '@opensrcs/core'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { Lazy, Loading, Scroller } from '@opensrcs/ui'
