...
-->
<script lang="ts">
  import { WorkbenchTab } from '@opensrcs/workbench'
  import {
  ...
  import { InboxNotification } from '@opensrcs/notification'
  import { onDestroy } from 'svelte'
  import { concatLink, Doc, Ref } from '@opensrcs/core'
  ...
  import { parseLocation } from '@opensrcs/ui'
