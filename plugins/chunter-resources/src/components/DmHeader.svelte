...
-->
<script lang="ts">
  import { DirectMessage } from '@opensrcs/chunter'
  import contact, { getCurrentEmployee } from '@opensrcs/contact'
  import { CombineAvatars, employeeRefByAccountUuidStore } from '@opensrcs/contact-resources'
  import { type Ref, notEmpty } from '@opensrcs/core'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { SearchEdit } from '@opensrcs/ui'
