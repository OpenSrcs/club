...
{#if persons.length > 1 && size !== 'medium'}
  {#if compact}
    <div class="clubAvatar-container clubAvatarSize-{size} group-ava">
      {persons.length}
    </div>
  {:else}
    <CombineAvatars
