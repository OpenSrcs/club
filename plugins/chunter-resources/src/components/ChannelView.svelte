...
-->
<script lang="ts">
  import core, { Doc, getCurrentAccount, Ref, Space } from '@opensrcs/core'
  import {
    defineSeparators,
    getCurrentLocation,
    Label,
  ...
  import { Channel, ObjectChatPanel } from '@opensrcs/chunter'
  import view from '@opensrcs/view'
  import { messageInFocus } from '@opensrcs/activity-resources'
