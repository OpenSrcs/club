...
-->
<script lang="ts">
  import { Label, tooltip } from '@opensrcs/ui'
  ...
  import { getDocLinkTitle, getDocTitle, ObjectIcon } from '@opensrcs/view-resources'
  import { ChatMessage, ThreadMessage } from '@opensrcs/chunter'
