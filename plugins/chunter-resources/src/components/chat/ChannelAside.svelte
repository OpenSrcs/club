...
-->
<script lang="ts">
  import core, { getCurrentAccount, Ref, notEmpty, AccountUuid } from '@opensrcs/core'
  import presentation from '@opensrcs/presentation'
  import { Label, showPopup, tooltip } from '@opensrcs/ui'

  import { Channel, ChunterSpace, ObjectChatPanel } from '@opensrcs/chunter'
