...
<script lang="ts">
  ...
  import { statusByUserStore } from '@opensrcs/contact-resources'
  import { Doc, reduceCalls, Ref } from '@opensrcs/core'
  import { DocNotifyContext } from '@opensrcs/notification'
  import { getResource, IntlString, translate } from '@opensrcs/club'
  import { getClient } from '@opensrcs/presentation'
  import ui, { Action, AnySvelteComponent, IconSize, ModernButton, NavGroup } from '@opensrcs/ui'
