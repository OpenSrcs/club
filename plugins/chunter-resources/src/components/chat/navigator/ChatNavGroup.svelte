...
<script lang="ts">
  ...
  import core, { Class, Doc, groupByArray, reduceCalls, Ref, Space } from '@opensrcs/core'
  ...
  import { createQuery, getClient, LiveQuery } from '@opensrcs/presentation'
  import { Action } from '@opensrcs/ui'
