...
-->
<script lang="ts">
  import { AccountRole, Doc, getCurrentAccount, hasAccountRole } from '@opensrcs/core'
  import { Scroller, SearchEdit, Label, ButtonIcon, IconAdd, showPopup, Menu } from '@opensrcs/ui'
  import { DocNotifyContext } from '@opensrcs/notification'
  import { SpecialNavModel } from '@opensrcs/workbench'
  import { NavLink } from '@opensrcs/view-resources'
  import { TreeSeparator, NavFooter } from '@opensrcs/workbench-resources'
...
<div class="clubNavPanel-header" class:withButton={hasAccountRole(getCurrentAccount(), AccountRole.User)}>
