...
<script lang="ts">
  ...
  import { SavedAttachments } from '@opensrcs/attachment'
  import { SavedMessage } from '@opensrcs/activity'
  import { savedMessagesStore } from '@opensrcs/activity-resources'
  import { savedAttachmentsStore } from '@opensrcs/attachment-resources'
