...
-->
<script lang="ts">
  import { Doc, Ref, Class } from '@opensrcs/core'
  ...
  import { NavigatorModel, SpecialNavModel } from '@opensrcs/workbench'
  ...
  import { parseLinkId, getObjectLinkId } from '@opensrcs/view-resources'
  import { ActivityMessage } from '@opensrcs/activity'
  import { loadSavedAttachments } from '@opensrcs/attachment-resources'
