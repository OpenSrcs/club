...
<script lang="ts">
  ...
  import { AccountUuid, Ref, notEmpty } from '@opensrcs/core'
  import { employeeByIdStore, SelectUsersPopup } from '@opensrcs/contact-resources'
  import presentation, { getClient } from '@opensrcs/presentation'
  import { Modal, showPopup } from '@opensrcs/ui'
