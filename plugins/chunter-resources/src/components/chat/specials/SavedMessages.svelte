...
-->
<script lang="ts">
  import { Attachment, SavedAttachments } from '@opensrcs/attachment'
  import { AttachmentPreview, savedAttachmentsStore } from '@opensrcs/attachment-resources'
  import { getName as getContactName } from '@opensrcs/contact'
  import { getPersonByPersonId } from '@opensrcs/contact-resources'
  import { getDisplayTime, Ref, WithLookup } from '@opensrcs/core'
  import { getClient } from '@opensrcs/presentation'
  import { Label, Scroller, Lazy } from '@opensrcs/ui'
  import activity, { ActivityMessage, SavedMessage } from '@opensrcs/activity'
  import { ActivityMessagePresenter, savedMessagesStore } from '@opensrcs/activity-resources'
