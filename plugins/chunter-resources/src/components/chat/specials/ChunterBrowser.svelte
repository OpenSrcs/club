...
<script lang="ts">
  ...
  import { FileBrowser } from '@opensrcs/attachment-resources'
  import { Scroller, Switcher } from '@opensrcs/ui'
  import type { AnySvelteComponent } from '@opensrcs/ui'
  import contact from '@opensrcs/contact'
  import contactPlg from '@opensrcs/contact-resources/src/plugin'
  import { EmployeeBrowser } from '@opensrcs/contact-resources'
  import MessagesBrowser from './MessagesBrowser.svelte'
  import { FilterBar, FilterButton } from '@opensrcs/view-resources'
