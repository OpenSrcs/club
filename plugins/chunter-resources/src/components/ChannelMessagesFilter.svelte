...
-->
<script lang="ts">
  import { Button, eventToHTMLElement, IconFilter, showPopup } from '@opensrcs/ui'
  import { Ref } from '@opensrcs/core'
  import activity, { ActivityMessagesFilter } from '@opensrcs/activity'
  import view from '@opensrcs/view-resources/src/plugin'
  import { getClient } from '@opensrcs/presentation'
  import { ActivityMessagesFilterPopup } from '@opensrcs/activity-resources'
