...
-->
<script lang="ts">
  import { AccountRole, getCurrentAccount, hasAccountRole, Timestamp } from '@opensrcs/core'
  import { copyTextToClipboard, createQuery } from '@opensrcs/presentation'
  import setting, { RoleCapability } from '@opensrcs/setting'
  import { getDefaultInviteRole, resolveInviteSettings } from '@opensrcs/setting-resources'
  import { getResource } from '@opensrcs/club'
  import { AnySvelteComponent, Button, EditBox, Grid, Label, Loading, MiniToggle, ticker } from '@opensrcs/ui'
