<script lang="ts">
  ...
  import { getCurrentLocation, Label, Loading, TimeLeft } from '@opensrcs/ui'
  import { logIn } from '@opensrcs/workbench'
  import { trackOAuthCompletion } from '@opensrcs/analytics-providers'
  import { type LoginInfoRequest, type LoginInfoByToken } from '@opensrcs/account-client'
  import platform, { OK, PlatformError, Status, unknownError } from '@opensrcs/club'
