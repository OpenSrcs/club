...
-->
<script lang="ts">
  import { type IntlString, Severity, Status } from '@opensrcs/club'
  import { signupStore } from '@opensrcs/analytics-providers'
  ...
  import { LoginInfo } from '@opensrcs/account-client'
