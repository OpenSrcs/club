...
-->
<script lang="ts">
  import { type RegionInfo } from '@opensrcs/account-client'
  import { OK, Severity, Status, getEmbeddedLabel } from '@opensrcs/club'
  import { LoginInfo } from '@opensrcs/login'
  import { ButtonMenu, Label, MiniToggle, getCurrentLocation, navigate } from '@opensrcs/ui'
