...
<script lang="ts">
  ...
  import { setMetadata, translate } from '@opensrcs/club'
  import { Loading, Label, getCurrentLocation, navigate } from '@opensrcs/ui'
  import { type LoginInfo } from '@opensrcs/account-client'
