...
import type { Asset, Metadata, Plugin, Resource } from '@opensrcs/club'
import { IntlString, plugin } from '@opensrcs/club'
import { TemplateField, TemplateFieldCategory } from '@opensrcs/templates'
import type { AnyComponent, ColorDefinition, ResolvedLocation, Location, ComponentExtensionId } from '@opensrcs/ui'
import { Action, FilterMode, Viewlet } from '@opensrcs/view'
import type { Readable } from 'svelte/store'
import { Card, MasterTag, Role } from '@opensrcs/card'
import { Preference } from '@opensrcs/preference'
...
export const contactPlugin = plugin(contactId, {
  ...
  socialIdentityProvider: {
    club: '' as Ref<SocialIdentityProvider>,
