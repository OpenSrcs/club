import core, { PersonId, Ref, SocialIdType, TxCreateDoc, TxUpdateDoc } from '@opensrcs/core'
...
describe('ContactCache', () => {
  ...
  beforeEach(() => {
    ...
    socialId = {
      ...
      value: 'tester@club.me',
      key: 'email:tester@club.me',
        ...
        $lookup: {
          socialIds: [
            socialId,
            {
              ...
              attachedToClass: contact.class.Person,
              type: SocialIdType.EMAIL,
              value: 'tester2@club.me',
              key: 'email:tester2@club.me',
              collection: 'socialIds'
            }
          ]
        }
