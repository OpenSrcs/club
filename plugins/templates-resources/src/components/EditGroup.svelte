...
-->
<script lang="ts">
  import { SpaceMembers } from '@opensrcs/contact-resources'
  ...
  import { TemplateCategory } from '@opensrcs/templates'
  import { EditBox, Grid, Label } from '@opensrcs/ui'
  import { BooleanPresenter } from '@opensrcs/view-resources'
