<script lang="ts">
  import core, { Data, Ref } from '@opensrcs/core'
  import { getEmbeddedLabel, getResource } from '@opensrcs/club'
  import { createQuery, getClient, MessageViewer, SpaceSelector } from '@opensrcs/presentation'
  import { MessageTemplate, TemplateCategory } from '@opensrcs/templates'
  ...
  import { getActions as getContributedActions, TreeItem, TreeNode } from '@opensrcs/view-resources'
...
<div class="clubComponent">
  ...
  <div class="clubComponent-content__container columns">
    <div class="clubComponent-content__column">
