...
<script lang="ts">
  import { ComponentExtensions, getClient, LiteMessageViewer } from '@opensrcs/presentation'
  import { Person } from '@opensrcs/contact'
  import { Avatar, getPersonByPersonIdCb, SystemAvatar } from '@opensrcs/contact-resources'
  import core, { PersonId, Doc, Timestamp } from '@opensrcs/core'
  import { Icon, Label, resizeObserver, TimeSince, tooltip } from '@opensrcs/ui'
  import { Asset, getEmbeddedLabel, IntlString } from '@opensrcs/club'
  import activity, { ActivityMessage, ActivityMessagePreviewType } from '@opensrcs/activity'
  import { classIcon, DocNavLink } from '@opensrcs/view-resources'
