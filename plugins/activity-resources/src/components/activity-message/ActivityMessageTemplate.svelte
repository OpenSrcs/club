...
<script lang="ts">
  ...
  import { Avatar, SystemAvatar } from '@opensrcs/contact-resources'
  import core, { Ref, type SocialId } from '@opensrcs/core'
  import notification from '@opensrcs/notification'
  import { Asset } from '@opensrcs/club'
  import { ComponentExtensions, getClient } from '@opensrcs/presentation'
  import { Action, Icon, Label } from '@opensrcs/ui'
  import { Action as ViewAction } from '@opensrcs/view'
  import { getActions, restrictionStore, showMenu } from '@opensrcs/view-resources'
