...
-->
<script lang="ts">
  import activity, { ActivityReference } from '@opensrcs/activity'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { Action, Label, ShowMore } from '@opensrcs/ui'
  ...
  import view, { ObjectPanel } from '@opensrcs/view'
  import { DocNavLink, getDocLinkTitle } from '@opensrcs/view-resources'
