...
-->
<script lang="ts">
  import { ActivityInfoMessage } from '@opensrcs/activity'
  import { Avatar, SystemAvatar, getPersonByPersonIdCb } from '@opensrcs/contact-resources'
  import { translateCB } from '@opensrcs/club'
  import { HTMLViewer } from '@opensrcs/presentation'
  import { Action, themeStore } from '@opensrcs/ui'
