...
<script lang="ts">
  ...
  import { AttachedDoc, Class, Collection, Doc, Ref, Space } from '@opensrcs/core'
  import { IntlString } from '@opensrcs/club'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { Action, Component, ShowMore } from '@opensrcs/ui'
  import { AttributeModel } from '@opensrcs/view'
  import { buildRemovedDoc, checkIsObjectRemoved } from '@opensrcs/view-resources'
