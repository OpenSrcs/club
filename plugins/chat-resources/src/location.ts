...
import type { Class, Doc, Ref } from '@opensrcs/core'
import { navigate, getCurrentResolvedLocation, type Location, type ResolvedLocation } from '@opensrcs/ui'
...
import { encodeObjectURI, decodeObjectURI } from '@opensrcs/view'
