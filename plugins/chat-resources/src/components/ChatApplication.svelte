...
<script lang="ts">
  ...
  import { Favorites } from '@opensrcs/card-resources'
  import workbench from '@opensrcs/workbench'
  import cardPlugin from '@opensrcs/card-resources/src/plugin'
...
<div class="clubPanels-container chat">
  {#if $deviceInfo.navigator.visible}
    ...
    />
  {/if}
  <div bind:this={replacedPanelElement} class="clubComponent chat__panel">
