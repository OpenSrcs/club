...
import type { Class, Doc, Mixin, Permission, Ref, SpaceType, SpaceTypeDescriptor } from '@opensrcs/core'
import { NotificationGroup, NotificationType } from '@opensrcs/notification'
import type { Asset, Plugin, Resource } from '@opensrcs/club'
import { IntlString, plugin } from '@opensrcs/club'
import type { AnyComponent, Location, ResolvedLocation } from '@opensrcs/ui/src/types'
