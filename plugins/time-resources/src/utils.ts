import { getCurrentAccount, type Client, type Ref } from '@opensrcs/core'
import { getClient } from '@opensrcs/presentation'
import type { ToDo, WorkSlot } from '@opensrcs/time'
import time from '@opensrcs/time'
import type { DefSeparators } from '@opensrcs/ui'

import calendarPlugin, { AccessLevel, getPrimaryCalendar, type Calendar } from '@opensrcs/calendar'
