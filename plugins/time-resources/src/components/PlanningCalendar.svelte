<script lang="ts">
  import calendar, { AccessLevel, Calendar, Event, generateEventId, getAllEvents } from '@opensrcs/calendar'
  import { DayCalendar, calendarByIdStore, hidePrivateEvents } from '@opensrcs/calendar-resources'
  import { getCurrentEmployee } from '@opensrcs/contact'
  import { Ref, SortingOrder, Timestamp, getCurrentAccount } from '@opensrcs/core'
  import { IntlString, getEmbeddedLabel } from '@opensrcs/club'
  ...
  import { ToDo, WorkSlot } from '@opensrcs/time'
...
>
  ...
  <div class="clubComponent-content__container">
    <DayCalendar
