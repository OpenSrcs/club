...
-->
<script lang="ts">
  import type { ItemPresenter, ToDo } from '@opensrcs/time'
  import type { Class, Doc } from '@opensrcs/core'
  import type { ObjectPanel } from '@opensrcs/view'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { Component, showPanel } from '@opensrcs/ui'
  import view from '@opensrcs/view'
  import time from '../plugin'
  import { DocReferencePresenter, getObjectLinkId } from '@opensrcs/view-resources'
