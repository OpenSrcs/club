...
<script lang="ts">
  ...
  import { AccessLevel, Calendar, generateEventId } from '@opensrcs/calendar'
  import { EventReminders, VisibilityEditor } from '@opensrcs/calendar-resources'
  import calendar from '@opensrcs/calendar-resources/src/plugin'
  import { getCurrentEmployee } from '@opensrcs/contact'
  import core, { AttachedData, Doc, Ref, SortingOrder, generateId, getCurrentAccount } from '@opensrcs/core'
  import { SpaceSelector, createQuery, getClient } from '@opensrcs/presentation'
  import tagsPlugin, { TagReference } from '@opensrcs/tags'
  import task, { makeRank } from '@opensrcs/task'
  import { StyledTextBox } from '@opensrcs/text-editor-resources'
  import { TimeEvents, ToDo, ToDoPriority, WorkSlot } from '@opensrcs/time'
  import { Button, Component, EditBox, IconClose, Label, Scroller } from '@opensrcs/ui'
