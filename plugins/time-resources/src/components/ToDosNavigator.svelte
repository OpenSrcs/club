<script lang="ts">
  ...
  import { ScheduleNavSection } from '@opensrcs/calendar-resources'
  import { getCurrentEmployee } from '@opensrcs/contact'
  import { Ref, getCurrentAccount } from '@opensrcs/core'
  import { Asset, getMetadata, getResource, IntlString } from '@opensrcs/club'
  import { createQuery } from '@opensrcs/presentation'
  import { NavFooter } from '@opensrcs/workbench-resources'
  import tagsPlugin, { TagElement as TagElementType } from '@opensrcs/tags'
  import ui, {
    Label,
    Separator,
    NavItem,
...
>
  <div class="antiPanel-wrap__content clubNavPanel-container">
    ...
    <Scroller shrink>
      ...
      <div class="clubAccordionItem-container border" class:noBorder={tags.length === 0}>
        <Month
