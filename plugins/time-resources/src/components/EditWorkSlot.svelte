...
-->
<script lang="ts">
  import { Event } from '@opensrcs/calendar'
  import {
    CalendarSelector,
    EventReminders,
    EventTimeEditor,
    VisibilityEditor,
    isReadOnly
  } from '@opensrcs/calendar-resources'
  import calendar from '@opensrcs/calendar-resources/src/plugin'
  import { DocumentUpdate } from '@opensrcs/core'
  ...
  import { Button, EditBox, Icon, IconClose, createFocusManager, FocusHandler } from '@opensrcs/ui'
