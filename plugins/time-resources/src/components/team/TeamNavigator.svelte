...
<script lang="ts">
  ...
  import { Separator, Scroller, NavItem, deviceOptionsStore as deviceInfo } from '@opensrcs/ui'
  import { ObjectPresenter, TreeNode } from '@opensrcs/view-resources'
  import { NavFooter, NavHeader } from '@opensrcs/workbench-resources'
