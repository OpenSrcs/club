...
import { type Calendar, type Event } from '@opensrcs/calendar'
import { isVisible } from '@opensrcs/calendar-resources'
import { type Contact, type Person } from '@opensrcs/contact'
import { type IdMap, type Ref } from '@opensrcs/core'
import { type ToDo, type WorkSlot } from '@opensrcs/time'
