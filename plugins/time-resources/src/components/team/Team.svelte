...
<script lang="ts">
  ...
  import { Ref, Doc } from '@opensrcs/core'
  ...
  import type { BreadcrumbItem } from '@opensrcs/ui'
  import time from '../../plugin'
  import { teamSeparators } from '../../utils'
  import TeamNavigator from './TeamNavigator.svelte'
  import Agenda from './agenda/Agenda.svelte'
  import Calendar from './calendar/Calendar.svelte'
  import { IconWithEmoji, getClient } from '@opensrcs/presentation'
  import view from '@opensrcs/view'
  import { Analytics } from '@opensrcs/analytics'
  import tracker, { Project as Proj } from '@opensrcs/tracker'
  import { TimeEvents } from '@opensrcs/time'
