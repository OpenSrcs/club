...
-->
<script lang="ts">
  import { Doc, Ref, TxCUD } from '@opensrcs/core'
  import { getClient } from '@opensrcs/presentation'
  import { Component, resizeObserver } from '@opensrcs/ui'
  import { DocNavLink, ObjectPresenter } from '@opensrcs/view-resources'
  import { ItemPresenter } from '@opensrcs/time'
