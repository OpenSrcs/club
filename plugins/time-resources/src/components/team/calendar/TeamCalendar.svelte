...
-->
<script lang="ts">
  import calendar, { Event, getAllEvents } from '@opensrcs/calendar'
  import { calendarByIdStore } from '@opensrcs/calendar-resources'
  import contact, { getCurrentEmployee, Person } from '@opensrcs/contact'
  import { employeeRefByAccountUuidStore, getPersonRefsByPersonIdsCb } from '@opensrcs/contact-resources'
  import core, {
    Doc,
    IdMap,
    PersonId,
