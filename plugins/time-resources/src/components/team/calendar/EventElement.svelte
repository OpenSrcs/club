...
-->
<script lang="ts">
  import calendar, { CalendarEventPresenter, Event } from '@opensrcs/calendar'
  import { EventPresenter, calendarByIdStore, isVisible } from '@opensrcs/calendar-resources'
  import { Doc } from '@opensrcs/core'
  import { getClient } from '@opensrcs/presentation'
  import { Component, MILLISECONDS_IN_MINUTE, showPopup, tooltip } from '@opensrcs/ui'
  import view, { ObjectEditor } from '@opensrcs/view'
