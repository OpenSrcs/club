...
<script lang="ts">
  ...
  import type { DocumentQuery, IdMap, Ref, WithLookup } from '@opensrcs/core'
  import { SortingOrder, toIdMap } from '@opensrcs/core'
  import type { IntlString } from '@opensrcs/club'
  import { createQuery } from '@opensrcs/presentation'
  import type { TagElement } from '@opensrcs/tags'
  import tags from '@opensrcs/tags'
  import type { ToDo, WorkSlot } from '@opensrcs/time'
  import type { Project } from '@opensrcs/tracker'
