...
<script lang="ts">
  ...
  import calendar, { AccessLevel, Calendar, generateEventId, getPrimaryCalendar } from '@opensrcs/calendar'
  ...
  import { TagElement } from '@opensrcs/tags'
  import { Separator, defineSeparators, deviceOptionsStore as deviceInfo } from '@opensrcs/ui'
