...
-->
<script lang="ts">
  import { Visibility } from '@opensrcs/calendar'
  import calendar from '@opensrcs/calendar-resources/src/plugin'
  import core, { Class, Ref, Space, getCurrentAccount, Markup } from '@opensrcs/core'
  import { SpaceSelector, getClient, createQuery } from '@opensrcs/presentation'
  import tags from '@opensrcs/tags'
  import task from '@opensrcs/task'
  import { StyledTextBox } from '@opensrcs/text-editor-resources'
  import { ModernEditbox, CheckBox, Component, IconClose, Label, Modal, Spinner, ButtonIcon } from '@opensrcs/ui'
  import { ToDo, ToDoPriority } from '@opensrcs/time'
  import { createEventDispatcher } from 'svelte'
  import time from '../plugin'
  import DueDateEditor from './DueDateEditor.svelte'
  import PriorityEditor from './PriorityEditor.svelte'
  import TodoWorkslots from './TodoWorkslots.svelte'
  import { VisibilityEditor } from '@opensrcs/calendar-resources'
