...
-->
<script lang="ts">
  import calendar, { AccessLevel, generateEventId } from '@opensrcs/calendar'
  import { EventReminders } from '@opensrcs/calendar-resources'
  ...
  import { closePopup, showPopup } from '@opensrcs/ui'
  import { deleteObjects } from '@opensrcs/view-resources'
  import { TimeEvents, ToDo, WorkSlot } from '@opensrcs/time'
