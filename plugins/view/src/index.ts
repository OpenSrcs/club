...
import { Class, Doc, DocumentQuery, FindOptions, Mixin, Ref } from '@opensrcs/core'
import { Asset, IntlString, Plugin, Resource, plugin } from '@opensrcs/club'
import { AnyComponent, PopupAlignment, PopupPosAlignment, type ComponentExtensionId } from '@opensrcs/ui/src/types'
import {
  Action,
  ActionCategory,
