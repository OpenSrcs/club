...
<script lang="ts">
  ...
  import { AccountArrayEditor } from '@opensrcs/contact-resources'
  import { AccountUuid } from '@opensrcs/core'
  import presentation, { Card, getClient, getCurrentWorkspaceUuid } from '@opensrcs/presentation'
  import setting, { Integration } from '@opensrcs/setting'
  import { Grid, Label, Toggle } from '@opensrcs/ui'
  import { getCurrentEmployee } from '@opensrcs/contact'
  import { isWorkspaceIntegration } from '@opensrcs/integration-client'
  import { Integration as AccountIntegration } from '@opensrcs/account-client'
