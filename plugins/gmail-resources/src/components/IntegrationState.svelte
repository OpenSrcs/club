...
<script lang="ts">
  ...
  import { IntegrationEventData, onIntegrationEvent } from '@opensrcs/integration-client'
  import { type GmailSyncState } from '@opensrcs/gmail'
  import { BaseIntegrationState, IntegrationStateRow } from '@opensrcs/setting-resources'

  import gmail from '../plugin'
  import { getState } from '../api'
  import platform, { IntlString, OK, ERROR, Status, Severity } from '@opensrcs/club'
