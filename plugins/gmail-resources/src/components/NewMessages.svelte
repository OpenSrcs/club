...
<script lang="ts">
  ...
  import contact, { Channel, Contact, getName as getContactName } from '@opensrcs/contact'
  import core, { generateId, getCurrentAccount, Markup, Ref, toIdMap } from '@opensrcs/core'
  ...
  import setting, { Integration } from '@opensrcs/setting'
  ...
  import { GmailEvents } from '@opensrcs/gmail'
