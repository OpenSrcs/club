...
<script lang="ts">
  ...
  import { Ref, SocialIdType, getCurrentAccount } from '@opensrcs/core'
  import { Message, SharedMessage } from '@opensrcs/gmail'
  ...
  import { Button, Dialog, eventToHTMLElement, Icon, Label, showPopup } from '@opensrcs/ui'
