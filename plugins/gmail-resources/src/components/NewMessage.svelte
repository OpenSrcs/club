...
<script lang="ts">
  ...
  import attachmentP, { Attachment } from '@opensrcs/attachment'
  import { AttachmentPresenter } from '@opensrcs/attachment-resources'
  import contact, { Channel, Contact, getName } from '@opensrcs/contact'
  import core, { Data, Markup, generateId } from '@opensrcs/core'
  import { NewMessage, SharedMessage, GmailEvents } from '@opensrcs/gmail'
  import { InboxNotificationsClientImpl } from '@opensrcs/notification-resources'
  import { getResource, setPlatformStatus, unknownError } from '@opensrcs/club'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { Integration } from '@opensrcs/setting'
  import templates, { TemplateDataProvider } from '@opensrcs/templates'
  import { EmptyMarkup, isEmptyMarkup, markupToJSON } from '@opensrcs/text'
  import { markupToHtml } from '@opensrcs/text-html'
  import { StyledTextEditor } from '@opensrcs/text-editor-resources'
  import { Button, EditBox, IconArrowLeft, IconAttachment, Label, Scroller } from '@opensrcs/ui'
