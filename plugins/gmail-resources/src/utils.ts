...
import contact, { type Channel, type Contact } from '@opensrcs/contact'
import { employeeBySocialKeyStore, getPersonByPersonId } from '@opensrcs/contact-resources'
import { buildSocialIdString, type PersonId, SocialIdType, type Client, type Doc, type Ref } from '@opensrcs/core'
import { type Message, type SharedMessage } from '@opensrcs/gmail'
