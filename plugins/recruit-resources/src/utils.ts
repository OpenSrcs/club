...
import { Hierarchy, type Class, type Client, type Doc, type Ref } from '@opensrcs/core'
...
import { type Poll } from '@opensrcs/survey'
import { generatePollLocation } from '@opensrcs/survey-resources'
import { getCurrentResolvedLocation, getPanelURI, type Location, type ResolvedLocation } from '@opensrcs/ui'
