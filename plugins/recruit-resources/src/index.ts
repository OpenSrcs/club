...
import { OK, Severity, Status, type Resources } from '@opensrcs/club'
import { getClient, type ObjectSearchResult } from '@opensrcs/presentation'
import { type Applicant, type Candidate, type Vacancy } from '@opensrcs/recruit'
import task from '@opensrcs/task'
import { showPopup } from '@opensrcs/ui'
import { type Filter } from '@opensrcs/view'
import { FilterQuery, statusStore } from '@opensrcs/view-resources'
