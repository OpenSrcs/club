...
-->
<script lang="ts">
  import contact, { getName, Person } from '@opensrcs/contact'
  import PersonPresenter from '@opensrcs/contact-resources/src/components/PersonPresenter.svelte'
  import { Ref } from '@opensrcs/core'
  import { getClient } from '@opensrcs/presentation'
  import type { Applicant } from '@opensrcs/recruit'
