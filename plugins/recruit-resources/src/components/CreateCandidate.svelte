...
<script lang="ts">
  ...
  import attachment, { AttachmentsEvents } from '@opensrcs/attachment'
  import contact, {
    AvatarType,
    Channel,
    ChannelProvider,
  ...
  import { getMetadata, getResource, setPlatformStatus, unknownError } from '@opensrcs/club'
  import presentation, {
    Card,
    createQuery,
    deleteFile,
  ...
  import { Candidate, CandidateDraft, RecruitEvents } from '@opensrcs/recruit'
  import { recognizeDocument } from '@opensrcs/rekoni'
  import tags, { findTagCategory, TagElement, TagReference } from '@opensrcs/tags'
  import {
    Button,
    Component,
    createFocusManager,
