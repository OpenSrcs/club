...
<script lang="ts">
  ...
  import { ExpandRightDouble } from '@opensrcs/contact-resources'
  import { FindOptions, Status as TaskStatus } from '@opensrcs/core'
  import { OK, Severity, Status } from '@opensrcs/club'
  import presentation, { Card, SpaceSelect, createQuery, getClient } from '@opensrcs/presentation'
  import type { Applicant, Vacancy } from '@opensrcs/recruit'
  import { getStates } from '@opensrcs/task'
  import { typeStore } from '@opensrcs/task-resources'
  import ui, {
    Button,
    ColorPopup,
    FocusHandler,
  ...
  import { moveToSpace } from '@opensrcs/view-resources/src/utils'
