...
-->
<script lang="ts">
  import { Class, Doc, platformNow, platformNowDiff, Ref, toIdMap } from '@opensrcs/core'
  import { getEmbeddedLabel } from '@opensrcs/club'
  import { Card, getClient } from '@opensrcs/presentation'
  import tags, { TagCategory, TagElement, TagReference } from '@opensrcs/tags'
  import { Button, CheckBox, EditBox, Expandable, Lazy, ListView, Loading } from '@opensrcs/ui'
  import { FILTER_DEBOUNCE_MS } from '@opensrcs/view-resources'
