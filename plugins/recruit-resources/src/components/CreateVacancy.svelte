...
<script lang="ts">
  ...
  import contact, { Organization } from '@opensrcs/contact'
  import { AccountArrayEditor, UserBox } from '@opensrcs/contact-resources'
  import core, {
    AttachedData,
    Data,
    Ref,
  ...
  import { RecruitEvents, Vacancy, Vacancy as VacancyClass } from '@opensrcs/recruit'
  import tags from '@opensrcs/tags'
  import task, { ProjectType } from '@opensrcs/task'
  import { selectedTypeStore, typeStore } from '@opensrcs/task-resources'
  import tracker, { Issue, IssueStatus, IssueTemplate, IssueTemplateData, Project } from '@opensrcs/tracker'
  import {
    Button,
    Component,
    EditBox,
