...
<script lang="ts">
  ...
  import { Data, Doc, type MarkupBlobRef, Mixin, Ref } from '@opensrcs/core'
  import notification from '@opensrcs/notification'
  import { Panel } from '@opensrcs/panel'
  import { getResource } from '@opensrcs/club'
  import presentation, { createQuery, getClient } from '@opensrcs/presentation'
  import { Vacancy } from '@opensrcs/recruit'
  import survey from '@opensrcs/survey'
  import tracker from '@opensrcs/tracker'
  import { Button, Component, EditBox, IconMixin, IconMoreH, Label } from '@opensrcs/ui'
  import view from '@opensrcs/view'
  import { DocAttributeBar, DocNavLink, getDocMixins, showMenu } from '@opensrcs/view-resources'
