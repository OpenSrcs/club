...
<script lang="ts">
  ...
  import { DateRangeMode, Doc, FindOptions, Ref } from '@opensrcs/core'
  import { IntlString } from '@opensrcs/club'
  import { Applicant, Review } from '@opensrcs/recruit'
  import { Button, DatePresenter, IconAdd, Label, Scroller, showPopup } from '@opensrcs/ui'
