...
-->
<script lang="ts">
  import calendar, { Calendar } from '@opensrcs/calendar'
  import type { Organization, Person } from '@opensrcs/contact'
  import contact, { getCurrentEmployee } from '@opensrcs/contact'
  import core, { Class, Client, DateRangeMode, Doc, generateId, Markup, PersonId, Ref } from '@opensrcs/core'
  import { getResource, OK, Resource, Severity, Status } from '@opensrcs/club'
  import { Card, getClient } from '@opensrcs/presentation'
  import { UserBox, UserBoxList } from '@opensrcs/contact-resources'
  import { Applicant, Candidate, RecruitEvents, Review } from '@opensrcs/recruit'
  import { EmptyMarkup } from '@opensrcs/text'
  import { StyledTextArea } from '@opensrcs/text-editor-resources'
  import { DateRangePresenter, EditBox, Status as StatusControl } from '@opensrcs/ui'
  import view from '@opensrcs/view'
  import { ObjectSearchBox } from '@opensrcs/view-resources'
