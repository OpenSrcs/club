...
-->
<script lang="ts">
  import { Organization } from '@opensrcs/contact'
  import core, { Doc, DocumentQuery, Ref, WithLookup } from '@opensrcs/core'
  import { createQuery } from '@opensrcs/presentation'
  import { Applicant, Vacancy } from '@opensrcs/recruit'
  import { Button, Component, IconAdd, Breadcrumb, Loading, SearchInput, showPopup, Header } from '@opensrcs/ui'
  import view, { BuildModelKey, ViewOptions, Viewlet, ViewletPreference } from '@opensrcs/view'
  import { FilterBar, FilterButton, ViewletSelector, ViewletSettingButton } from '@opensrcs/view-resources'
  import recruit from '../plugin'
  import CreateOrganization from './CreateOrganization.svelte'
  import { ExportButton } from '@opensrcs/export-resources'
