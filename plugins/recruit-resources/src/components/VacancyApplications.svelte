...
<script lang="ts">
  ...
  import { recruitId, Vacancy } from '@opensrcs/recruit'
  import { Button, Icon, IconAdd, Label, Loading, Scroller, showPopup } from '@opensrcs/ui'
  import { Viewlet, ViewletPreference } from '@opensrcs/view'
  import { NavLink, Table, ViewletsSettingButton } from '@opensrcs/view-resources'
