...
-->
<script lang="ts">
  import { AttributesBar, getClient } from '@opensrcs/presentation'
  import { ProjectType } from '@opensrcs/task'
  import { StyledTextBox } from '@opensrcs/text-editor-resources'
  import tracker from '@opensrcs/tracker'
  import { Button, Component, Icon, IconAdd, Label, showPopup } from '@opensrcs/ui'
  import { getFiltredKeys } from '@opensrcs/view-resources'
