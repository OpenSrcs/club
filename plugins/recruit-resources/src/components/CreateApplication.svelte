...
<script lang="ts">
  ...
  import type { Contact, Employee, Person } from '@opensrcs/contact'
  import contact from '@opensrcs/contact'
  import { EmployeeBox, ExpandRightDouble, UserBox } from '@opensrcs/contact-resources'
  import core, {
    AccountRole,
    Class,
    Client,
  ...
  import { OK, Resource, Severity, Status, getResource } from '@opensrcs/club'
  import presentation, {
    Card,
    InlineAttributeBar,
    SpaceSelect,
  ...
  import { recruitId, type Applicant, type Candidate, type Vacancy, RecruitEvents } from '@opensrcs/recruit'
  import { TaskType, getStates } from '@opensrcs/task'
  import { TaskKindSelector, selectedTypeStore, typeStore } from '@opensrcs/task-resources'
