...
import { type Restrictions } from '@opensrcs/guest'
...
import { type CollaborationUser } from '@opensrcs/text-editor'
import {
  ErrorPresenter,
...
export { getFiltredKeys, isCollectionAttr } from '@opensrcs/presentation'
