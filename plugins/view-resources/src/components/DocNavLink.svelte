...
-->
<script lang="ts">
  import { concatLink, Doc, Hierarchy } from '@opensrcs/core'
  import presentation, { NavLink, getClient, createQuery, MessageBox } from '@opensrcs/presentation'
  import { AnyComponent, getPanelURI, locationToUrl, showPopup } from '@opensrcs/ui'
