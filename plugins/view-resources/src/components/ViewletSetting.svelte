...
<script lang="ts">
  ...
  import { Asset, getEmbeddedLabel, IntlString, translate } from '@opensrcs/club'
  import { createQuery, getAttributePresenterClass, getClient, hasResource } from '@opensrcs/presentation'
  import { DropdownLabelsIntl, Loading, resizeObserver } from '@opensrcs/ui'
  import { BuildModelKey, Viewlet, ViewletPreference } from '@opensrcs/view'
