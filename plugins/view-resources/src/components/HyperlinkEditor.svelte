...
<script lang="ts">
  ...
  import type { AnySvelteComponent, ButtonKind, ButtonSize, IconProps } from '@opensrcs/ui'
  import { Button, Label, eventToHTMLElement, parseURL, showPopup } from '@opensrcs/ui'
