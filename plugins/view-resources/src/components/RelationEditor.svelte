<script lang="ts">
  import card, { type MasterTag } from '@opensrcs/card'
  import core, { Association, Doc, WithLookup } from '@opensrcs/core'
  import { IntlString } from '@opensrcs/club'
  import { getClient, ObjectCreate } from '@opensrcs/presentation'
  import { Button, IconAdd, Label, Scroller, Section, showPopup } from '@opensrcs/ui'
