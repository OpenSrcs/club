<script lang="ts">
  import { Class, Doc, DocumentQuery, FindOptions, Hierarchy, Mixin, Ref, generateId } from '@opensrcs/core'
  import { Asset, IntlString } from '@opensrcs/club'
  import { ObjectPopup, getClient, updateAttribute } from '@opensrcs/presentation'
  import { Label, SelectPopup, resizeObserver } from '@opensrcs/ui'
