...
-->
<script lang="ts">
  import { AccountRole, Class, Doc, DocumentQuery, Ref, Space, getCurrentAccount } from '@opensrcs/core'
  import { getResource } from '@opensrcs/club'
  import { getClient, reduceCalls } from '@opensrcs/presentation'
  import { Button, IconAdd, eventToHTMLElement, getCurrentLocation, showPopup } from '@opensrcs/ui'
  import { Filter, FilteredView, ViewOptions, Viewlet } from '@opensrcs/view'
