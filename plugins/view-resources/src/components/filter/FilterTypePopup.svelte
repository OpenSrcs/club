...
-->
<script lang="ts">
  import core, { AnyAttribute, ArrOf, Class, ClassifierKind, Doc, Ref, RefTo, Space, Type } from '@opensrcs/core'
  import { getClient } from '@opensrcs/presentation'
  import { Label, Scroller, Submenu, closePopup, closeTooltip, resizeObserver, showPopup } from '@opensrcs/ui'
  import { ClassFilters, Filter, KeyFilter, KeyFilterPreset, ViewOptions } from '@opensrcs/view'
