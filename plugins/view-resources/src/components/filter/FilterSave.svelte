<script lang="ts">
  import core, { Class, Doc, Ref, Space, getCurrentAccount } from '@opensrcs/core'
  import { Card, getClient } from '@opensrcs/presentation'
  import { Button, EditBox, ToggleWithLabel, getCurrentResolvedLocation } from '@opensrcs/ui'
  import { ViewOptions } from '@opensrcs/view'
