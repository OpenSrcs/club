...
-->
<script lang="ts">
  import { Class, Doc, DocumentQuery, FindOptions, Ref, generateId, SortingOrder } from '@opensrcs/core'
  import { ActionContext } from '@opensrcs/presentation'
  import { Scroller, tableSP } from '@opensrcs/ui'
  import { BuildModelKey, Viewlet, ViewOptionModel, ViewOptions } from '@opensrcs/view'
