...
<script lang="ts">
  ...
  import core, { Doc, Hierarchy, Ref, Space, TxRemoveDoc, type Tx } from '@opensrcs/core'
  import { getResource } from '@opensrcs/club'
  import { addTxListener, contextStore, getClient, reduceCalls } from '@opensrcs/presentation'
  import { AnyComponent, Component } from '@opensrcs/ui'
  import { Action, ViewContextType } from '@opensrcs/view'
