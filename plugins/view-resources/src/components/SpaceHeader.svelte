<script lang="ts">
  ...
  import { IModeSelector, ModeSelector, SearchInput, Header, Breadcrumb, HeaderAdaptive } from '@opensrcs/ui'
  import type { Asset } from '@opensrcs/club'
  import { ComponentExtensions, getClient } from '@opensrcs/presentation'
  import view, { Viewlet, type ViewletViewAction } from '@opensrcs/view'
