...
<script lang="ts">
  ...
  import { getResource, translate, translateCB } from '@opensrcs/club'
  import {
    ActionContext,
    SearchResult,
    addTxListener,
  ...
  import { Action, ActionCategory, ViewContext } from '@opensrcs/view'
  ...
  import { contextStore } from '@opensrcs/presentation'
