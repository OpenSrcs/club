...
-->
<script lang="ts">
  import contact, { PermissionsStore } from '@opensrcs/contact'
  import core, { AnyAttribute, Class, Doc, Ref, TxOperations, TypedSpace, getObjectValue } from '@opensrcs/core'
  import { getClient, reduceCalls, updateAttribute } from '@opensrcs/presentation'
  import { Label, Loading, mouseAttractor } from '@opensrcs/ui'
  import { AttributeModel, BuildModelKey, BuildModelOptions, Viewlet } from '@opensrcs/view'
