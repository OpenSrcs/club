...
-->
<script lang="ts">
  import { Class, Doc, DocumentQuery, Ref, Space, WithLookup } from '@opensrcs/core'
  ...
  import view, { ViewOptions, Viewlet, ViewletPreference, type ViewletViewAction } from '@opensrcs/view'
