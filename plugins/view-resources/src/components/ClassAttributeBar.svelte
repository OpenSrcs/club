...
-->
<script lang="ts">
  import core, { Class, Doc, Rank, Ref, toRank } from '@opensrcs/core'
  import { IntlString } from '@opensrcs/club'
  import { AttributesBar, KeyedAttribute, createQuery, getAttribute, getClient } from '@opensrcs/presentation'
  import setting, { settingId } from '@opensrcs/setting'
  import { Button, Label, getCurrentResolvedLocation, navigate } from '@opensrcs/ui'
