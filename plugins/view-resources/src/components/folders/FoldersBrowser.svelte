...
<script lang="ts">
  ...
  import { Class, Doc, DocumentQuery, Ref, SortingOrder } from '@opensrcs/core'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { Action, IconEdit, navigate, type Location, Scroller, location, getLocation } from '@opensrcs/ui'
  import { getResource, type Resource } from '@opensrcs/club'
