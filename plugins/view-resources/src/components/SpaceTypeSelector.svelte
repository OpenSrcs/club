...
<script lang="ts">
  ...
  import core, { type Ref, type SpaceType, type SpaceTypeDescriptor } from '@opensrcs/core'
  import { createQuery } from '@opensrcs/presentation'
  import { type DropdownTextItem, ButtonKind, ButtonSize, DropdownLabels } from '@opensrcs/ui'
