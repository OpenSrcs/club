...
<script lang="ts">
  ...
  import { ButtonIcon, closeTooltip, IconOptions, showPopup } from '@opensrcs/ui'
  import { OrderOption, Viewlet, ViewOptionModel, ViewOptions } from '@opensrcs/view'
  import { createEventDispatcher } from 'svelte'
  import view from '../plugin'
  import { focusStore } from '../selection'
  import { setViewOptions } from '../viewOptions'
  import ViewOptionsEditor from './ViewOptions.svelte'
  import core, { Class, Doc, Hierarchy, Ref, SortingOrder, Type } from '@opensrcs/core'
