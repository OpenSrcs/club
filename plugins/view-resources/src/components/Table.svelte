...
<script lang="ts">
  ...
  import { createQuery, getClient, reduceCalls, updateAttribute } from '@opensrcs/presentation'
  import ui, {
    Button,
    CheckBox,
    Component,
  ...
  import { AttributeModel, BuildModelKey, BuildModelOptions, ViewOptionModel, ViewOptions } from '@opensrcs/view'
