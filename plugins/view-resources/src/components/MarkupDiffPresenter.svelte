...
-->
<script lang="ts">
  import { AnyAttribute, Markup } from '@opensrcs/core'
  import { EmptyMarkup, MarkupNode, MarkupNodeType, markupToJSON } from '@opensrcs/text'
  import { MarkupDiffViewer } from '@opensrcs/text-editor-resources'
  import { ShowMore } from '@opensrcs/ui'
