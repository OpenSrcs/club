...
-->
<script lang="ts">
  import { SpaceSelect, getClient, Card } from '@opensrcs/presentation'
  import { Label, Status as StatusControl, themeStore } from '@opensrcs/ui'

  import core, { Class, Client, Doc, Ref, SortingOrder, Space } from '@opensrcs/core'
  import { OK, Resource, Severity, Status, getResource, translate } from '@opensrcs/club'
  import task, { Project, Task, makeRank } from '@opensrcs/task'
