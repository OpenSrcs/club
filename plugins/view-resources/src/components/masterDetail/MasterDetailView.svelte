...
-->
<script lang="ts">
  import core, { Doc, DocumentQuery, FindOptions, Ref, Space, WithLookup, mergeQueries } from '@opensrcs/core'
  import { MasterDetailConfig, ViewOptions, Viewlet, ViewletDescriptor } from '@opensrcs/view'
