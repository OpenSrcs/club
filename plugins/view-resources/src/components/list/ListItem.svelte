...
-->
<script lang="ts">
  import { AnyAttribute, Doc, getObjectValue } from '@opensrcs/core'
  import notification from '@opensrcs/notification'
  import { getClient, updateAttribute } from '@opensrcs/presentation'
  import { CheckBox, Component, IconCircles, tooltip, deviceOptionsStore as deviceInfo } from '@opensrcs/ui'
