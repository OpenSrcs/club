...
<script lang="ts">
  ...
  import { getResource, translateCB } from '@opensrcs/club'
  import { createQuery, getClient, IconWithEmoji } from '@opensrcs/presentation'
  import { AnyComponent, Icon, LabelAndProps, themeStore, tooltip } from '@opensrcs/ui'
  import view from '@opensrcs/view'
  import activity, { ActivityMessage } from '@opensrcs/activity'

  import { getReferenceLabel } from '@opensrcs/text-editor-resources/src/components/extension/reference'
