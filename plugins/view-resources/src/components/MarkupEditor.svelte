...
<script lang="ts">
  ...
  import { Button, eventToHTMLElement, Label, showPopup } from '@opensrcs/ui'
  import MarkupEditorPopup from './MarkupEditorPopup.svelte'
  import { StyledTextBox } from '@opensrcs/text-editor-resources'
  import type { EditorKitOptions, ImageUploadOptions } from '@opensrcs/text-editor-resources'
  import textEditorPlugin from '@opensrcs/text-editor'
