<script lang="ts">
  ...
  import { DropdownIntlItem, DropdownLabelsIntl, Label, Toggle } from '@opensrcs/ui'
  import { Viewlet, ViewOptions, ViewOptionsModel, ViewOptionModel } from '@opensrcs/view'
