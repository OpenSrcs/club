<script lang="ts">
  ...
  import { resolvedLocationStore, Switcher } from '@opensrcs/ui'
  import view, { Viewlet, ViewletDescriptor, ViewletPreference } from '@opensrcs/view'
  import core, { DocumentQuery, Ref, WithLookup } from '@opensrcs/core'
