...
import platform, { getResource, PlatformError, translate } from '@opensrcs/club'
import { BasePresentationMiddleware, type PresentationMiddleware } from '@opensrcs/presentation'
import view, { type IAggregationManager } from '@opensrcs/view'
import notification from '@opensrcs/notification'
import { addNotification, NotificationSeverity } from '@opensrcs/ui'
