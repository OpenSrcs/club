...
import { type Asset, getResource, type IntlString } from '@opensrcs/club'
import { type LiveQuery, createQuery, getAttributePresenterClass, getClient } from '@opensrcs/presentation'
import { locationToUrl, getCurrentResolvedLocation } from '@opensrcs/ui'
import {
