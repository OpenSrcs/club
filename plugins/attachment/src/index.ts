...
import type { AttachedDoc, Blob, BlobMetadata, Class, Doc, Ref } from '@opensrcs/core'
import type { Asset, Plugin } from '@opensrcs/club'
import { IntlString, plugin, Resource } from '@opensrcs/club'
