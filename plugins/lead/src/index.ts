...
import type { Contact } from '@opensrcs/contact'
import type {
  Attribute,
  Class,
  MarkupBlobRef,
...
import { Mixin } from '@opensrcs/core'
import type { Asset, IntlString, Plugin } from '@opensrcs/club'
import { plugin } from '@opensrcs/club'
import type { Project, ProjectType, ProjectTypeDescriptor, Task, TaskType } from '@opensrcs/task'
