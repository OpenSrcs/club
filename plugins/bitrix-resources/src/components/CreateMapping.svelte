<script lang="ts">
  import { BitrixEntityMapping, BitrixEntityType, mappingTypes } from '@opensrcs/bitrix'
  import core, { Class, ClassifierKind, Doc, Obj, Ref } from '@opensrcs/core'
  import { Card, createQuery, getClient } from '@opensrcs/presentation'
  import setting, { Integration } from '@opensrcs/setting'
  import { DropdownLabels } from '@opensrcs/ui'
