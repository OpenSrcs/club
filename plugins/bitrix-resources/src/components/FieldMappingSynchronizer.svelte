<script lang="ts">
  import {
    ...
    StatusValue,
    toClassRef
  } from '@opensrcs/bitrix'
  import contact from '@opensrcs/contact'
  import core, { Class, Doc, generateId, Ref, Space, WithLookup } from '@opensrcs/core'
  import { getEmbeddedLabel, getMetadata } from '@opensrcs/club'
  import presentation, { getClient, SpaceSelect } from '@opensrcs/presentation'
  import {
    Button,
    CheckBox,
    Expandable,
  ...
  import { NumberEditor } from '@opensrcs/view-resources'
