<script lang="ts">
  ...
  import { AnyAttribute, Status } from '@opensrcs/core'
  import { getEmbeddedLabel } from '@opensrcs/club'
  import { getClient, InlineAttributeBarEditor } from '@opensrcs/presentation'
  import recruit from '@opensrcs/recruit'
  import task from '@opensrcs/task'
  import { Button, DropdownLabels, DropdownLabelsIntl, DropdownTextItem, IconAdd } from '@opensrcs/ui'
