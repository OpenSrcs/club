<script lang="ts">
  import { BitrixEntityMapping, BitrixFieldMapping, MappingOperation, Fields } from '@opensrcs/bitrix'
  ...
  import { Button, eventToHTMLElement, IconDelete, Menu, showPopup, Action, IconEdit } from '@opensrcs/ui'
