...
import { createPublicLink } from '@opensrcs/guest'
import { getMetadata } from '@opensrcs/club'
import { printToPDF } from '@opensrcs/print'
import { signPDF } from '@opensrcs/sign'
import { getDocTitle } from '@opensrcs/view-resources'
...
jest.mock('@opensrcs/view-resources', () => ({
  getDocTitle: jest.fn(),
...
jest.mock('@opensrcs/print', () => ({
  printToPDF: jest.fn()
}))

jest.mock('@opensrcs/sign', () => ({
  signPDF: jest.fn()
}))
