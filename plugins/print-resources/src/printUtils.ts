...
import type { Class, Client, Doc, Ref } from '@opensrcs/core'
import type { Location } from '@opensrcs/ui'
import { Analytics } from '@opensrcs/analytics'
import guest, { type PublicLink, createPublicLink } from '@opensrcs/guest'
...
import presentation, { getFileUrl } from '@opensrcs/presentation'
