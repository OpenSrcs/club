...
<script lang="ts">
  ...
  import { Doc, type Blob, type Ref } from '@opensrcs/core'
  import presentation, { PDFViewer, createQuery, getClient } from '@opensrcs/presentation'
  import guest, { PublicLink, createPublicLink } from '@opensrcs/guest'
  ...
  import { getDocTitle, getObjectLinkFragment } from '@opensrcs/view-resources'
  import { printToPDF, type PrintPageOrientation } from '@opensrcs/print'
