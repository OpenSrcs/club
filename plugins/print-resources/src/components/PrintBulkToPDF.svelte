...
<script lang="ts">
  ...
  import type { Blob, Doc, Ref } from '@opensrcs/core'
  import presentation, { Card, getClient, PDFViewer } from '@opensrcs/presentation'
  import view from '@opensrcs/view'
  import { Button, Label, Loading, Scroller } from '@opensrcs/ui'
