...
<script lang="ts">
  ...
  import { type Blob, type BlobMetadata, type Ref } from '@opensrcs/core'
  import { getMetadata } from '@opensrcs/club'
  import presentation, { getFileUrl } from '@opensrcs/presentation'
  import { convertToHTML } from '@opensrcs/print'
  import { EmbeddedHTML, Spinner, themeStore } from '@opensrcs/ui'
