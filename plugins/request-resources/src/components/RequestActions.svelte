...
<script lang="ts">
  ...
  import { AttachedData, getCurrentAccount, Markup } from '@opensrcs/core'
  import { getClient } from '@opensrcs/presentation'
  import { Request, RequestStatus } from '@opensrcs/request'
  import { EmptyMarkup, isEmptyMarkup } from '@opensrcs/text'
  import { type RefAction } from '@opensrcs/text-editor'
