...
<script lang="ts">
  ...
  import { getPersonRefsByPersonIdsCb, PersonRefPresenter } from '@opensrcs/contact-resources'
  import { Ref } from '@opensrcs/core'
  import { createQuery, MessageViewer } from '@opensrcs/presentation'
  import { Request, RequestDecisionComment } from '@opensrcs/request'
  import { BooleanIcon, Label, ShowMore } from '@opensrcs/ui'
