...
import type { Attribute, Class, Doc, Mixin, Permission, Ref, Status } from '@opensrcs/core'
import type { Asset, IntlString, Plugin, Resource } from '@opensrcs/club'
import { plugin } from '@opensrcs/club'
import type { ProjectTypeDescriptor, TaskType } from '@opensrcs/task'
import { AnyComponent, Location, ResolvedLocation } from '@opensrcs/ui'
