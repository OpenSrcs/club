...
import { Mixin, Type, type Class, type Doc, type Ref } from '@opensrcs/core'
...
import { ActionCategory, Viewlet } from '@opensrcs/view'
import type { DocumentSpaceType, DocumentSpaceTypeDescriptor } from '@opensrcs/controlled-documents'
