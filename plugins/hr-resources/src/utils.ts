import { type Employee, getName } from '@opensrcs/contact'
import { type Ref, type TxOperations } from '@opensrcs/core'
import { type Department, type Request, type RequestType, type Staff, fromTzDate } from '@opensrcs/hr'
import { MessageBox } from '@opensrcs/presentation'
import { type Issue, type TimeSpendReport } from '@opensrcs/tracker'
import { MILLISECONDS_IN_DAY, areDatesEqual, isWeekend, showPopup } from '@opensrcs/ui'
