...
<script lang="ts">
  ...
  import { CalendarMode } from '@opensrcs/calendar-resources'
  import calendar from '@opensrcs/calendar-resources/src/plugin'
  import { DocumentQuery, Ref } from '@opensrcs/core'
  import { Department, Staff } from '@opensrcs/hr'
  import { createQuery } from '@opensrcs/presentation'
  import { getEmbeddedLabel } from '@opensrcs/club'
  import type { TabItem, DropdownIntlItem } from '@opensrcs/ui'
  import {
    ModernButton,
    ButtonIcon,
    IconBack,
  ...
  import view, { Viewlet, ViewletPreference, type ViewOptions } from '@opensrcs/view'
  import { ViewletSelector, ViewletSettingButton } from '@opensrcs/view-resources'
...
<div class="clubPanels-container">
  ...
  <div class="clubComponent" bind:this={replacedPanel}>
    <Header
      adaptive={'disabled'}
    ...
    <div class="clubHeader-container clearPadding justify-between flex-gap-4">
      <div class="flex-row-center flex-gap-2">
        ...
        />
        <div class="clubHeader-divider short" />
