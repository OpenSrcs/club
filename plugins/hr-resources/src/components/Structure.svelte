...
<script lang="ts">
  ...
  import { DocumentQuery, Ref, WithLookup } from '@opensrcs/core'
  import type { Department, Staff } from '@opensrcs/hr'
  import { createQuery } from '@opensrcs/presentation'
  import { Button, IconAdd, Label, Scroller, SearchEdit, eventToHTMLElement, showPopup } from '@opensrcs/ui'
