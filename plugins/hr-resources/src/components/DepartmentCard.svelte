...
<script lang="ts">
  ...
  import { Avatar, EmployeePresenter, UsersPopup } from '@opensrcs/contact-resources'
  ...
  import { Button, IconAdd, Label, closeTooltip, eventToHTMLElement, showPopup } from '@opensrcs/ui'
  import { openDoc, showMenu } from '@opensrcs/view-resources'
