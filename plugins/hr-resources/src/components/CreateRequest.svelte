...
<script lang="ts">
  ...
  import { EmployeeBox } from '@opensrcs/contact-resources'
  import core, { DocumentQuery, generateId, Markup, Ref } from '@opensrcs/core'
  import { Request, RequestType, Staff, timeToTzDate } from '@opensrcs/hr'
  import { translate } from '@opensrcs/club'
  import { Card, createQuery, getClient } from '@opensrcs/presentation'
