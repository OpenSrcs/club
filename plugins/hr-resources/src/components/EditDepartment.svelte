...
<script lang="ts">
  ...
  import { createFocusManager, EditBox, FocusHandler } from '@opensrcs/ui'

  import { ChannelsEditor, EditableAvatar } from '@opensrcs/contact-resources'
  import core, { getCurrentAccount, Ref } from '@opensrcs/core'
