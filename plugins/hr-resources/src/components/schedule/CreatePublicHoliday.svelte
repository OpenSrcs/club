...
-->
<script lang="ts">
  import core, { Data, Ref, Timestamp } from '@opensrcs/core'
  import { Department, PublicHoliday, timeToTzDate } from '@opensrcs/hr'
  import presentation, { Card, getClient } from '@opensrcs/presentation'
  import { Button, DateRangePresenter, EditBox, Label } from '@opensrcs/ui'
