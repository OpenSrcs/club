...
<script lang="ts">
  ...
  import { AccountRole, getCurrentAccount, Ref } from '@opensrcs/core'
  import { tzDateCompare, type Department, type Request, type RequestType, type Staff } from '@opensrcs/hr'
  import { isAdminUser } from '@opensrcs/presentation'
  import {
    areDatesEqual,
    daysInMonth,
