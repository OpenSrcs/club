...
<script lang="ts">
  import { Action, Menu, ModernTab, showPopup } from '@opensrcs/ui'
  import { Widget, WidgetTab } from '@opensrcs/workbench'
  import { createNotificationsQuery, createQuery, getClient, IconWithEmoji } from '@opensrcs/presentation'
  import { Card, MasterTag } from '@opensrcs/card'
  import { Ref, SortingOrder } from '@opensrcs/core'
  import { closeWidgetTab } from '@opensrcs/workbench-resources'
