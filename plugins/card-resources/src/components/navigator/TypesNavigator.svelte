...
-->
<script lang="ts">
  import { FavoriteType, MasterTag } from '@opensrcs/card'
  import core, { Class, Doc, getCurrentAccount, Ref, Space } from '@opensrcs/core'
  import preference from '@opensrcs/preference'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { Action, getCurrentLocation, location as locationStore, navigate } from '@opensrcs/ui'
  import view from '@opensrcs/view'
  import { setFilters, TreeNode } from '@opensrcs/view-resources'
  import { GroupsNavModel } from '@opensrcs/workbench'
