...
-->
<script lang="ts">
  import { ButtonIcon, handler } from '@opensrcs/ui'
  import type { RefAction, TextEditorHandler } from '@opensrcs/text-editor'
  import { getEditorHandler } from '@opensrcs/text-editor-resources/src/components/editor-context'
