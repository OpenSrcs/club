...
<script lang="ts">
  import card, { Card, CardSection, CardViewDefaults } from '@opensrcs/card'
  import communication from '@opensrcs/communication'
  import { NotificationContext } from '@opensrcs/communication-types'
  ...
  import { Component, Loading, ModernButton, Scroller } from '@opensrcs/ui'
...
<div class="clubComponent-content__container columns relative">
  {#if showOverlay}
    <div class="overlay">
      <Loading />
    </div>
  ...
  <div class="clubComponent-content__column content">
    ...
    >
      <div class="clubComponent-content withoutMaxWidth" class:gap={renderTopSections}>
