...
<script lang="ts">
  ...
  import { AnyAttribute, ArrOf, Class, Ref, RefTo, Type } from '@opensrcs/core'
  import { IntlString } from '@opensrcs/club'
  import { IconWithEmoji, createQuery, getClient } from '@opensrcs/presentation'
  import { Button, ButtonKind, ButtonSize, eventToHTMLElement, Label, showPopup } from '@opensrcs/ui'
