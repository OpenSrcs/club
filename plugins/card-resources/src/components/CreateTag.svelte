...
-->
<script lang="ts">
  import { CardEvents, MasterTag, Tag } from '@opensrcs/card'
  import core, { Class, ClassifierKind, Data, Ref } from '@opensrcs/core'
  import { getEmbeddedLabel } from '@opensrcs/club'
  import { Card, getClient } from '@opensrcs/presentation'
  import { EditBox, getColorNumberByText, Icon, Label } from '@opensrcs/ui'
