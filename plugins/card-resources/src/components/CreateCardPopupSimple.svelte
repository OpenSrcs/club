...
<script lang="ts">
  import card, { Card as TypeCard, CardSpace, type CreateCardExtension, MasterTag } from '@opensrcs/card'
  import presentation, { Card, createQuery, getClient, SpaceSelector } from '@opensrcs/presentation'
  import { createEventDispatcher } from 'svelte'
  import core, { Data, generateId, Ref, Markup, getCurrentAccount } from '@opensrcs/core'
  import { getResource, translate, getEmbeddedLabel } from '@opensrcs/club'
  import { Label, Modal, ModernEditbox, languageStore } from '@opensrcs/ui'
