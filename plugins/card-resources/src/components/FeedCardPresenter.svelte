...
<script lang="ts">
  import cardPlugin, { Card } from '@opensrcs/card'
  import { CardID, Label as CardLabel, Message, MessageType } from '@opensrcs/communication-types'
  import { SortingOrder, WithLookup } from '@opensrcs/core'
  import { createMessagesQuery } from '@opensrcs/presentation'

  import chat from '@opensrcs/chat'
  import { ExtendedMessagePreview, labelsStore } from '@opensrcs/communication-resources'
  import { getEmbeddedLabel } from '@opensrcs/club'
  import { Button, IconDetailsFilled, IconMoreH, tooltip } from '@opensrcs/ui'
  import { DocNavLink, showMenu } from '@opensrcs/view-resources'
