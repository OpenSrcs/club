...
<script lang="ts">
  ...
  import { Card, Tag } from '@opensrcs/card'
  import core, { Blob, Class, Doc, Ref, toRank } from '@opensrcs/core'
  import { getResource, setPlatformStatus, unknownError } from '@opensrcs/club'
  import { getClient, KeyedAttribute, updateAttribute } from '@opensrcs/presentation'
  import { isEmptyMarkup } from '@opensrcs/text'
  import { Label } from '@opensrcs/ui'
  import { MarkupEditor } from '@opensrcs/view-resources'
