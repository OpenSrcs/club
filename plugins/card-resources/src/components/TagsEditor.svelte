...
<script lang="ts">
  ...
  import { Class, Doc, Mixin, Permission, Ref, TypedSpace } from '@opensrcs/core'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { CircleButton, eventToHTMLElement, IconAdd, IconDownOutline, SelectPopup, showPopup } from '@opensrcs/ui'
