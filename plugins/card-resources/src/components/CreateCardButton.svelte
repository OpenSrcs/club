...
<script lang="ts">
  ...
  import { Card, CardEvents, MasterTag } from '@opensrcs/card'
  import core, { Class, Data, Doc, fillDefaults, MarkupBlobRef, Ref } from '@opensrcs/core'
  import { translate } from '@opensrcs/club'
  import { ButtonIcon, getCurrentLocation, IconAdd, navigate, showPopup } from '@opensrcs/ui'
