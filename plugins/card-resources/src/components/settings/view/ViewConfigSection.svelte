...
<script lang="ts">
  ...
  import { ButtonIcon, Icon, IconAdd, IconDelete, Label } from '@opensrcs/ui'
  import setting from '@opensrcs/setting'
  import { Class, Doc, Ref, generateId } from '@opensrcs/core'
  import DescriptorBox from './DescriptorBox.svelte'
  import card from '../../../plugin'
  import { MasterTag, Tag } from '@opensrcs/card'
  import view, { MasterDetailConfig, ViewletDescriptor } from '@opensrcs/view'
  ...
  {#if viewConfigs.length > 0}
    {#each viewConfigs as config, index}
      <div class="clubTableAttr-content task">
        <div class="clubTableAttr-content__row justify-between">
