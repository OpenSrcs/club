...
<script lang="ts">
  ...
  import core, { Data, generateId, Ref } from '@opensrcs/core'
  import { Card, getClient } from '@opensrcs/presentation'
  import setting from '@opensrcs/setting'
  import { EditBox, Label } from '@opensrcs/ui'
  import view, { MasterDetailConfig, Viewlet, ViewletDescriptor, ViewOptionsModel } from '@opensrcs/view'
