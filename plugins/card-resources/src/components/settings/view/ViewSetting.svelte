...
<script lang="ts">
  ...
  import { getAttributePresenterClass, getClient, hasResource } from '@opensrcs/presentation'
  import { Loading, resizeObserver } from '@opensrcs/ui'
  import view, { BuildModelKey, Viewlet } from '@opensrcs/view'
  import {
    buildConfigLookup,
    canResolveAttribute,
    getKeyLabel,
