...
<script lang="ts">
  ...
  import { ButtonIcon, showPopup, closeTooltip, IconOptions } from '@opensrcs/ui'
  import view, { OrderOption, ViewOptionsModel, Viewlet } from '@opensrcs/view'
  import { ViewOptions as ViewOptionsEditor } from '@opensrcs/view-resources'
  import core, { Class, Data, Ref, SortingOrder, Type } from '@opensrcs/core'
