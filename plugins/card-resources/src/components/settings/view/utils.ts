import { type Data } from '@opensrcs/core'
import { type Viewlet } from '@opensrcs/view'
import { type AttributeConfig, type Config, isAttribute } from '@opensrcs/view-resources'
