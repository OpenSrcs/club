...
<script lang="ts">
  ...
  import { Button, IconDelete, Label, Modal, ModernEditbox, showPopup } from '@opensrcs/ui'
  import view, { Viewlet } from '@opensrcs/view'

  import { AttributeConfig, Config } from '@opensrcs/view-resources'
