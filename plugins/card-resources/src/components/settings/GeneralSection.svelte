...
<script lang="ts">
  ...
  import { TypeNumber } from '@opensrcs/model'
  import { getEmbeddedLabel, translateCB } from '@opensrcs/club'
  import { getClient, IconDownload, IconWithEmoji, MessageBox } from '@opensrcs/presentation'
  ...
  import { ColorsPopup, IconPicker } from '@opensrcs/view-resources'
...
<div class="clubComponent-content__column-group">
  <div class="clubComponent-content__header items-center">
