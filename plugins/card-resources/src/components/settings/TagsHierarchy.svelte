...
-->
<script lang="ts">
  import cardPlugin, { MasterTag } from '@opensrcs/card'
  import core, { Class, ClassifierKind, Doc, Ref } from '@opensrcs/core'
...
{#each classes as cl}
  ...
  <button
    class="clubTableAttr-content__row justify-start cursor-pointer"
    on:click={() => {
      dispatch('select', cl)
    }}
  >
    <div
      class="clubTableAttr-content__row-label font-medium-14 flex flex-gap-2"
