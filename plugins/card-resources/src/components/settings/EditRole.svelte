...
<script lang="ts">
  ...
  import { MasterTag, Role } from '@opensrcs/card'
  import { clearSettingsStore } from '@opensrcs/setting-resources'
  import settingRes from '@opensrcs/setting-resources/src/plugin'
