...
<script lang="ts">
  ...
  import { IconAdd, NavGroup, Action, NavItem, ButtonIcon, showPopup, languageStore } from '@opensrcs/ui'
  import { Ref } from '@opensrcs/core'
  import { createEventDispatcher } from 'svelte'
  import { CardSpace, MasterTag } from '@opensrcs/card'
  import presentation, { IconWithEmoji, getClient } from '@opensrcs/presentation'
  import { translate, getEmbeddedLabel } from '@opensrcs/club'
