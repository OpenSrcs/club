...
<script lang="ts">
  import cardPlugin, { Card, CardSpace, FavoriteCard, MasterTag } from '@opensrcs/card'
  ...
  import { Label, NotificationContext, NotificationType, SortingOrder } from '@opensrcs/communication-types'
  import { NavGroup } from '@opensrcs/ui'
  import preference from '@opensrcs/preference'
  import { createEventDispatcher } from 'svelte'
  import { labelsStore } from '@opensrcs/communication-resources'
