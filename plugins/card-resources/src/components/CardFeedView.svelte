...
<script lang="ts">
  ...
  import { Card, CardSpace, type MasterTag } from '@opensrcs/card'
  import core, { DocumentQuery, type Ref, SortingOrder } from '@opensrcs/core'
  import ui, { Label, Scroller, Loading } from '@opensrcs/ui'
