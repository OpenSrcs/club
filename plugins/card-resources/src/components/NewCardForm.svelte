...
<script lang="ts">
  import {
    ...
    SpaceSelector
  } from '@opensrcs/presentation'
  import { ButtonIcon, IconMinimize, IconSend, ModernButton, ModernEditbox } from '@opensrcs/ui'
  import { createEventDispatcher } from 'svelte'

  import { Analytics } from '@opensrcs/analytics'
  import { AttachmentStyledBox } from '@opensrcs/attachment-resources'
  import { Card, MasterTag, type CardSpace } from '@opensrcs/card'
  import chat from '@opensrcs/chat'
  import { defaultMessageInputActions } from '@opensrcs/communication-resources'
  import { AttachmentID, BlobParams } from '@opensrcs/communication-types'
  import core, { Data, generateId, getCurrentAccount, Markup, Ref } from '@opensrcs/core'
  import { getResource } from '@opensrcs/club'
  import { EmptyMarkup, isEmptyMarkup, markupToJSON, markupToText } from '@opensrcs/text'
  import textEditor, { type RefAction } from '@opensrcs/text-editor'
  import { AttachIcon } from '@opensrcs/text-editor-resources'
  ...
  import { permissionsStore } from '@opensrcs/contact-resources'
  import { canCreateObject } from '@opensrcs/view-resources'
