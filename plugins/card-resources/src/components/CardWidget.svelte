...
-->
<script lang="ts">
  import { closeWidget } from '@opensrcs/workbench-resources'
  import { Widget, WidgetTab } from '@opensrcs/workbench'
  import { createQuery, createNotificationContextsQuery, getClient } from '@opensrcs/presentation'
  ...
  import { Button, EditBox, Header, IconClose, IconMoreH } from '@opensrcs/ui'
