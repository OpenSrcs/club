...
import core, { type Class, type Doc, type Hierarchy, type Ref } from '@opensrcs/core'
import { translate, type IntlString } from '@opensrcs/club'
import cardPlugin, { type Card, type CardSpace } from '@opensrcs/card'
import { type AttributeModel } from '@opensrcs/view'
import { getClient } from '@opensrcs/presentation'
import { isIntlString } from '@opensrcs/converter-resources'
