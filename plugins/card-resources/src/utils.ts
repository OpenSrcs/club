...
import { type AccountClient, getClient as getAccountClientRaw } from '@opensrcs/account-client'
import { Analytics } from '@opensrcs/analytics'
import { type Card, CardEvents, cardId, type CardSpace, type MasterTag, type Tag } from '@opensrcs/card'
import { chatId } from '@opensrcs/chat'
import communication from '@opensrcs/communication'
import { type PermissionsStore } from '@opensrcs/contact'
import core, {
  AccountRole,
  type Class,
...
import { EmptyMarkup, isEmptyMarkup } from '@opensrcs/text'
import {
  getCurrentLocation,
...
import view, { canCopyLink, encodeObjectURI } from '@opensrcs/view'
import { accessDeniedStore } from '@opensrcs/view-resources'
import workbench, { type LocationData, type Widget, type WidgetTab } from '@opensrcs/workbench'
import { createWidgetTab } from '@opensrcs/workbench-resources'
