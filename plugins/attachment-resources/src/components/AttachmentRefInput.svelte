...
-->
<script lang="ts">
  import { Attachment, AttachmentMetadata } from '@opensrcs/attachment'
  import {
  ...
  import { Asset, IntlString, getResource, setPlatformStatus, unknownError } from '@opensrcs/club'
  import {
    DraftController,
  ...
  import { AttachIcon, ReferenceInput } from '@opensrcs/text-editor-resources'
  import { Loading, type AnySvelteComponent } from '@opensrcs/ui'
  import {
