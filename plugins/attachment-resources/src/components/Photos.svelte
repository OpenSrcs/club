...
-->
<script lang="ts">
  import { Photo } from '@opensrcs/attachment'
  import { Class, Doc, Ref, Space, type WithLookup } from '@opensrcs/core'
  import { setPlatformStatus, unknownError } from '@opensrcs/club'
  import { createQuery, getBlobRef, getClient, uploadFile } from '@opensrcs/presentation'
  import { Button, IconAdd, Label, Spinner } from '@opensrcs/ui'
