...
<script lang="ts">
  ...
  import type { BlobType, WithLookup } from '@opensrcs/core'
  import { getResource } from '@opensrcs/club'
  import presentation, { canPreviewFile, getFileUrl, previewTypes } from '@opensrcs/presentation'
  import { IconMoreH, Menu, Action as UIAction, showPopup, tooltip } from '@opensrcs/ui'
  import view, { Action } from '@opensrcs/view'
