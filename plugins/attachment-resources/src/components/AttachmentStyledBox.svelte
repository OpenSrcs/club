...
<script lang="ts">
  ...
  import { IntlString, setPlatformStatus, unknownError } from '@opensrcs/club'
  import {
    createQuery,
    deleteFile,
    DraftController,
  ...
  import { AttachIcon, EditorKitOptions, StyledTextBox } from '@opensrcs/text-editor-resources'
  import { ButtonSize } from '@opensrcs/ui'
  import { type FileUploadCallbackParams, uploadFiles } from '@opensrcs/uploader'
