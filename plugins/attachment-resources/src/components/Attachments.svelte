...
<script lang="ts">
  ...
  import { Class, Data, Doc, DocumentQuery, Ref, Space } from '@opensrcs/core'
  import { IntlString } from '@opensrcs/club'
  import { Icon, Label, resizeObserver, Scroller, Spinner, ButtonIcon, IconAdd } from '@opensrcs/ui'
  import view, { BuildModelKey } from '@opensrcs/view'
  import { Table } from '@opensrcs/view-resources'
  import { getClient } from '@opensrcs/presentation'
  import { FileUploadCallbackParams, uploadFiles } from '@opensrcs/uploader'
