...
<script lang="ts">
  ...
  import { createQuery, getClient, uploadFile } from '@opensrcs/presentation'
  import { ActionIcon, IconAdd, Label, Loading } from '@opensrcs/ui'

  import core, { Doc, Ref, Space, WithLookup } from '@opensrcs/core'
