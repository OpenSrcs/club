...
<script lang="ts">
  ...
  import core, { Class, Ref, Space } from '@opensrcs/core'
  import { getClient } from '@opensrcs/presentation'
  import { Label, Loading, navigate, TabList, getLocation } from '@opensrcs/ui'
...
{/if}
<div class="clubHeader-container background-comp-header-color">
  <FileBrowserFilters
...
<div class="clubHeader-container justify-between">
