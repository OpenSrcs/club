...
<script lang="ts">
  ...
  import attachment, { Attachment, AttachmentsEvents } from '@opensrcs/attachment'
  import contact from '@opensrcs/contact'
  import core, { BlobMetadata, Doc, PersonId, Ref, generateId, type Blob, type Space } from '@opensrcs/core'
  import { IntlString, getResource, setPlatformStatus, unknownError } from '@opensrcs/club'
  import { FileOrBlob, KeyedAttribute, createQuery, getClient, uploadFile } from '@opensrcs/presentation'
  import textEditor, { type RefAction, type TextEditorHandler } from '@opensrcs/text-editor'
  import {
    AttachIcon,
    ...
    defaultRefActions,
    getModelRefActions
  } from '@opensrcs/text-editor-resources'
  import { AnySvelteComponent, getEventPositionElement, getPopupPositionElement } from '@opensrcs/ui'
  import {
    getUploadHandlers,
    uploadFiles,
    UploadHandlerDefinition,
    type FileUploadCallbackParams
  } from '@opensrcs/uploader'
  import { getCollaborationUser, getObjectId } from '@opensrcs/view-resources'
