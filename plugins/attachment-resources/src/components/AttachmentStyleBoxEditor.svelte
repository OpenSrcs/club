...
-->
<script lang="ts">
  import { Class, Doc, Ref, updateAttribute } from '@opensrcs/core'

  import { IntlString } from '@opensrcs/club'
  import { createQuery, getAttribute, getClient, KeyedAttribute } from '@opensrcs/presentation'
  import { createEventDispatcher, onDestroy } from 'svelte'
  import AttachmentStyledBox from './AttachmentStyledBox.svelte'
  import { EditorKitOptions } from '@opensrcs/text-editor-resources'
