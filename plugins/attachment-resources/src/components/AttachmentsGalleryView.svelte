...
<script lang="ts">
  ...
  import { Doc, getCurrentAccount, type WithLookup } from '@opensrcs/core'
  import { getClient, getFileUrl } from '@opensrcs/presentation'
  import { Icon, IconMoreV, Menu, showPopup } from '@opensrcs/ui'
