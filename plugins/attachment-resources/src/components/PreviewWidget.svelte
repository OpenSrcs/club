...
-->
<script lang="ts">
  import workbench, { Widget, WidgetTab } from '@opensrcs/workbench'
  import { FilePreview, DownloadFileButton, FilePreviewPopup, FileTypeIcon } from '@opensrcs/presentation'
  import { Breadcrumbs, Button, closeTooltip, Header, showPopup } from '@opensrcs/ui'
