...
import activity, { type ActivityMessage, type DocUpdateMessage } from '@opensrcs/activity'
import attachment, { type Attachment } from '@opensrcs/attachment'
import core, { SortingOrder, type Markup, type ObjQueryType, type SortingQuery } from '@opensrcs/core'
import { type IntlString, type Resources } from '@opensrcs/club'
import { PDFViewer, deleteFile, getClient, uploadFile } from '@opensrcs/presentation'
