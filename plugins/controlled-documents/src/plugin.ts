...
import type { AnyComponent, ResolvedLocation, Location } from '@opensrcs/ui/src/types'
import { Action, Viewlet } from '@opensrcs/view'
...
import type { NotificationType } from '@opensrcs/notification'
...
export const documentsPlugin = plugin(documentsId, {
  ...
  function: {
    ...
    FormatDocumentMarkdownValue: '' as Resource<import('@opensrcs/converter').ValueFormatter>
  },
  icon: {
    Approvals: '' as Asset,
