...
jest.mock('@opensrcs/collaborator-client', () => {
...
describe('createRemoteProvider reconnect grace behavior', () => {
  ...
  const platformMock = jest.requireMock('@opensrcs/club')
  const collaboratorClientMock = jest.requireMock('@opensrcs/collaborator-client')
