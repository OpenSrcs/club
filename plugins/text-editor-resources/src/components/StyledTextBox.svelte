<script lang="ts">
  ...
  import presentation, { MessageViewer, getFileUrl, getImageSize, imageSizeToRatio } from '@opensrcs/presentation'
  import { EmptyMarkup } from '@opensrcs/text'
  import textEditor, { RefAction } from '@opensrcs/text-editor'
  import {
    ActionIcon,
    ButtonSize,
    IconCheck,
