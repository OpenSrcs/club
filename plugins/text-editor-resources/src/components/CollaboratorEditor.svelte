...
<script lang="ts">
  ...
  import textEditor, { CollaborationUser, TextEditorCommandHandler } from '@opensrcs/text-editor'
  import { AnySvelteComponent, IconSize, registerFocus } from '@opensrcs/ui'
