<!--
// Copyright © 2026, 2023, 2024 OpenSrcs.
//
...
<script lang="ts">
  ...
  import core, { Class, Doc, Ref, SearchResultDoc, SortingOrder, type VersionableDoc } from '@opensrcs/core'
  ...
  import { Label, ListView, resizeObserver, Submenu } from '@opensrcs/ui'
  import view, { type ReferenceVersion, type ReferenceVersionsProvider } from '@opensrcs/view'
