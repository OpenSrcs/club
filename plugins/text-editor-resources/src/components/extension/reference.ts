...
import { ReferenceNode, type ReferenceNodeProps, type ReferenceOptions } from '@opensrcs/text'
import Suggestion, { type SuggestionKeyDownProps, type SuggestionOptions, type SuggestionProps } from './suggestion'

import { type Blob, type Class, type Doc, type Ref } from '@opensrcs/core'
import { getMetadata, getResource, translate } from '@opensrcs/club'
import presentation, { createQuery, getBlobRef, getClient, MessageBox } from '@opensrcs/presentation'
...
import { parseLocation, showPopup, tooltip, type LabelAndProps, type Location, fromCodePoint } from '@opensrcs/ui'
