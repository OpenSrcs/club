<script lang="ts">
  ...
  import { type Class, type Doc, type Ref, type Space, SortingOrder } from '@opensrcs/core'
  import { MessageBox, createQuery, getClient } from '@opensrcs/presentation'
  import { makeRank } from '@opensrcs/rank'
  import time, { ToDo, ToDoPriority } from '@opensrcs/time'
  import { CheckBox, getEventPositionElement, showPopup, Component } from '@opensrcs/ui'
