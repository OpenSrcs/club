...
-->
<script lang="ts">
  import { Blob, Class, Doc, Markup, Ref } from '@opensrcs/core'
  import { Asset, IntlString } from '@opensrcs/club'
  import { EmptyMarkup, isEmptyMarkup, mergeKitOptions } from '@opensrcs/text'
  import textEditor, { RefAction, TextEditorHandler } from '@opensrcs/text-editor'
  import {
    AnySvelteComponent,
    Button,
    ButtonKind,
