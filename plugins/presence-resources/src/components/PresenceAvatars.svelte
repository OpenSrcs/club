...
<script lang="ts">
  import { type Doc, type Ref, notEmpty } from '@opensrcs/core'
  import { type Person, formatName, getCurrentEmployee } from '@opensrcs/contact'
  import { Avatar, getPersonsByPersonRefs } from '@opensrcs/contact-resources'
  import { getEmbeddedLabel } from '@opensrcs/club'
  import { IconSize, tooltip, deviceOptionsStore as deviceInfo, checkAdaptiveMatching } from '@opensrcs/ui'
...
>
  {#if persons.length > 0}
    {#if adaptive}
      <div
        class="clubCombineAvatars-container"
