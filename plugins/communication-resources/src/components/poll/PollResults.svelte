...
<script lang="ts">
  import { Label, Modal, Scroller } from '@opensrcs/ui'
  import { employeeByAccountStore, UserDetails } from '@opensrcs/contact-resources'
  import { Poll } from '@opensrcs/communication'
  import { AccountUuid, notEmpty } from '@opensrcs/core'
