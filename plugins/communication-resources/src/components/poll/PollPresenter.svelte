...
<script lang="ts">
  import { Applet, Poll, PollAnswer, UserVote } from '@opensrcs/communication'
  import { AppletAttachment } from '@opensrcs/communication-types'
  import { DAY, getEventPositionElement, Label, Menu, showPopup, ticker, TimeSince } from '@opensrcs/ui'
  import contact, { getCurrentEmployeeSpace } from '@opensrcs/contact'
  import { employeeByAccountStore, CombineAvatars } from '@opensrcs/contact-resources'
  import { notEmpty, getCurrentAccount, isOtherDay, Timestamp, getDay } from '@opensrcs/core'
  ...
  import { openDoc } from '@opensrcs/view-resources'
