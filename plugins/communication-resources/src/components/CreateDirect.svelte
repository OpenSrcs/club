...
<script lang="ts">
  ...
  import { Data, notEmpty, Ref } from '@opensrcs/core'
  import { Employee, formatName, getCurrentEmployee, getCurrentEmployeeSpace } from '@opensrcs/contact'
  import { Direct } from '@opensrcs/communication'
  import { employeeByIdStore } from '@opensrcs/contact-resources'
