...
<script lang="ts">
  import { Person, formatName } from '@opensrcs/contact'
  import { IntlString } from '@opensrcs/club'
  import { resizeObserver, TimeSince, tooltip } from '@opensrcs/ui'
  import {
    Avatar,
  ...
  import { SocialID } from '@opensrcs/communication-types'
