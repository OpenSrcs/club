...
<script lang="ts">
  ...
  import { getEventPositionElement, showPopup, Action, Menu } from '@opensrcs/ui'
  import type { SocialID } from '@opensrcs/communication-types'
  import { Message, MessageType } from '@opensrcs/communication-types'
  import { getResource } from '@opensrcs/club'
  import { MessageAction } from '@opensrcs/communication'
