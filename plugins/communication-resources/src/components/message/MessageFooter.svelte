...
<script lang="ts">
  import { createQuery, getClient, getCommunicationClient } from '@opensrcs/presentation'
  import cardPlugin, { Card } from '@opensrcs/card'
  import { getCurrentAccount, Ref } from '@opensrcs/core'
  import { AttachmentPreview, LinkPreview } from '@opensrcs/attachment-resources'
  import { AttachmentID, Emoji, Message, MessageType } from '@opensrcs/communication-types'
