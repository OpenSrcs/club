...
-->
<script lang="ts">
  import { ActivityProcess, Markdown } from '@opensrcs/communication-types'
  import { getClient } from '@opensrcs/presentation'
  import { Icon, IconAdd, IconArrowRight, IconCheck, IconStart, Label } from '@opensrcs/ui'
  import processPlugin from '@opensrcs/process'
