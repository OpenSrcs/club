...
<script lang="ts">
  import { Direct } from '@opensrcs/communication'
  import { Icon, IconSize } from '@opensrcs/ui'
  import { getClient } from '@opensrcs/presentation'
  import contact, { Employee, getCurrentEmployee, Person } from '@opensrcs/contact'
  import { classIcon } from '@opensrcs/view-resources'
  import { Ref } from '@opensrcs/core'
  import { Avatar, employeeByIdStore, getPersonByPersonRef } from '@opensrcs/contact-resources'
