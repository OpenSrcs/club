...
<script lang="ts">
  import { AccountUuid, notEmpty, PersonUuid } from '@opensrcs/core'
  import { ObjectPresenter } from '@opensrcs/view-resources'
  import { Employee } from '@opensrcs/contact'
  import { employeeByAccountStore } from '@opensrcs/contact-resources'
  import { EmojiPresenter, getEmojiByUnicode } from '@opensrcs/emoji-resources'
  import { isCustomEmoji } from '@opensrcs/emoji'
