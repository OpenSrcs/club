...
<script lang="ts">
  ...
  import { Class, ClassifierKind, Doc, Ref } from '@opensrcs/core'
  import presentation, { getClient } from '@opensrcs/presentation'
  import { DropdownIntlItem, Label, Modal, ModernEditbox, NestedDropdown } from '@opensrcs/ui'
  import { createEventDispatcher } from 'svelte'
  import { Message } from '@opensrcs/communication-types'
