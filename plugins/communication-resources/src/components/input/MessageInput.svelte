...
<script lang="ts">
  ...
  import { BlobParams, LinkPreviewParams, Message, MessageID, BlobID } from '@opensrcs/communication-types'
  import { generateId, getCurrentAccount, Markup, RateLimiter, Ref } from '@opensrcs/core'
  import { getResource, setPlatformStatus, unknownError } from '@opensrcs/club'
  import { clearTyping, setTyping } from '@opensrcs/presence-resources'
  import { deleteFile, getClient, isLinkPreviewEnabled, uploadFile } from '@opensrcs/presentation'
  import { areEqualMarkups, isEmptyMarkup } from '@opensrcs/text'
  import { showPopup, ThrottledCaller } from '@opensrcs/ui'
  import { FileUploadCallbackParams, getUploadHandlers, UploadHandlerDefinition } from '@opensrcs/uploader'
