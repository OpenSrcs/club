...
-->
<script lang="ts">
  import { type PersonId, getCurrentAccount } from '@opensrcs/core'
  import { getName } from '@opensrcs/contact'
  import { getPersonsByPersonIds } from '@opensrcs/contact-resources'
  import { IntlString } from '@opensrcs/club'
  import { getClient } from '@opensrcs/presentation'
  import { Label } from '@opensrcs/ui'
  import { type TypingInfo, typing } from '@opensrcs/presence-resources'
  import { CardID } from '@opensrcs/communication-types'
