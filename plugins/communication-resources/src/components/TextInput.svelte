...
<script lang="ts">
  import { Markup, type Blob, type Ref } from '@opensrcs/core'
  import { IntlString } from '@opensrcs/club'
  import { areEqualMarkups, EmptyMarkup, isEmptyMarkup } from '@opensrcs/text'
  import { TextEditorHandler } from '@opensrcs/text-editor'
  import { TextEditor } from '@opensrcs/text-editor-resources'
  import { Button, ButtonIcon, handler, IconComponent, IconSend, registerFocus } from '@opensrcs/ui'
