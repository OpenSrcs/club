...
<script lang="ts">
  import { LiteMessageViewer } from '@opensrcs/presentation'
  import { Card } from '@opensrcs/card'
  import { type WithLookup } from '@opensrcs/core'
  import { Message, SocialID } from '@opensrcs/communication-types'
  import { Person } from '@opensrcs/contact'
  import { getEmbeddedLabel, IntlString } from '@opensrcs/club'
  import { employeeByPersonIdStore, getPersonByPersonId } from '@opensrcs/contact-resources'
  import { markdownToMarkup } from '@opensrcs/text-markdown'
  import { jsonToMarkup, markupToText } from '@opensrcs/text'
  import { tooltip } from '@opensrcs/ui'
