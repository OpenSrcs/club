...
import core, { type Class, type Client, type Doc, type Mixin, type Ref } from '@opensrcs/core'
import view, { type AttributeModel } from '@opensrcs/view'
import { buildRemovedDoc, getAttributePresenter } from '@opensrcs/view-resources'
