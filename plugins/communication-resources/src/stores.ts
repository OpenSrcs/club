...
import { createLabelsQuery, createQuery, onClient, onCommunicationClient } from '@opensrcs/presentation'
import {
  MessageType,
  type CardID,
  type Label,
...
import core, { getCurrentAccount, type Markup, type Ref } from '@opensrcs/core'
import { languageStore } from '@opensrcs/ui'
import cardPlugin, { type Card } from '@opensrcs/card'
import communication from '@opensrcs/communication'
import { translationStore } from '@opensrcs/contact-resources'
