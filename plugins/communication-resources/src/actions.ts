...
} from '@opensrcs/communication'
import { languageStore, showPopup } from '@opensrcs/ui'
import emojiPlugin from '@opensrcs/emoji'
import {
  type AppletParams,
  type AttachmentID,
  type BlobAttachment,
...
import cardPlugin, { type Card, type MasterTag } from '@opensrcs/card'
import { addRefreshListener, deleteFile, getClient, getCommunicationClient } from '@opensrcs/presentation'
import {
  AccountRole,
  fillDefaults,
  generateId,
...
import { getMetadata, getResource } from '@opensrcs/club'
import { employeeByPersonIdStore } from '@opensrcs/contact-resources'
import { getEmployeeBySocialId } from '@opensrcs/contact'
import chat from '@opensrcs/chat'
import { markupToText } from '@opensrcs/text'
import { get } from 'svelte/store'
import { translate as aiTranslate } from '@opensrcs/ai-bot-resources'
...
import { isAppletAttachment, isBlobAttachment, isLinkPreviewAttachment } from '@opensrcs/communication-shared'
