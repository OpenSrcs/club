...
import contact, { Channel, Organization } from '@opensrcs/contact'
import core, {
  AnyAttribute,
  AttachedDoc,
  Class,
...
import { Message } from '@opensrcs/gmail'
import recruit, { Applicant, Candidate, Vacancy } from '@opensrcs/recruit'
