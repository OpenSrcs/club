...
import type { Client, Doc, Mixin, Ref } from '@opensrcs/core'
import { type Plugin, type Resource, plugin } from '@opensrcs/club'
...
import type { Action, BuildMarkdownTableMetadata, ViewAction } from '@opensrcs/view'
import type {
