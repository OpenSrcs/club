...
import { type Person } from '@opensrcs/core'
import { avatarWhiteColors, avatarDarkColors, type ColorDefinition } from '@opensrcs/ui'
import { type UserProfile, getClient as getAccountClientRaw, type AccountClient } from '@opensrcs/account-client'
