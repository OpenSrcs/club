...
<script lang="ts">
  ...
  import { PersonWithProfile } from '@opensrcs/account-client'
  import { type AccountUuid, type PersonUuid } from '@opensrcs/core'
  import globalProfile from '@opensrcs/global-profile'
