...
-->
<script lang="ts">
  import type { AttachedDoc, Class, Collection, Doc, Ref } from '@opensrcs/core'
  import { IntlString, translateCB } from '@opensrcs/club'
  import { KeyedAttribute } from '@opensrcs/presentation'
  import { TagElement, TagReference } from '@opensrcs/tags'
  import type { ButtonKind, ButtonSize, TooltipAlignment } from '@opensrcs/ui'
  import { Button, showPopup, themeStore } from '@opensrcs/ui'
