...
-->
<script lang="ts">
  import { Loading, Scroller, formatDuration, formatNumberCompact, themeStore } from '@opensrcs/ui'
  import { getCurrentWorkspaceUuid } from '@opensrcs/presentation'
  import billingPlugin from '@opensrcs/billing'
  import love from '@opensrcs/love'
  import view from '@opensrcs/view'
  import filesize from 'filesize'
  import StatsCard from './StatsCard.svelte'
  import drivePlugin from '@opensrcs/drive'
