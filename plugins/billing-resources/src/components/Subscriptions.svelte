...
-->
<script lang="ts">
  import { type SubscriptionData, SubscriptionType } from '@opensrcs/account-client'
  import { type SubscribeRequest, type CheckoutStatus } from '@opensrcs/payment-client'
  import { Tier } from '@opensrcs/billing'
  import { getMetadata, translate } from '@opensrcs/club'
  import presentation, { getClient, MessageBox } from '@opensrcs/presentation'
  import { type Ref, SortingOrder, UsageStatus } from '@opensrcs/core'
  import {
    IconCheckmark,
    Label,
    Loading,
...
{#if tiers.length > 0}
  <Scroller align={'center'} padding={'var(--spacing-3)'} bottomPadding={'var(--spacing-3)'}>
    <div class="clubComponent-content gapV-8">
