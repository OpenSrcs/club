...
-->
<script lang="ts">
  import { AccountArrayEditor, employeeRefByAccountUuidStore } from '@opensrcs/contact-resources'
  import { type AccountUuid, TypedSpace, notEmpty } from '@opensrcs/core'
  import { IntlString } from '@opensrcs/club'
  import { ButtonKind, ButtonSize } from '@opensrcs/ui'
