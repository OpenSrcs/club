...
-->
<script lang="ts">
  import core, { AnyAttribute, Class, Doc, DOMAIN_STATUS, Ref, RefTo } from '@opensrcs/core'
  import { TypeRef } from '@opensrcs/model'
  import { getClient } from '@opensrcs/presentation'
  import { Component, DropdownLabelsIntl, Label } from '@opensrcs/ui'
  import view from '@opensrcs/view-resources/src/plugin'
  import card from '@opensrcs/card'
  import { createEventDispatcher } from 'svelte'
  import type { ButtonKind, ButtonSize, DropdownIntlItem } from '@opensrcs/ui'
