...
-->
<script lang="ts">
  import core, { DateRangeMode, TypeDate as DateType } from '@opensrcs/core'
  import { TypeDate } from '@opensrcs/model'
  import { IntlString } from '@opensrcs/club'
  import { DropdownLabelsIntl, Label, DropdownIntlItem } from '@opensrcs/ui'
