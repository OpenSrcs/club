...
-->
<script lang="ts">
  import core, { Attribute, CustomSequence, IndexKind, Ref, Type, TypeIdentifier as TypeId } from '@opensrcs/core'
  import { TypeIdentifier } from '@opensrcs/model'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { EditBox, Label, Toggle, Button, ButtonIcon } from '@opensrcs/ui'
