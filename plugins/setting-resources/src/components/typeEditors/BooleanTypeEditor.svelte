...
-->
<script lang="ts">
  import core, { AnyAttribute, Type } from '@opensrcs/core'
  import { TypeBoolean } from '@opensrcs/model'
  import { Label, Toggle } from '@opensrcs/ui'
  import { BooleanEditor } from '@opensrcs/view-resources'
