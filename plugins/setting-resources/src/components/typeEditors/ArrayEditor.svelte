...
-->
<script lang="ts">
  import core, { AnyAttribute, ArrOf, Class, Doc, Ref, Type } from '@opensrcs/core'
  import { ArrOf as createArrOf } from '@opensrcs/model'
  import { getClient } from '@opensrcs/presentation'
  import { AnyComponent, Component, DropdownLabelsIntl, Label } from '@opensrcs/ui'
