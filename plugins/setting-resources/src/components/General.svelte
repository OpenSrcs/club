...
-->
<script lang="ts">
  import { AvatarType } from '@opensrcs/contact'
  import { EditableAvatar, getAccountClient } from '@opensrcs/contact-resources'
  import core, { Configuration, WorkspaceAccountPermission } from '@opensrcs/core'
  import { loginId } from '@opensrcs/login'
  import { translateCB } from '@opensrcs/club'
  import { createQuery, getClient, MessageBox } from '@opensrcs/presentation'
  import { WorkspaceSetting } from '@opensrcs/setting'
  import {
    Breadcrumb,
    Button,
  ...
  <div class="clubComponent-content__column content">
    ...
    {:else}
      <Scroller align={'center'} padding={'var(--spacing-3)'} bottomPadding={'var(--spacing-3)'}>
        <div class="clubComponent-content flex-col flex-gap-4">
