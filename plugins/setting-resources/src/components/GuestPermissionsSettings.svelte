...
-->
<script lang="ts">
  import card, { Card } from '@opensrcs/card'
  import chat from '@opensrcs/chat'
  import communication, { GuestCommunicationSettings } from '@opensrcs/communication'
  import contact, { ensureEmployeeForPerson } from '@opensrcs/contact'
  import { getAccountClient } from '@opensrcs/contact-resources'
  import core, {
    type Account,
    AccountRole,
    AccountUuid,
  ...
  import { getEmbeddedLabel, getMetadata, type IntlString } from '@opensrcs/club'
  import { createQuery, getClient, uiContext } from '@opensrcs/presentation'
  import workbench, { type Application } from '@opensrcs/workbench'
  import {
    Breadcrumb,
    Component,
    defineSeparators,
...
<div class="clubComponent">
  ...
  <div class="clubComponent-content__container columns">
    <div class="clubComponent-content__column navigation py-2">
      <Scroller shrink>
        <NavItem
    ...
    <div class="clubComponent-content__column content">
      ...
      {:else}
        <Scroller align={'center'} padding={'var(--spacing-3)'} bottomPadding={'var(--spacing-3)'}>
          <div class="clubComponent-content guestPermissionsRoot flex-col">
