...
<script lang="ts">
  ...
  import { getClient, createQuery, isDisabled } from '@opensrcs/presentation'
  import settingPlg from '../plugin'
  import setting, { SettingsCategory, SettingsEvents } from '@opensrcs/setting'
  import {
    Component,
    Label,
    NavGroup,
  ...
  import {
    ...
    sidebarStore,
    logOut
  } from '@opensrcs/workbench-resources'
...
{#if asideComponent != null && !moveASide}
  ...
  <div class="clubSidePanel-container">
    {#key asideProps}
