...
-->
<script lang="ts">
  import { getCurrentAccount, hasAccountRole } from '@opensrcs/core'
  import { createQuery, isAdminUser, isDisabled } from '@opensrcs/presentation'
  import setting, { SettingsCategory } from '@opensrcs/setting'
  import {
    Component,
    Location,
    NavItem,
