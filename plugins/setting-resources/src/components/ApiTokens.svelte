...
-->
<script lang="ts">
  import { Breadcrumb, Header, IconAdd, Label, Loading, ModernButton, Scroller, showPopup } from '@opensrcs/ui'
  import { MessageBox } from '@opensrcs/presentation'
  import setting from '@opensrcs/setting'
  import { Analytics } from '@opensrcs/analytics'
  import { type ApiTokenInfo } from '@opensrcs/account-client'
...
<div class="clubComponent">
  ...
  <div class="clubComponent-content__container columns">
    <div class="clubComponent-content__column p-6">
      {#if loading}
        <Loading />
      {:else if loadError}
        <div class="clubComponent-content__empty">
