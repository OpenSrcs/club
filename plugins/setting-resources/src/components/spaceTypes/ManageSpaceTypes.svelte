...
<script lang="ts">
  ...
  import core, { Ref, SpaceType, WithLookup } from '@opensrcs/core'
  import { Location, getCurrentResolvedLocation, navigate, resolvedLocationStore } from '@opensrcs/ui'
  import { createQuery, hasResource } from '@opensrcs/presentation'
  import { Resource } from '@opensrcs/club'
