...
<script lang="ts">
  ...
  import core, { Class, Ref, SpaceTypeDescriptor, generateId, SpaceType, Data } from '@opensrcs/core'
  import { Card, getClient, hasResource } from '@opensrcs/presentation'
  import { AnySvelteComponent, EditBox } from '@opensrcs/ui'
  import { Resource, getResource } from '@opensrcs/club'
  import { ObjectBox } from '@opensrcs/view-resources'
  import setting, { SpaceTypeCreator, createSpaceType } from '@opensrcs/setting'
