...
<script lang="ts">
  ...
  import core, { AccountUuid, reduceCalls, type SpaceType, type SpaceTypeDescriptor } from '@opensrcs/core'
...
{#if descriptor !== undefined}
  ...
  <div class="clubComponent-content__column-group">
    <div class="clubComponent-content__header">
