...
<script lang="ts">
  ...
  import core, { SpaceType, SpaceTypeDescriptor } from '@opensrcs/core'
  import type { IntlString } from '@opensrcs/club'
  import { SpaceTypeEditor } from '@opensrcs/setting'
  import {
    ButtonIcon,
    Component,
    IconDescription,
  ...
  <div class="clubComponent-content__container columns">
    {#if visibleSecondNav}
      <div class="clubComponent-content__column">
        <div class="clubComponent-content__navHeader">
          <div class="clubComponent-content__navHeader-menu">
        ...
        <Scroller align="center" padding="var(--spacing-3)" bottomPadding="var(--spacing-3)">
          <div class="clubComponent-content gap">
            {#each editorDescriptor.sections as section}
              <div bind:this={sectionRefs[section.id]} class:clubTableAttr-container={!section.withoutContainer}>
                <Component
