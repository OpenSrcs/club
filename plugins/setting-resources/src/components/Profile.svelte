...
-->
<script lang="ts">
  import contact, { combineName, getFirstName, getLastName } from '@opensrcs/contact'
  import { ChannelsEditor, EditableAvatar, myEmployeeStore } from '@opensrcs/contact-resources'
  import { AccountRole, getCurrentAccount, SocialIdType } from '@opensrcs/core'
  import login, { loginId } from '@opensrcs/login'
  import platform, { getResource, PlatformError } from '@opensrcs/club'
  import { AttributeEditor, createQuery, getClient, hasResource, MessageBox } from '@opensrcs/presentation'
  import {
    Breadcrumb,
    Button,
    Component,
  ...
  import { logIn, logOut } from '@opensrcs/workbench-resources'
