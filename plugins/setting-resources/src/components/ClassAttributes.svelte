...
-->
<script lang="ts">
  import core, { AnyAttribute, Class, Doc, Ref, Space, toRank } from '@opensrcs/core'
...
>
  <div class="clubTableAttr-header font-medium-12" class:withButton={showHierarchy}>
    {#if showHeader}
      {#if showHierarchy}
  ...
  {:else if attributes.length > 0}
    <div class="clubTableAttr-content class">
      <ClassAttributesList
        {_class}
        {ofClass}
        {attributeMapper}
