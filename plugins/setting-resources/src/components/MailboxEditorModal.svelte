...
-->
<script lang="ts">
  import { MailboxOptions } from '@opensrcs/account-client'
  import presentation, { getClient } from '@opensrcs/presentation'
  import { Dropdown, ListItem, Modal, ModernEditbox, Spinner, themeStore } from '@opensrcs/ui'
  import setting from '@opensrcs/setting'
  import { createEventDispatcher } from 'svelte'
  import { getAccountClient } from '../utils'
  import { IntlString, translateCB } from '@opensrcs/club'
  import contact, { getCurrentEmployee, SocialIdentityRef } from '@opensrcs/contact'
