...
-->
<script lang="ts">
  import core, { Class, Doc, DocumentUpdate, Tx, TxCreateDoc, TxUpdateDoc } from '@opensrcs/core'
  import { getEmbeddedLabel, IntlString } from '@opensrcs/club'
  import presentation, { Card, createQuery, getClient } from '@opensrcs/presentation'
  import { Button, EditBox, Label } from '@opensrcs/ui'
