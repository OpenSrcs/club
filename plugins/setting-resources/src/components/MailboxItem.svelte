...
<script lang="ts">
  ...
  import { MailboxInfo } from '@opensrcs/account-client'
...
<div class="clubTableAttr-container" class:mt-6={mailboxIdx > 0}>
  <div class="clubTableAttr-header heading-medium-16" style="text-transform: unset">
  ...
  <!-- TODO
  <div class="clubTableAttr-content withTitle">
    <div class="flex-col column">
      ...
      <div class="clubTableAttr-content__wrapper flex-gap-1">
