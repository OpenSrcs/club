...
-->
<script lang="ts">
  import contact, { SocialIdentity, SocialIdentityProvider, SocialIdentityRef } from '@opensrcs/contact'
  import { SocialIdentityPresenter } from '@opensrcs/contact-resources'
  import {
    getCurrentAccount,
    loginSocialTypes,
    pickPrimarySocialId,
  ...
  import { setPlatformStatus, unknownError } from '@opensrcs/club'
  import { getClient, MessageBox } from '@opensrcs/presentation'
  import { getPlatformColorDef, Label, PaletteColorIndexes, showPopup, themeStore } from '@opensrcs/ui'
