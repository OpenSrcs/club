...
<script lang="ts">
  ...
  import contact, { getCurrentEmployee, SocialIdentityProvider, SocialIdentityRef } from '@opensrcs/contact'
  import { EditBox, Label, Button, CodeForm, TimeLeft, Status as StatusControl } from '@opensrcs/ui'
  import { OtpInfo } from '@opensrcs/account-client'
  import { buildSocialIdString, getCurrentAccount, setCurrentAccount, SocialId, Timestamp } from '@opensrcs/core'
  import { OK, PlatformError, Severity, Status, unknownError } from '@opensrcs/club'
