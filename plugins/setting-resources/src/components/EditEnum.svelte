...
-->
<script lang="ts">
  import core, { Enum } from '@opensrcs/core'
  import presentation, { getClient, MessageBox } from '@opensrcs/presentation'
  import {
    IconAdd,
    IconAttachment,
    IconDelete,
  ...
  import type { DropdownIntlItem } from '@opensrcs/ui'
...
>
  <div class="flex-col">
    ...
    <div
      class="clubTableAttr-container mt-6"
    ...
    >
      ...
      {#if values.length > 0 || newItem}
        <div class="clubTableAttr-content options">
          <EnumValuesList
            bind:values
            on:update={(e) => {
              values = e.detail
          ...
          />
          {#if newItem}
            <div class="clubTableAttr-content__row hovered">
              <div class="clubTableAttr-content__row-dragMenu">
                <IconMoreV2 size={'small'} />
              </div>
              <div class="clubTableAttr-content__row-label font-regular-14 accent grow">
                <ModernEditbox
                  kind={'ghost'}
                  size={'small'}
              ...
              {#if matched}
                <div class="clubChip-item error font-medium-12">
