...
<script lang="ts">
  ...
  import presentation, { MessageBox, createQuery, getClient } from '@opensrcs/presentation'
  import {
    Action,
    AnySvelteComponent,
    IconCopy,
  ...
  import { getContextActions, SortableList } from '@opensrcs/view-resources'
  ...
  import { TypeIdentifier } from '@opensrcs/model'
