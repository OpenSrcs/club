...
<script lang="ts">
  ...
  import { createQuery, getCurrentWorkspaceUuid } from '@opensrcs/presentation'
  import { type IntegrationType, IntegrationError } from '@opensrcs/setting'
  ...
  import { onIntegrationEvent } from '@opensrcs/integration-client'
  ...
  import { IntegrationKind } from '@opensrcs/core'
  ...
  typeQuery.query(setting.class.IntegrationType, { kind: { $ne: 'club-mail' as IntegrationKind } }, (res) => {
