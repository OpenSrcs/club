...
-->
<script lang="ts">
  import { PluginConfiguration, systemAccountUuid } from '@opensrcs/core'
  import {
    createQuery,
    getClient,
  ...
  import ratingPlugin, { getRaiting, type PersonRating } from '@opensrcs/rating'
  import { Breadcrumb, Header, Label, Scroller } from '@opensrcs/ui'
