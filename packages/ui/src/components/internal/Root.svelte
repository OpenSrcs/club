<script lang="ts">
  import platform, { OK, PlatformEvent, Severity, Status, addEventListener, getMetadata } from '@opensrcs/club'
  import { onDestroy, onMount } from 'svelte'
  import type { AnyComponent, WidthType } from '../../types'
  import { deviceSizes, deviceWidths } from '../../types'
  // import { applicationShortcutKey } from '../../utils'
  import { Theme, themeStore } from '@opensrcs/theme'
  import {
    IconArrowLeft,
    IconArrowRight,
    checkMobile,
...
<style lang="scss">
  #ui-root {
    ...
    // height: 100vh;
    height: calc(100% - var(--club-top-indent, 0rem));
    height: calc(100dvh - var(--club-top-indent, 0rem));
    ...
    .antiStatusBar {
      ...
      .history-box {
        ...
        margin-left: var(--club-history-box-left-indent, 4.625rem);
      }
