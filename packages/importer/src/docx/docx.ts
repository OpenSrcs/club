...
import { htmlToJSON, type MarkupNode } from '@opensrcs/text'
import { markupToMarkdown } from '@opensrcs/text-markdown'
import { mkdir, readdir, readFile, writeFile } from 'fs/promises'
import * as yaml from 'js-yaml'
import { basename, dirname, extname, join, relative } from 'path'
import { type ClubControlledDocumentHeader, type ClubDocumentTemplateHeader } from '../club/club'
...
export interface DocumentState {
  ...
  root: string
  markup: MarkupNode
  header?: ClubControlledDocumentHeader | ClubDocumentTemplateHeader
}
