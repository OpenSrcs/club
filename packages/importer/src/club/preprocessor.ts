...
import { type Class, type Doc, type Ref, type Space } from '@opensrcs/core'
import { MarkupMarkType, type MarkupNode, MarkupNodeType, traverseNode, traverseNodeMarks } from '@opensrcs/text'
...
export class ClubMarkdownPreprocessor extends BaseMarkdownPreprocessor {
  constructor (
