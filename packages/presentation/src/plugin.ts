...
import type { Asset, IntlString, Metadata, Plugin, StatusCode } from '@opensrcs/club'
import { plugin } from '@opensrcs/club'
import { type FileStorage } from '@opensrcs/storage-client'
import { type ComponentExtensionId } from '@opensrcs/ui/src/types'
...
export type { FileStorage } from '@opensrcs/storage-client'
...
export default plugin(presentationId, {
  ...
  metadata: {
    ...
    ClublakeUrl: '' as Metadata<string>,
