...
import { LiveQuery as LQ } from '@opensrcs/query'
import { type AnyComponent, type AnySvelteComponent, getRawCurrentLocation, workspaceId } from '@opensrcs/ui'
import view, { type AttributeCategory, type AttributeEditor } from '@opensrcs/view'
...
export { reduceCalls } from '@opensrcs/core'
...
export function copyTextToClipboardOldBrowser (text: string): void {
  ...
  textarea.value = text
  textarea.classList.add('clubClipboardArea')
