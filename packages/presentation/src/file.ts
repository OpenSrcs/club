...
import { type Blob as PlatformBlob, type Ref, type WorkspaceUuid } from '@opensrcs/core'
import { getMetadata } from '@opensrcs/club'
import { type FileStorage, createFileStorage as createStorageClient } from '@opensrcs/storage-client'
...
/** @public */
export function createFileStorage (uploadUrl: string, datalakeUrl?: string, clublakeUrl?: string): FileStorage {
  return createStorageClient({ uploadUrl, datalakeUrl, clublakeUrl })
}
