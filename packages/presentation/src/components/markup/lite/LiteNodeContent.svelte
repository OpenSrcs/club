...
-->
<script lang="ts">
  import { Blob, Class, Doc, Ref } from '@opensrcs/core'
  import { AttrValue, MarkupNode, MarkupNodeType, MarkupMarkType } from '@opensrcs/text'

  import LiteNodes from './LiteNodes.svelte'
  import ObjectNode from '../ObjectNode.svelte'
  import NodeMarks from '../NodeMarks.svelte'
  import { getBlobRef } from '../../../preview'
  import { ParsedTextWithEmojis } from '@opensrcs/emoji'
