...
-->
<script lang="ts">
  import { Class, DocumentQuery, FindOptions, Ref, Space } from '@opensrcs/core'
  import { Asset, IntlString } from '@opensrcs/club'
  import { AnyComponent, AnySvelteComponent, ButtonKind, ButtonShape, ButtonSize } from '@opensrcs/ui'
