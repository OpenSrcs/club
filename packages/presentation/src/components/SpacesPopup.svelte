...
-->
<script lang="ts">
  import { Class, Doc, DocumentQuery, FindOptions, Ref, Space, getCurrentAccount } from '@opensrcs/core'
  import { Asset, getResource } from '@opensrcs/club'
  import { AnyComponent, AnySvelteComponent, ButtonSize } from '@opensrcs/ui'
