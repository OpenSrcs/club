...
A TypeScript/Node.js client for the Clubpulse WebSocket server.
...
```ts
import { ClubpulseClient } from "./clubpulse_client.js"

async function main() {
  // connect
  const client = await ClubpulseClient.connect("wss://clubpulse_mem.lleo.me/ws")
