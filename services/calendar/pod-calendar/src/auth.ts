...
import calendar, { calendarIntegrationKind } from '@opensrcs/calendar'
import contact, { getPrimarySocialId } from '@opensrcs/contact'
import core, {
  AccountUuid,
  MeasureContext,
  PersonId,
...
import type { IntegrationClient } from '@opensrcs/integration-client'
