...
import { Data, MeasureContext, WorkspaceUuid } from '@opensrcs/core'
...
export async function eventCreated (
  ...
  // TODO: move emailing logic from club-schedule here
...
export async function eventUpdated (
  ...
  // TODO: if the event was created via club-schedule, we need to send an email
