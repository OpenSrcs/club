...
//
import { getClient as getAccountClient, AccountClient } from '@opensrcs/account-client'
import { createRestTxOperations } from '@opensrcs/api-client'
import { Event } from '@opensrcs/calendar'
import core, { Hierarchy, PersonId, systemAccountUuid, TxOperations, WorkspaceUuid } from '@opensrcs/core'
