...
import { generateId, type Data, type Ref } from '@opensrcs/core'
import productsPlugin, { ProductVersionState, type Product, type ProductVersion } from '@opensrcs/products'
