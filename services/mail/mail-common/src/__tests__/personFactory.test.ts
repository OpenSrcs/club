...
import { MeasureContext, PersonUuid, PersonId, WorkspaceUuid } from '@opensrcs/core'
import { RestClient, createRestClient } from '@opensrcs/api-client'
...
jest.mock('@opensrcs/api-client', () => ({
  ...jest.requireActual('@opensrcs/api-client'),
