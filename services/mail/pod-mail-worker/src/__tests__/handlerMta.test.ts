...
import { createMessages } from '@opensrcs/mail-common'
...
jest.mock('@opensrcs/mail-common', () => {
  const actualMailCommon = jest.requireActual('@opensrcs/mail-common')
  return {
    ...actualMailCommon,
