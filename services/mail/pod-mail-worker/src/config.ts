...
const config: Config = {
  ...
  communicationTopic: process.env.COMMUNICATION_TOPIC ?? 'clubgun',
  serviceId: process.env.SERVICE_ID ?? 'club-mail',
  mailUrl: (() => {
  ...
  footerMessage: process.env.FOOTER_MESSAGE ?? '<br><br><p>Sent via <a href="https://club.opensrcs.org">club</a></p>',
