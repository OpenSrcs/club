...
A service that provides Gmail integration capabilities for the OpenSrcs Platform. This service handles Gmail authentication, message synchronization, and workspace management.
...
- OpenSrcs Platform dependencies
...
- OpenSrcs Platform core services
...
### Core Dependencies
- @opensrcs/core
- @opensrcs/server-core
- @opensrcs/server-client
- @opensrcs/server-token
- @opensrcs/gmail
...
For support, please contact the OpenSrcs team or open an issue in the repository.
