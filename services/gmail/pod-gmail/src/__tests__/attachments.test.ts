...
import type { Attachment as AttachedFile } from '@opensrcs/mail-common'
...
describe('AttachmentHandler', () => {
  ...
  describe('makeAttachmentsBody', () => {
    it('should create message body with attachments', async () => {
      ...
      expect(decodedResult).toContain('<br><br><p>Sent via <a href="https://club.opensrcs.org">club</a></p>')
    })
  })
})
