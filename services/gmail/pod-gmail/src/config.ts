...
const config: Config = (() => {
  ...
  const params: Partial<Config> = {
    ...
    FooterMessage: process.env[envMap.FooterMessage] ?? '<br><br><p>Sent via <a href="https://club.opensrcs.org">club</a></p>',
    ...
    CommunicationTopic: process.env[envMap.CommunicationTopic] ?? 'clubgun',
