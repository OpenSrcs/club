...
import contact, { Channel, Contact as PContact, getFirstName, getLastName } from '@opensrcs/contact'
import core, {
  PersonId,
  Blob,
  Client,
...
import settingP from '@opensrcs/setting'
import telegramP, { NewTelegramMessage } from '@opensrcs/telegram'
