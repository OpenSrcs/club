...
import contact, { type Person, type PersonSpace } from '@opensrcs/contact'
import core, {
  type AccountUuid,
  type Class,
  type Doc,
...
import type { ConsumerControl } from '@opensrcs/server-core'
import notification, { type CommonInboxNotification, type DocNotifyContext } from '@opensrcs/notification'
