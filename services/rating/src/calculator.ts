...
import { Api as CommunicationApi } from '@opensrcs/communication-server'
import contact, { type Person, type SocialIdentity } from '@opensrcs/contact'
import core, {
  type AccountUuid,
  type Class,
  type Doc,
...
import { _parseId, type Id, PlatformError, unknownError } from '@opensrcs/club'
import {
