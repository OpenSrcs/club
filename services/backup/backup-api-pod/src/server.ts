...
import { getCPUInfo, getMemoryInfo } from '@opensrcs/server-core'
import { decodeToken, decodeTokenVerbose, TokenError } from '@opensrcs/server-token'
...
import { getClient } from '@opensrcs/account-client'
import { createStorageBackupStorage, type BackupInfo, type BackupStorage } from '@opensrcs/server-backup'
import { createStorageFromConfig, storageConfigFromEnv } from '@opensrcs/server-storage'
...
export async function createServer (ctx: MeasureContext, config: Config): Promise<{ app: Express, close: () => void }> {
  ...
  app.get('/', (req, res) => {
    res.send(`club&reg; Backup&trade; <a href="https://club.opensrcs.org">https://club.opensrcs.org</a>
      &copy; 2024 <a href="https://clublabs.com">club Labs</a>`)
  })
  ...
  app.get('/', (_req, res) => {
    res.send(`
      club® Datalake™ <a href="https://club.opensrcs.org">https://club.opensrcs.org</a>
      © 2025 <a href="https://clublabs.com">club Labs</a>
    `)
  })
