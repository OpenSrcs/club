<script lang="ts">
  ...
  import core, { Ref, WithLookup, generateId } from '@opensrcs/core'
  import { getMetadata, translate } from '@opensrcs/club'
  import { getClient } from '@opensrcs/presentation'
  import task, { TaskType, updateProjectType, type TaskStatusFactory } from '@opensrcs/task'
  import tracker, { Project, createStatesData } from '@opensrcs/tracker'
  import ui, {
    Button,
    IconChevronDown,
    PaletteColorIndexes,
