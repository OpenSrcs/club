...
<script lang="ts">
  ...
  import { Button, Chevron, Component, ExpandCollapse, Label } from '@opensrcs/ui'
  import diffview from '@opensrcs/diffview'
  import { GithubPatch, GithubPullRequest, GithubPullRequestReview } from '@opensrcs/github'
