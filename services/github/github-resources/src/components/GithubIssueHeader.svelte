<script lang="ts">
  ...
  import { NavLink, createQuery, getClient, isAdminUser } from '@opensrcs/presentation'
  import { Issue } from '@opensrcs/tracker'
  import { ButtonKind, showPopup, Button, Icon } from '@opensrcs/ui'
  import { DocSyncInfo, GithubIntegrationRepository, GithubProject } from '@opensrcs/github'
