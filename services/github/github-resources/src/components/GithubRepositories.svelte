<script lang="ts">
  import { AttachedDoc, Ref, WithLookup } from '@opensrcs/core'
  import { GithubIntegration, GithubIntegrationRepository, GithubProject } from '@opensrcs/github'
  import { getMetadata } from '@opensrcs/club'
  import presentation, { NavLink, getClient, isAdminUser, MessageBox } from '@opensrcs/presentation'
