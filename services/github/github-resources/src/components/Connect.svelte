...
<script lang="ts">
  ...
  import type { Integration as AccountIntegration } from '@opensrcs/account-client'
  import { Analytics } from '@opensrcs/analytics'
  import { WithLookup, getCurrentAccount } from '@opensrcs/core'
  import { GithubAuthentication, GithubIntegration } from '@opensrcs/github'
  import { getEmbeddedLabel, getMetadata, translate } from '@opensrcs/club'
  import presentation, { Card, HTMLViewer, NavLink, createQuery } from '@opensrcs/presentation'
  import tracker, { Project } from '@opensrcs/tracker'
  import ui, { Button, Label, Loading, TabItem, TabList, location, ticker } from '@opensrcs/ui'
