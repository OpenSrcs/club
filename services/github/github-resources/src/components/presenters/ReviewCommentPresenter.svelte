<script lang="ts">
  import { EmployeePresenter, SystemAvatar, getPersonByPersonIdCb } from '@opensrcs/contact-resources'
  import Avatar from '@opensrcs/contact-resources/src/components/Avatar.svelte'
  import core, { getDisplayTime } from '@opensrcs/core'
  import { MessageViewer } from '@opensrcs/presentation'
  import { Label } from '@opensrcs/ui'
  import { GithubReviewComment } from '@opensrcs/github'
