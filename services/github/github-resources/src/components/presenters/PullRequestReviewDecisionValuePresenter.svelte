<script lang="ts">
  ...
  import { AnySvelteComponent, Icon, Label, PaletteColorIndexes, getPlatformColor, themeStore } from '@opensrcs/ui'
  import { GithubReviewDecisionState } from '@opensrcs/github'
