...
-->
<script lang="ts">
  import core, { Ref, WithLookup, getCurrentAccount } from '@opensrcs/core'
  import { GithubPullRequest, GithubReviewComment, GithubReviewThread } from '@opensrcs/github'

  import { ActivityMessageHeader, ActivityMessageTemplate } from '@opensrcs/activity-resources'
  import { Person } from '@opensrcs/contact'
  import { EmployeePresenter, getPersonByPersonId, getPersonByPersonIdCb } from '@opensrcs/contact-resources'
  import { getEmbeddedLabel } from '@opensrcs/club'
  import { createQuery, getClient } from '@opensrcs/presentation'
  import { ReferenceInput } from '@opensrcs/text-editor-resources'
  import { Button, Component, Label, PaletteColorIndexes, getPlatformColor, themeStore } from '@opensrcs/ui'
  import diffview from '@opensrcs/diffview'
