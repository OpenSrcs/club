...
-->
<script lang="ts">
  import { AttachedDoc, WithLookup } from '@opensrcs/core'
  import { GithubIntegration, GithubIntegrationRepository } from '@opensrcs/github'
  import { getClient } from '@opensrcs/presentation'
  import type { Integration } from '@opensrcs/account-client'
  import { BaseIntegrationState } from '@opensrcs/setting-resources'
  import { OK, ERROR, Status } from '@opensrcs/club'
