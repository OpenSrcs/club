...
<script lang="ts">
  ...
  import type { ButtonKind, ButtonShape, ButtonSize, LabelAndProps, SelectPopupValueType } from '@opensrcs/ui'
  import { ButtonWithDropdown, Icon, IconDropdown, SelectPopup, eventToHTMLElement, showPopup } from '@opensrcs/ui'
  import { GithubIntegrationRepository, GithubProject } from '@opensrcs/github'
