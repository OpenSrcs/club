...
import core, { TAttachedDoc, TDoc } from '@opensrcs/model-core'
...
} from '@opensrcs/github'
import contact, { TPerson } from '@opensrcs/model-contact'
import presentation from '@opensrcs/model-presentation'
import tracker, { TComponent, TIssue, TProject, issuesOptions } from '@opensrcs/model-tracker'
import view, { classPresenter } from '@opensrcs/model-view'
...
import tags from '@opensrcs/tags'
import task from '@opensrcs/task'

import { generateClassNotificationTypes } from '@opensrcs/model-notification'

import { type ActivityMessageControl } from '@opensrcs/activity'
import activity, { TActivityMessage } from '@opensrcs/model-activity'
import attachment, { TAttachment } from '@opensrcs/model-attachment'
import chunter from '@opensrcs/model-chunter'
import { TPreference } from '@opensrcs/model-preference'
import { TToDo } from '@opensrcs/model-time'
import notification from '@opensrcs/notification'
import { DOMAIN_PREFERENCE } from '@opensrcs/preference'
import time from '@opensrcs/time'

export { githubId } from '@opensrcs/github'
