...
import { MarkdownState } from '@opensrcs/text-markdown'
...
A list of closed updated issues`
  ...
  it('markup to markdown', async () => {
    ...
    const data2 =
      '[Sobolev Andrey](https://front.club.opensrcs.org/open/?workspace=workspace&_class=contact%3Aclass%3APerson&_id=629d8b615bdc96430ced15a0&label=Sobolev%20Andrey) [UBERF-16](https://front.club.opensrcs.org/open/?workspace=workspace&_class=github%3Aclass%3AGithubPullRequest&_id=64db123e602161ac4482475c&label=UBERF-16) link test'
    const html = await markupToMarkdown(data, 'https://front.club.opensrcs.org/open/?workspace=workspace')
  ...
  it('markdown to markup', () => {
    ...
    const markup = markdownToMarkup(data, 'https://front.club.opensrcs.org/open/?workspace=workspace')
  ...
  it('test conversion', async () => {
    ...
    const markdown = await markupToMarkdown(data, 'https://front.club.opensrcs.org/open/?workspace=workspace')
    const markup = markdownToMarkup(markdown, 'https://front.club.opensrcs.org/open/?workspace=workspace')
