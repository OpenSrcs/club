import type { AccountClient, IntegrationSecret } from '@opensrcs/account-client'
import core, { systemAccountUuid, type MeasureContext, type PersonId, type WorkspaceUuid } from '@opensrcs/core'
import { getAccountClient } from '@opensrcs/server-client'
import { generateToken } from '@opensrcs/server-token'
import { githubUserIntegrationKind } from '@opensrcs/github'
