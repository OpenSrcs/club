...
export COLLABORATOR_URL=ws://club.local:3078
export STORAGE_CONFIG="datalake|http://club.local:4030"
export OTEL_EXPORTER_OTLP_ENDPOINT=http://club.local:4318/v1/traces
rush bundle --to @opensrcs/pod-github
