...
//
import core, { Client, Ref, TxOperations, AccountUuid } from '@opensrcs/core'
import { createClient } from '@opensrcs/server-client'
import contact, { Employee, Person } from '@opensrcs/contact'
import chunter, { DirectMessage } from '@opensrcs/chunter'
import { aiBotEmailSocialKey } from '@opensrcs/ai-bot'
