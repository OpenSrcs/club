...
import serverCore, { workspaceEvents, type PlatformQueue, type StorageAdapter } from '@opensrcs/server-core'
import { searchFulltext, type FulltextDBConfiguration } from '@opensrcs/server-indexer'
import {
