...
import { MeasureContext, metricsAggregate } from '@opensrcs/core'
...
export async function createServer (ctx: MeasureContext, config: Config): Promise<{ app: Express, close: () => void }> {
  ...
  app.get('/', (_req, res) => {
    res.send(`
      club&reg; Link Preview Service&trade; <a href="https://club.opensrcs.org">https://club.opensrcs.org</a>
      &copy; 2026 <a href="https://clublabs.com">club Labs</a>
    `)
  })
