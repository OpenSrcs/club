...
Copies external images into the official registry (opensrcs). A git-based `git describe --tags --abbrev=0` tag is applied to copied images.
...
More details are available in the [Design Document](https://app.club.opensrcs.org/workbench/platform/document/external-services-build-682232fa8c2a2eb48ffe47d5)
