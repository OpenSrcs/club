...
import contact, { Contact, Employee, formatName, getName, Person } from '@opensrcs/contact'
import core, {
  Doc,
  PersonId,
  Ref,
...
import gmail from '@opensrcs/gmail'
import hr, { Department, fromTzDate, PublicHoliday, Request, Staff, tzDateEqual } from '@opensrcs/hr'
import notification, { NotificationType } from '@opensrcs/notification'
import { translate } from '@opensrcs/club'
import { TriggerControl } from '@opensrcs/server-core'
import { getEmployee, getSocialStrings } from '@opensrcs/server-contact'
import { sendEmailNotification } from '@opensrcs/server-gmail-resources'
import {
