...
//
import { Person, type Employee } from '@opensrcs/contact'
import core, {
  combineAttributes,
  DocumentQuery,
  PersonId,
...
import { getEmployees, getSocialIds } from '@opensrcs/server-contact'
...
import training, { TrainingState, type TrainingRequest } from '@opensrcs/training'
