...
import { Class, Doc, DocumentQuery, FindOptions, FindResult, Hierarchy, Ref, concatLink } from '@opensrcs/core'
import document, { Document, documentId } from '@opensrcs/document'
