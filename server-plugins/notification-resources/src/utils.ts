...
import { getMetadata, getResource, IntlString, translate } from '@opensrcs/club'
import { getPersonSpaces } from '@opensrcs/server-contact'
...
import serverNotification, {
  ...
  SenderInfo,
  TextPresenter
} from '@opensrcs/server-notification'
import serverView from '@opensrcs/server-view'
import { extractReferences, markupToJSON, Reference } from '@opensrcs/text-core'
