...
import activity, { ActivityMessage, ActivityReference } from '@opensrcs/activity'
import chunter, { Channel, ChatMessage, chunterId, ChunterSpace, ThreadMessage } from '@opensrcs/chunter'
import contact, { Employee, Person } from '@opensrcs/contact'
import core, {
  AccountUuid,
  Class,
  combineAttributes,
...
import notification, { DocNotifyContext, NotificationContent } from '@opensrcs/notification'
import { getMetadata, IntlString, translate } from '@opensrcs/club'
import { getAccountBySocialId, getPerson } from '@opensrcs/server-contact'
import serverCore, { TriggerControl } from '@opensrcs/server-core'
import {
  createCollaboratorNotifications,
  getAddCollaboratTxes,
  getDocCollaborators
} from '@opensrcs/server-notification-resources'
import { jsonToHTML, markupToJSON } from '@opensrcs/text'
import { extractReferences, markupToText, stripTags } from '@opensrcs/text-core'
import { workbenchId } from '@opensrcs/workbench'

import { NOTIFICATION_BODY_SIZE } from '@opensrcs/server-notification'
import { encodeObjectURI } from '@opensrcs/view'
