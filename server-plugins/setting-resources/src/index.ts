...
//
import contact, { Person, getFirstName, getLastName } from '@opensrcs/contact'
import core, { PersonId, Doc, Role, Tx, TxUpdateDoc } from '@opensrcs/core'
import { getEmbeddedLabel, translate } from '@opensrcs/club'
