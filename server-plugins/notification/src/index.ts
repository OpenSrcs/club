//
// Copyright © 2026, 2022, 2023 OpenSrcs.
//
...
import { Employee, Person, PersonSpace } from '@opensrcs/contact'
import { PersonId, Class, Doc, Mixin, Ref, Tx, TxCUD, AccountUuid } from '@opensrcs/core'
import { NotificationContent, NotificationType } from '@opensrcs/notification'
import { Metadata, Plugin, Resource, plugin } from '@opensrcs/club'
import type { TriggerControl, TriggerFunc } from '@opensrcs/server-core'

/**
 * @public
 */
export const serverNotificationId = 'server-notification' as Plugin
export { DOMAIN_USER_NOTIFY, DOMAIN_NOTIFICATION, DOMAIN_DOC_NOTIFY } from '@opensrcs/notification'
