...
import contact, { Employee, type Person, PersonSpace, SocialIdentityRef } from '@opensrcs/contact'
import core, { AccountUuid, parseSocialIdString, PersonId, type Ref, SocialId, toIdMap } from '@opensrcs/core'
