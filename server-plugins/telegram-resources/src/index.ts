...
import contact, { Channel, Person } from '@opensrcs/contact'
import core, {
  PersonId,
  Class,
  Doc,
...
import { PlatformQueueProducer, QueueTopic, TriggerControl } from '@opensrcs/server-core'
import {
  getNotificationLink,
  getTextPresenter,
...
} from '@opensrcs/server-telegram'
import telegram, { TelegramMessage } from '@opensrcs/telegram'
