...
import card, { Card, cardId, MasterTag, Tag } from '@opensrcs/card'
import communication, { Direct } from '@opensrcs/communication'
import {
...
import { CardPeer } from '@opensrcs/communication-types'
import contact, { Employee, formatName, Person } from '@opensrcs/contact'
import core, {
  AccountUuid,
  AnyAttribute,
  ArrOf,
...
import { getEmployee, getPersonSpaces } from '@opensrcs/server-contact'
import serverCore, { TriggerControl } from '@opensrcs/server-core'
import setting from '@opensrcs/setting'
import view, { type BuildModelKey, type Viewlet } from '@opensrcs/view'
